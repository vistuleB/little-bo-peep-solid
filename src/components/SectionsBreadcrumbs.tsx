...
const screen_width_to_achieve_default_visible = 8000; // basically off by default...
const screen_width_to_achieve_on = 1800;
...
const SectionsBreadcrumbs = (props: ParentProps) => {
  ...
  const { getPrevPage, prevDisabled, getNextPage, nextDisabled } =
    usePrevNextPage();
