...
export const Solution = (props: SolutionProps) => {
  ...
  createEffect(() => {
    ...
    setTimeout(() => { if (solution_open()) { reset_content_height_etc(); }}, 50);
    setTimeout(() => { if (solution_open()) { reset_content_height_etc(); }}, 500);
    setTimeout(() => { if (solution_open()) { reset_content_height_etc(); }}, 1200);
  });
    ...
    >
      <SolutionSVG
        ...
        onClick={() => {
          ...
          props.resetter(); // this first call on its own is enough apparently
          setTimeout(props.resetter, 200);
          setTimeout(props.resetter, 1000);
