    ...
    <Article
      ...
      <Section id="section-1">
        <OuterP>
          ...
          <Math>$2$</Math> and <Math>$3$</Math> (and nothing else):
        </OuterP>
        <Pause />
        ...
        <Pause />
        <OuterP>
          is a set containing just the numbers <Math>$1$</Math> and{" "}
          <NoBreak>
            <Math>$3$</Math>,
          </NoBreak>{" "}
          even
      ...
      {showMore() && (
        <>
          ...
          <Section id="section-2">
            ...
            <Pause />
            <OuterP>
              as in, for example, the buttons and clock display and door handle
              of a microwave oven) of a set consists of just one functionality:
              a set can answer questions of the form
            </OuterP>
            <Pause />
            <CentralDisplayItalic>do you contain ... ?</CentralDisplayItalic>
            <Pause />
            <OuterP>and nothing else. For example, you could ask a set</OuterP>
            <Pause />
            <CentralDisplayItalic>do you contain 3?</CentralDisplayItalic>
            <Pause />
            <OuterP>
              to which <Math>$\&#123;1, 2, 3\&#125;$</Math> would answer “yes”,
              but <Math>$\&#123; 1\&#125;$</Math> would answer “no”, or
            </OuterP>
            <Pause />
            <CentralDisplayItalic>do you contain 5?</CentralDisplayItalic>
            <Pause />
            <OuterP>
              to which <Math>$\&#123;1\&#125;$</Math> and{" "}
              <Math>$\&#123;1, 2, 3\&#125;$</Math> would both answer “no”.
            </OuterP>
            <OuterP class="indent-10">Notation-wise, the expression</OuterP>
            <Pause />
            ...
            <Pause />
            <CentralDisplayItalic>
              <Math>$A$</Math> contains <Math>$x$</Math>
            </CentralDisplayItalic>
            <Pause />
            <OuterP>or</OuterP>
            <Pause />
            <CentralDisplayItalic>
              <Math>$A$</Math> answers “yes” to the question “do you contain{" "}
              <NoBreak>
                <Math>$x$</Math>
                ?”
              </NoBreak>
            ...
            <Pause />
            <OuterP>equivalently. [One can also say</OuterP>
            <Pause />
            <CentralDisplayItalic>
              <Math>$x$</Math> in <Math>$A$</Math>
            </CentralDisplayItalic>
            <Pause />
            <OuterP>or</OuterP>
            <Pause />
            <CentralDisplayItalic>
              <Math>$x$</Math> is in <Math>$A$</Math>
            </CentralDisplayItalic>
            <Pause />
            <OuterP>or</OuterP>
            <Pause />
            <CentralDisplayItalic>
              <Math>$x$</Math> is an element of <Math>$A$</Math>
            </CentralDisplayItalic>
            <Pause />
            <OuterP>
              depending on one's mood and/or tastes.] As in all of mathematics,
              any such statement evaluates to either “true” or “false”. For
              example,
            </OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              is true, because <Math>$1$</Math> <i>is</i> an element of the set{" "}
              <NoBreak>
                <Math>$\&#123;1, 2\&#125;$</Math>,
              </NoBreak>{" "}
              whereas
            ...
            <Pause />
            <OuterP>
              is false, because <Math>$3$</Math> <i>is not</i> an element of the
              set{" "}
              <NoBreak>
                <Math>$\&#123;1, 2\&#125;$</Math>.
              </NoBreak>
          ...
          <Section id="section-3">
            <OuterP>
              <b>Set Equality.</b> Two sets are deemed to be equal if and only
              if they answer the same to all “do you contain ...?” questions.
              For example, while
            </OuterP>
            <Pause />
            <MathBlock>$$ \Large\&#123;2, 1\&#125; $$</MathBlock>
            <Pause />
            <OuterP>might look superficially different from</OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>and answer “no” to all else. For that matter,</OuterP>
            <Pause />
            <MathBlock>$$ \Large\&#123;1, 1, 2\&#125; $$</MathBlock>
            <Pause />
            <OuterP>might also look superficially different from</OuterP>
            <Pause />
            <MathBlock>$$ \Large\&#123;1, 2\&#125; $$</MathBlock>
            <Pause />
            <OuterP>but since both sets answer “yes” to</OuterP>
            <Pause />
            <CentralDisplayItalic>do you contain 1?</CentralDisplayItalic>
            <Pause />
            <CentralDisplayItalic>do you contain 2?</CentralDisplayItalic>
            ...
            <OuterP class="indent-10">
              (These examples demonstrate that human notation is redundant:
              there are several different ways of writing down the same set.
              They also demonstrate that sets do not keep track of the
            </OuterP>
            <Pause />
            <CentralDisplayItalic>order</CentralDisplayItalic>
            <Pause />
            <OuterP>nor of the</OuterP>
            <Pause />
            <CentralDisplayItalic>multiplicity</CentralDisplayItalic>
            <Pause />
            <OuterP>
              of their elements. Such notions are simply not part of the “API”
              of a set.)
            </OuterP>
            <OuterP class="indent-10">
              Moreover, any empty set is equal to any other empty set. Equality
              follows because both sets answer all questions the same way: they
              both answer “no” to everything. So there is
            </OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>empty set—the one and only!</OuterP>
          </Section>
          <Pause />
          <Section id="section-4">
            <OuterP>
              <b>Second notation for the empty set.</b> While the empty set can
              be written
            </OuterP>
            <Pause />
            <MathBlock>$$ \Large \&#123;\&#125; $$</MathBlock>
            <Pause />
            <OuterP>another available notation is</OuterP>
            <Pause />
            <MathBlock>$$ \Large \phi $$</MathBlock>
            <Pause />
            <OuterP>
              which is the Greek letter phi, read “fee”. (Or “fie”? Hum.) (Or
              you can just say “the empty set”, and keep it safe.)
            </OuterP>
          </Section>
          <Pause />
          <Section id="section-5">
            <OuterP>
              <b>Sets within sets.</b> Sets can be nested much like Russian
              dolls. In fact, the result of doing this might even look like a
              little bit like a Russian doll (no?):
            </OuterP>
            <Pause />
            <MathBlock>
              $$ \Large \&#123;\&#123;\&#123;\&#123;\&#125;\&#125;\&#125;\&#125;
            ...
            <Pause />
            <OuterP>
              The above is “a set containing a set containing a set containing a
              set containing the empty set”. Eschewing complete adherence to the
              Russian doll aesthetic, we could also write
            </OuterP>
            <Pause />
            <MathBlock>
              $$ \Large \&#123;\&#123;\&#123;\phi\&#125;\&#125;\&#125; $$
            ...
            <Pause />
            <OuterP>
              etc, etc: adding a new outer layer changes the whole set each
              time.
            </OuterP>
          </Section>
          <Pause />
          <Section id="section-6">
            <OuterP>
              <b>Set union and set intersection.</b> The so-called <i>union</i>{" "}
              of two sets <Math>$A$</Math> and <Math>$B$</Math> is written
            </OuterP>
            <Pause />
            ...
            <OuterP>
              ...
              <Math>$2$</Math> and <Math>$5$</Math> are the only elements to
              find themselves either in <Math>$\&#123;1, 2\&#125;$</Math> or in{" "}
              <NoBreak>
                <Math>$\&#123;2, 5\&#125;$</Math>.
              </NoBreak>{" "}
              The so-called <i>intersection</i> of two sets <Math>$A$</Math> and{" "}
              <Math>$B$</Math> is written
            </OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              as <Math>$2$</Math> is the only element that is both in{" "}
              <Math>$\&#123;1, 2\&#125;$</Math> and in{" "}
              <NoBreak>
                <Math>$\&#123;2, 5\&#125;$</Math>.
              </NoBreak>
            </OuterP>
            ...
            <Pause />
            <OuterP>
              because that's how we defined “union”. (Replace “or” by “and” to
              get a definition of intersection.) In fact, a logician would
              define the union of two sets by an abstruse expression of the type
            </OuterP>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <CentralDisplayItalic>
              an element <Math>$x$</Math> is in the thing I call{" "}
              <NoBreak>
                “<Math>$A \cup B$</Math>”
              </NoBreak>{" "}
              if and only if <Math>$x$</Math> is in <Math>$A$</Math> or{" "}
              <Math>$x$</Math> is in <Math>$B$</Math>
            </CentralDisplayItalic>
            <Pause />
            <OuterP>
              as{" "}
            ...
            <Pause />
            <OuterP>means “and”.)</OuterP>
          </Section>
          <Pause />
          <Section id="section-7">
            <OuterP>
              <b>Sets encountered in calculus.</b> In calculus, you will see
              sets such as <i>the real numbers</i>
            </OuterP>
            <Pause />
            <MathBlock>$$ \Large\rr $$</MathBlock>
            <Pause />
            <OuterP>
              which is an infinite set containing all “ordinary” decimal
              numbers, or such as <i>the integers</i>
            </OuterP>
            <Pause />
            <MathBlock>$$ \Large\zz $$</MathBlock>
            <Pause />
            <OuterP>
              which contains all “whole” numbers, including the negative ones.
              You might also encounter <i>the natural numbers</i>
            </OuterP>
            <Pause />
            <MathBlock>$$ \Large\nn $$</MathBlock>
            <Pause />
            ...
            <Pause />
            <OuterP>
              is a <i>closed interval</i>, consisting of all (real) numbers
            ...
            <Pause />
            <OuterP>
              is a <i>half-open</i> interval, consisting of all real numbers
              greater than or equal to{" "}
              <NoBreak>
                <Math>$a$</Math>,
              </NoBreak>{" "}
          ...
          <Section id="section-8">
            <OuterP>
              <b>Sets not encountered in calculus.</b> If you take a more
              advanced course, you might encounter the so-called{" "}
            ...
            <Pause />
            <OuterP>(I.e., ...well, you get it!)</OuterP>
            <OuterP class="indent-10">
              You can view <Math>$\overline&#123;\rr&#125;$</Math> as a kind
              “closed interval” version of{" "}
              <NoBreak>
                <Math>$\rr$</Math>,
              </NoBreak>{" "}
              that is, think of <Math>$\overline&#123;\rr&#125;$</Math> as being
              the closed interval
            </OuterP>
            <Pause />
            <MathBlock>$$ \Large [-\infty, \infty] $$</MathBlock>
            ...
            <OuterP class="indent-10">
              ...
              is: <i>not until you give it one</i>.
            </OuterP>
            <OuterP class="indent-10">
              E.g. (to give you a brief flavor, before we move on forever from
              the topic), the value of something like
            </OuterP>
            <Pause />
            ...
            <OuterP>
              ...
              <Math>$a + \infty = \infty$</Math> for any{" "}
              <NoBreak>
                <Math>$a \ne -\infty$</Math>
                .)
              </NoBreak>{" "}
              And some things remain explicitly <i>undefined</i>. For example,
              the expression
            </OuterP>
            <Pause />
            <MathBlock>$$ \Large (-\infty) + \infty $$</MathBlock>
