    ...
    <Article
      ...
      <SectionsBreadcrumbs>
        <BreadcrumbItem id="breadcrumb-0">
          <InChapterLink href="?id=grid">grid</InChapterLink>
        </BreadcrumbItem>
        <BreadcrumbItem id="breadcrumb-1">
          <InChapterLink href="?id=exercises-_148_hgi_">
            exercises 1
          </InChapterLink>
        </BreadcrumbItem>
        <BreadcrumbItem id="breadcrumb-2">
          <InChapterLink href="?id=exercises-_149_hgi_">
            exercises 2
          </InChapterLink>
        </BreadcrumbItem>
      </SectionsBreadcrumbs>
      <ArticleTitle banner="Bootcamp 3:">Components Playground</ArticleTitle>
      <Pause />
      ...
      <Section id="grid">
        <OuterP>
          ...
          used for putting items in a controlled grid layout, a more friendly
          alternative to Table component that needs all special html tags tr,
          colgroup ...etc
        </OuterP>
        <Pause />
        <OuterP>
        ...
        <Pause />
        <Grid cols={3} placeItems="start" style="background-color:#ffe4e6">
          <Item>Item 1</Item>
          <Item>Item 2</Item>
          <Item>Item 3</Item>
          <Item>Item 4</Item>
