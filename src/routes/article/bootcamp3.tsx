        ...
        <Exercise number={3}>
          ...
          <Solution>
            <OuterP>
              ...
              {" "} places an out-of-flow image beside the paragraph, math block, or image that immediately precedes it.
            </OuterP>
            <Pause />
            <OuterP>
              <i>
              ...
              {" "} ImageRight attached to a paragraph, with a positive horizontal offset.
            </OuterP>
            <OuterP class="indent-10">
              This paragraph has a right-side cloud attached to its right edge. The cloud should sit outside the text column, vertically centered on this paragraph.
              <ImageRight
            ...
            <OuterP>
              ...
              {" "} ImageLeft attached to a paragraph, with a positive horizontal offset.
            </OuterP>
            <OuterP class="indent-10">
              This paragraph has a left-side cloud attached to its left edge. The positive offset moves the cloud farther left, away from the paragraph.
              <ImageLeft
            ...
            <OuterP>
              ...
              {" "} ImageRight attached to a math block. The renderer adds at-least-as-wide=true for this case.
            </OuterP>
            <Pause />
            <MathBlock>
              $$
            ...
            <OuterP>
              ...
              {" "} line anchoring from the top and bottom of a paragraph.
            </OuterP>
            <OuterP class="indent-10">
              This paragraph has enough text to span several lines on normal desktop widths. The right cloud uses line=2, so its anchor should be near the second line from the top. The left cloud uses line=-1, so its anchor should be near the first line from the bottom. Resize the viewport to check that both anchors stay related to the parent text.
              <ImageRight
            ...
            <OuterP>
              ...
              {" "} child overlay positioning inside the scaled side-image wrapper.
            </OuterP>
            <OuterP class="indent-10">
              This figure has a label positioned by children-x and children-y. The label container should move and scale with the side image.
              <ImageLeft
