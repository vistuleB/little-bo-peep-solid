  ...
  return (
    ...
    >
      ...
      <Section work="ing" id="section-1">
        <OuterP>
          <b>Cos and Sin. (“Cosine” and “sine”.)</b> We have already encountered
          the ‘cos’ function in{" "}
          <a href="/article/chapter3#_39_h.a.i_" class="out-chapter-link">
        ...
        <OuterP>
          in{" "}
          <a href="/article/chapter4#_83_h.a.i_" class="out-chapter-link">
      ...
      {showMore() && (
        <>
          ...
          <Section id="section-2">
            <OuterP>
              <b>Derivatives.</b> Continuing the last topic, we can add two more
              particles to the diagram that defines ‘sin’ and ‘cos’ via{" "}
              <NoBreak>
                <Math>$x$</Math>
                -coordinates.
              </NoBreak>{" "}
            ...
            <OuterP>
              ...
              <a href="/article/chapter4#_66_h.a.i_" class="out-chapter-link">
                Exercise 10
              </a>{" "}
              and{" "}
              <a href="/article/chapter4#_67_h.a.i_" class="out-chapter-link">
          ...
          <Section id="section-3">
            ...
            <OuterP>
              ...
              &#8288;,{" "}
              <a href="/article/chapter4#_87_h.a.i_" class="out-chapter-link">
                Chapter 4
              </a>
          ...
          >
            ...
            <Exercise number={49}>
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>
                  Now comparing this set of definitions to this figure...
                </OuterP>
                <Pause />
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <OuterP>
                    By contrast, this exercise shows that we can also view sin
                    and cos as the projections of two different fixed points
                    onto a single ruler, which is the rotating object:
                  </OuterP>
                  <Pause />
            ...
            <Exercise number={51}>
              <ExerciseStatement id="_140_h.a.i_">
                <OuterP>
                  <b>Exercise 51.</b> Which function is most plausibly
            ...
            <Exercise number={52}>
              <ExerciseStatement id="_141_h.a.i_">
                <OuterP>
                  <b>Exercise 52.</b> Where or how, if at all, is the
                </OuterP>
                <Pause />
                <CentralDisplayItalic>
            ...
            <Exercise number={57}>
              <ExerciseStatement id="_146_h.a.i_">
                <OuterP>
                  <b>Exercise 57.</b> Show that for all{" "}
