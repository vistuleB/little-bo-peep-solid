...
const Article = () => {
  ...
  return (
    <>
      <Chapter number={5} title="The Trigonometric Functions">
        <a class="prev_page" href="/article/chapter4" />
        <Rest />
      </Chapter>
    </>
  );
    ...
    <>
      {showMore() && (
        <>
          <Section>
            <VerticalChunk>
              <b>Cos and Sin. (“Cosine” and “sine”.)</b> We've already
              encountered the ‘cos’ function in Exercise 7 of Chapter 3, e.g..
            ...
            <Pause />
            <VerticalChunk>
              It has a close cousin named ‘sin’. While <Math>$\cos(x)$</Math>{" "}
              “tops off” at{" "}
              <NoBreak>
                <Math>$x = 0$</Math>,
              </NoBreak>{" "}
            ...
            <VerticalChunk>
              ...
              it turns out, as we can know by a calculator equipped with ‘sin’
              and ‘cos’):
            </VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>
              Indeed, going <Math>$-3$</Math> units counterclockwise—which
              means, going <Math>$3$</Math> units clockwise—on the unit circle,
              starting from{" "}
              <NoBreak>
                <Math>$(1, 0)$</Math>,
              </NoBreak>{" "}
            ...
            <VerticalChunk>
              ...
              <i>minus one-quarter the circumference of a unit circle</i>,
              because <Math>$(0, -1)$</Math> is one-quarter of the unit circle
              clockwise from{" "}
              <NoBreak>
                <Math>$(1, 0)$</Math>.
              </NoBreak>{" "}
              Note that one-quarter the circumference of a unit circle was
              estimated to be
            </VerticalChunk>
            <Pause />
            <MathBlock>
            ...
            <VerticalChunk>
              ...
              for that matter, which may or may not be cheating), which agrees
            ...
            <VerticalChunk>
              ...
              <Math>$\sin(x)$</Math> and <Math>$\cos(x)$</Math> are both defined
              by{" "}
              <NoBreak>
                <Math>$x$</Math>
                -coordinates:
            ...
            <Pause />
            <VerticalChunk>
              In more detail, if you tilt your head sideways, you will see that
              the <Math>$x$</Math> axis looks, from the vantage point of{" "}
              <NoBreak>
                <Math>$(0, -1)$</Math>,
              </NoBreak>{" "}
              the same as the <Math>$y$</Math> axis looks from the vantage point
              of{" "}
              <NoBreak>
                <Math>$(1, 0)$</Math>.
              </NoBreak>{" "}
            ...
            <VerticalChunk indent={true}>
              In particular, <Math>$\sin(x)$</Math> and <Math>$\cos(x)$</Math>{" "}
              can also be understood as the{" "}
              <NoBreak>
                <Math>$x$</Math>
                -coordinates
              </NoBreak>{" "}
              of two particles on the unit circle such that the ‘sin’ particle
              is one-quarter-turn behind the{" "}
              <NoBreak>
                ‘<Math>$\cos$</Math>’
              </NoBreak>{" "}
              particle:
            ...
            <VerticalChunk>
              ...
              (“Lagging” when you read the graphs from left to right.) It's
              because the ‘sin’ particle follows in the trail blazed by the
              ‘cos’ particle, namely!
            </VerticalChunk>
          </Section>
          <Pause />
          <Section>
            ...
            <Pause />
            <VerticalChunk>also known simply as</VerticalChunk>
            <Pause />
            <CentralDisplay>
              {" "}
              <NoBreak>
            ...
            <Pause />
            <VerticalChunk>by the general definition that</VerticalChunk>
            <Pause />
            ...
            <VerticalChunk indent={true}>However, note that</VerticalChunk>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <VerticalChunk>to finish the computation), and that</VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>
              to finish the computation), which means that you only need to
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>Two more identities</VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>We also have these identities...</VerticalChunk>
            <Pause />
            <MathBlock>
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>given that</VerticalChunk>
            <Pause />
            <MathBlock>$$ \sin(x + \eta) = \cos(x) $$</MathBlock>
            <Pause />
            <MathBlock>$$ \cos(x + \eta) = -\!\sin(x) $$</MathBlock>
            <Pause />
            <VerticalChunk>as seen in the previous section.</VerticalChunk>
            <VerticalChunk indent={true}>
            ...
            <VerticalChunk>
              ...
              Each derivative is obtained by moving to the next particle in the
              order of rotation, i.e., by adding <Math>$+\eta$</Math> to the
              input!
            </VerticalChunk>
          </Section>
          <Pause />
          <Section>
            ...
            <Pause />
            <VerticalChunk>
              is forevermore suspect, because it might just be
            </VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>(variable not important) might be</VerticalChunk>
            <Pause />
            <MathBlock>$$ 1 - \cos^2(y) $$</MathBlock>
            <Pause />
            <VerticalChunk>just as</VerticalChunk>
            <Pause />
            <MathBlock>$$ \cos^2(y) $$</MathBlock>
            <Pause />
            <VerticalChunk>might be</VerticalChunk>
            <Pause />
            ...
            <MathBlock>$$ 1 - \sin^2(y) $$</MathBlock>
            <Pause />
            <VerticalChunk>might end up respectively rewritten</VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>
              by the difference-of-squares factorization), and
            </VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>or otherwise</VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>this one.) Etc.</VerticalChunk>
          </Section>
          <Pause />
          <Section>
            <VerticalChunk>
            ...
            <Pause />
            <VerticalChunk>
              of an angle was briefly touched upon in Note 1 of Exercise 37,
              Chapter 4. In short, it is a “scientific” measure of angles in
              which the value of an angle is the length of a circular arc
              subtended by the angle, divided by the radius of that arc:
            </VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>To imprint this fact in our memories:</VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>aaaand... and so on.</VerticalChunk>
            <VerticalChunk indent={true}>
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>converts from degrees to radians.</VerticalChunk>
            ...
            <Pause />
            <VerticalChunk>per this definition.</VerticalChunk>
            <VerticalChunk indent={true}>
            ...
            <Pause />
            <VerticalChunk>as a stand-in for</VerticalChunk>
            <Pause />
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>is on the unit circle, as is</VerticalChunk>
            <Pause />
            <MathBlock>
              $$ (\sqrt&#123;0.1&#125;, \sqrt&#123;0.9&#125;) $$
            </MathBlock>
            ...
            <Pause />
            <VerticalChunk>Here</VerticalChunk>
            <Pause />
            <MathBlock>
              $$ (\sqrt&#123;0.5&#125;,\,
              \sqrt&#123;0.5&#125;\rt&#123;0.2&#125;) $$
            ...
            <Pause />
            <VerticalChunk>in radians. Symmetrically,</VerticalChunk>
            <Pause />
            <MathBlock>
            ...
            <VerticalChunk indent={true}>
              For the remaining values, observe the existence of the following
            ...
            <Pause />
            <VerticalChunk>
              These triangles imply that the the unique point on the unit circle
              with{" "}
              <NoBreak>
                <Math>$x$</Math>
                -coordinate
              ...
              <Math>$60^\circ\hlfbk$</Math> from the <Math>$x$</Math> axis, and
              that the unique point on the unit circle with{" "}
              <NoBreak>
                <Math>$y$</Math>
                -coordinate
              </NoBreak>{" "}
            ...
            <Pause />
            <VerticalChunk>by conclusion; or</VerticalChunk>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <VerticalChunk>in radians!</VerticalChunk>
            <VerticalChunk indent={true}>
            ...
            <Pause />
            <VerticalChunk>a.k.a.,</VerticalChunk>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <VerticalChunk>in radians, etc.)</VerticalChunk>
            <Pause />
            <VerticalChunk>
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>or, in individual formulas,</VerticalChunk>
            <Pause />
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>or namely with the property that:</VerticalChunk>
            <TextParent>
            ...
            <Pause />
            <VerticalChunk>namely.)</VerticalChunk>
            <VerticalChunk indent={true}>
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>...the relationship can be written:</VerticalChunk>
            <Pause />
            <Image src="/images/svg_ch5_ch_relationships_of_note.svg" />
            <Pause />
            <VerticalChunk>To be paired with this figure:</VerticalChunk>
            <Pause />
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>The eponymous</VerticalChunk>
            <Pause />
            <CentralDisplayItalic>Abercrombie inequality</CentralDisplayItalic>
            <Pause />
            <VerticalChunk>states that</VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>The point is that</VerticalChunk>
            <Pause />
            <MathBlock>
              $$ \overline&#123;s_1s_2&#125;\, &gt;
              \,\overline&#123;p_1p_2&#125; $$
          ...
          <Section>
            <VerticalChunk>
              <b>The “Fisher sandwich”.</b> The “Fisher sandwich”—we don't make
              these terms up—states that
            </VerticalChunk>
            <Pause />
            <MathBlock>
              $$ \sin(\theta) \,&lt;\, \theta \,&lt;\,
            ...
            <VerticalChunk>
              ...
              The Fisher sandwich is so-called because it “sandwiches”{" "}
              <Math>$\theta$</Math> between
            </VerticalChunk>
            <Pause />
            <MathBlock>$$ \sin(\theta) $$</MathBlock>
            <Pause />
            <VerticalChunk>below, and</VerticalChunk>
            <Pause />
            <MathBlock>
              $$ &#123;\sin(\theta)\over\cos(\theta)&#125; $$
            </MathBlock>
            <Pause />
            <VerticalChunk>above. (Indeed,</VerticalChunk>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <VerticalChunk>makes you</VerticalChunk>
            <Pause />
            ...
            <VerticalChunk indent={true}>The first inequality</VerticalChunk>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <VerticalChunk>Specifically,</VerticalChunk>
            <Pause />
            ...
            <VerticalChunk indent={true}>The fact that</VerticalChunk>
            <Pause />
            <MathBlock>
              $$ &#123;\theta&#125; \rt&#123;0.1&#125;&lt;\rt&#123;0.1&#125;
              &#123;\sin(\theta)\over \cos(\theta)&#125; $$
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>...works as well!)</VerticalChunk>
            <VerticalChunk indent={true}>
          ...
          <Section>
            ...
            <VerticalChunk indent={true}>You may observe that</VerticalChunk>
            <Pause />
            ...
            <Pause />
            <VerticalChunk>modulo a technicality, and</VerticalChunk>
            <Pause />
            <MathBlock>
              $$ \tan \,=\, \sec \cdot \sin \,\,=\,\,
            ...
            <VerticalChunk>
              ...
              our proof of the Fisher sandwich.) (Indeed: the Fisher sandwich
              can be written...
            </VerticalChunk>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <VerticalChunk>...in this form, as well!)</VerticalChunk>
          </Section>
          <Pause />
          <Section>
            <VerticalChunk>
            ...
            <Pause />
            <VerticalChunk>which gives</VerticalChunk>
            <Pause />
            <MathBlock>
          ...
          <Exercises>
            <Exercise exercise_number={1}>
              ...
              <Solution solution_number={1}>
                ...
                <Pause />
                <VerticalChunk>or its graph</VerticalChunk>
                <Pause />
            ...
            <Exercise exercise_number={3}>
              ...
              <Solution solution_number={3}>
                ...
                />
                <Pause />
                <VerticalChunk>[Nb:</VerticalChunk>
                <Pause />
                <CentralDisplayItalic>parabolic</CentralDisplayItalic>
                <Pause />
                <VerticalChunk>is a synonym of</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>i.e., a function of the form</VerticalChunk>
                <Pause />
                ...
                <VerticalChunk indent={true}>The value</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>(in more detail,</VerticalChunk>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <VerticalChunk>per this estimate.</VerticalChunk>
                <VerticalChunk indent={true}>
                ...
                <Pause />
                <VerticalChunk>...giving us...</VerticalChunk>
                <Pause />
                <MathBlock>
            ...
            <Exercise exercise_number={4}>
              ...
              <Solution solution_number={4}>
                ...
                <MathBlock>$$ y = -&#123;1\over 4&#125;x $$</MathBlock>
                <Pause />
                <VerticalChunk>or thereabouts.</VerticalChunk>
                <VerticalChunk indent={true}>
                ...
                <Pause />
                <VerticalChunk>This graph has the form</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>has graph...</VerticalChunk>
                <Pause />
                <Image
                ...
                <Pause />
                <VerticalChunk>i.e., use</VerticalChunk>
                <Pause />
                ...
                <VerticalChunk indent={true}>(So far we have</VerticalChunk>
                <Pause />
                <MathBlock>
                ...
                <VerticalChunk indent={true}>Altogether, we get</VerticalChunk>
                <Pause />
                <MathBlock>
            ...
            <Exercise exercise_number={5}>
              ...
              <Solution solution_number={5}>
                <VerticalChunk>The culprits are:</VerticalChunk>
                <Pause />
            ...
            <Exercise exercise_number={6}>
              ...
              <Solution solution_number={6}>
                ...
                />
                <Pause />
                <VerticalChunk>And this occurs because</VerticalChunk>
                <Pause />
            ...
            <Exercise exercise_number={7}>
              <VerticalChunk>
                <b>Exercise 7.</b> Compute the ratio <Math>$A/B$</Math> assuming
                all same-colored triangles are similar, with the help of a
                calculator:
              </VerticalChunk>
              <Pause />
              <Image
              ...
              <Solution solution_number={7}>
                ...
                <Pause />
                <VerticalChunk>(that can also be written</VerticalChunk>
                <Pause />
                <MathBlock>
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <VerticalChunk>quadrilaterals, or</VerticalChunk>
                  <Pause />
                  <MathBlock>$$ 2 \times 18 = 36 $$</MathBlock>
                  <Pause />
                  <VerticalChunk>quadrilaterals for two turns!</VerticalChunk>
                </SolutionNote>
              </Solution>
            </Exercise>
            <Exercise exercise_number={8}>
              <VerticalChunk>
                <b>Exercise 8.</b> In the drawing below the oval is a circle of
                radius <Math>$r$</Math> and the angle <Math>$\phi$</Math> is in
                “standard position”, meaning that it opens counterclockwise for
                a positive angle from the direction of the positive{" "}
                <Math>$x$</Math> axis. What are the coordinates of{" "}
                <Math>$P$</Math> in terms of{" "}
                <NoBreak>
                  <Math>$r$</Math>,
                </NoBreak>{" "}
                <NoBreak>
            ...
            <Exercise exercise_number={9}>
              ...
              <Solution solution_number={9}>
                ...
                <Pause />
                <VerticalChunk>of a vector</VerticalChunk>
                <Pause />
                <MathBlock>$$ \vec&#123;u&#125; = (u_x, u_y) $$</MathBlock>
                <Pause />
                <VerticalChunk>and of a vector</VerticalChunk>
                <Pause />
                <MathBlock>$$ \vec&#123;v&#125; = (v_x, v_y) $$</MathBlock>
                <Pause />
                <VerticalChunk>is the vector</VerticalChunk>
                <Pause />
            ...
            <Exercise exercise_number={10}>
              <VerticalChunk>
                <b>Exercise 10.</b> If a particle in <Math>$\rr^2$</Math> (= “in
                the plane”) has{" "}
                <NoBreak>
                  <Math>$x$</Math>
                  -coordinate
              ...
              <Pause />
              <VerticalChunk>
                at time <Math>$t$</Math> what is the most likely motion that the
                particle is undergoing? In that case, what is the geometric
              ...
              <Solution solution_number={10}>
                ...
                <VerticalChunk>And either:</VerticalChunk>
                <TextParent>
                  <ul style="list-style-type:disc;margin-top:1em;margin-bottom:1em;padding-left:66px;line-height:1.7em;">
                    <li>
                ...
                <VerticalChunk>In more detail, every time</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>
                  is an amount of <i>clockwise</i>
                  radians. The following diagram illustrates the two
                  possibilities:
                </VerticalChunk>
                <Pause />
            ...
            <Exercise exercise_number={11}>
              <VerticalChunk>
                <b>Exercise 11.</b> Take a particle traveling around a circle at
                constant speed. What is the number of cycles [full revolutions]
                per <Math>$4\eta$</Math> units of time equal to, by another
                name?
              </VerticalChunk>
              <Pause />
              <Solution solution_number={11}>
                <VerticalChunk>Let</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>say that the particle travels</VerticalChunk>
                <Pause />
                <CentralDisplayItalic>
                  {" "}
                ...
                <Pause />
                <VerticalChunk>or that the particle travels</VerticalChunk>
                <Pause />
                <CentralDisplayItalic>
                  {" "}
            ...
            <Exercise exercise_number={12}>
              <VerticalChunk>
                <b>Exercise 12.</b> Which of these angles is <Math>$0.2$</Math>{" "}
                radians?
              </VerticalChunk>
              <Pause />
              ...
              <Solution solution_number={12}>
                <VerticalChunk>An angle is </VerticalChunk>
                <Pause />
                ...
                />
                <Pause />
                <VerticalChunk>(Joking.)</VerticalChunk>
              </Solution>
            </Exercise>
            <Exercise exercise_number={13}>
              ...
              <Pause />
              <VerticalChunk>represent?</VerticalChunk>
              <Pause />
            ...
            <Exercise exercise_number={14}>
              ...
              <Pause />
              <VerticalChunk>by hand using long division.</VerticalChunk>
              <Pause />
              <Solution solution_number={14}>
                ...
                <SolutionNote>
                  ...
                  />
                  <Pause />
                  <VerticalChunk>We subtract</VerticalChunk>
                  <VerticalChunk indent={true}>
                    <div style="font-size:1.65em;margin:1em 0;">
            ...
            <Exercise exercise_number={15}>
              ...
              <Solution solution_number={15}>
                ...
                <Pause />
                <VerticalChunk>From which...</VerticalChunk>
                <Pause />
                <MathBlock>
                  $$ \Large \up&#123;1.5&#125;&#123;22\over 7&#125; =
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <VerticalChunk>...we thus have...</VerticalChunk>
                  <Pause />
                  <MathBlock>
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <VerticalChunk>from</VerticalChunk>
                  <Pause />
                  <MathBlock>
            ...
            <Exercise exercise_number={16}>
              <VerticalChunk>
                <b>Exercise 16.</b> To close our division skills: use the table
                below to compute the integer part and the first three digits
                past the decimal point (no rounding based on the fourth digit)
                of
              </VerticalChunk>
              <Pause />
              ...
              <VerticalChunk>
                ...
                when the quotient reaches the 3rd digit after the decimal point,
                and what equation is implied from the quotient and the new
                (last) remainder at that point?
              </VerticalChunk>
              <Pause />
              <MathBlock>
                $$ \begin&#123;array&#125;&#123;c|cc&#125;
              ...
              <Solution solution_number={16}>
                ...
                <Pause />
                <VerticalChunk>Said quotient is</VerticalChunk>
                <Pause />
                <MathBlock>$$ 20003200099.033 $$</MathBlock>
                <Pause />
                <VerticalChunk>while the new (last) remainder is</VerticalChunk>
                <Pause />
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <VerticalChunk>...these yellow digits.) Etc.</VerticalChunk>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <VerticalChunk>
                  ...
                  <Pause />
                  <VerticalChunk>
                    The answer is: <Math>$4$</Math> [miles*] (*say):
                  </VerticalChunk>
                  <Pause />
                  ...
                  <Pause />
                  <VerticalChunk>Etc—we finally obtain:</VerticalChunk>
                  <Pause />
                  <Image
            ...
            <Exercise exercise_number={17}>
              <VerticalChunk>
                <b>Exercise 17.</b> What is the angle marked ‘?’, as a function
                of{" "}
                <NoBreak>
                  <Math>$\theta$</Math>?
                </NoBreak>
              ...
              <Solution solution_number={17}>
                ...
                <SolutionNote>
                  <VerticalChunk>
                    ...
                    a right triangle are, therefore, complementary!
                  </VerticalChunk>
                </SolutionNote>
              </Solution>
            </Exercise>
            <Exercise exercise_number={18}>
              ...
              <Solution solution_number={18}>
                <VerticalChunk>The sum</VerticalChunk>
                <Pause />
                <MathBlock>$$ x + y $$</MathBlock>
                <Pause />
                <VerticalChunk>where</VerticalChunk>
                <Pause />
                <MathBlock>$$ (x, y) $$</MathBlock>
                <Pause />
                <VerticalChunk>
                ...
                <VerticalChunk indent={true}>Having said this,</VerticalChunk>
                <Pause />
                <MathBlock>$$ \cos(x) + \sin(x) $$</MathBlock>
                <Pause />
                <VerticalChunk>
                ...
                <Pause />
                <VerticalChunk>(cf. Exercise 1, Chapter 1).</VerticalChunk>
                <Pause />
                <SolutionNote>
                  <VerticalChunk>
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <VerticalChunk>(Note that</VerticalChunk>
                  <Pause />
                  <MathBlock>
            ...
            <Exercise exercise_number={19}>
              <VerticalChunk>
                <b>Exercise 19.</b> What is the angle marked ‘?’, as a function
                of{" "}
                <NoBreak>
                  <Math>$\theta$</Math>?
                </NoBreak>
            ...
            <Exercise exercise_number={21}>
              ...
              <Pause />
              <VerticalChunk>...is a so-called</VerticalChunk>
              <Pause />
              <CentralDisplayItalic>isoset</CentralDisplayItalic>
              <Pause />
              <VerticalChunk>
                (also: <i>isoline</i>, <i>contour line</i>, <i>isoquant</i>,{" "}
                <i>isosurface</i>, <i>isovalue line</i>, or <i>isovalue set</i>{" "}
                <NoBreak>
                  <Math>$\rt&#123;0.1&#125;$</Math>)
                </NoBreak>{" "}
              ...
              <Pause />
              <VerticalChunk>given by</VerticalChunk>
              <Pause />
              <MathBlock>$$ f(x, y) = x + y $$</MathBlock>
              <Pause />
              <VerticalChunk>then what are similar</VerticalChunk>
              <Pause />
              ...
              <VerticalChunk>
                ...
                and specify the set of values of <Math>$\theta$</Math> for which
                the maximum is attained.
              </VerticalChunk>
              <Pause />
              <Solution solution_number={21}>
                <VerticalChunk>The isosets of</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>(or: “the isoset</VerticalChunk>
                <Pause />
                <MathBlock>
                  $$ \&#123;(x, y) \in \rr^2 : xy = 0 \&#125; $$
                </MathBlock>
                ...
                <MathBlock>$$ xy = 0 $$</MathBlock>
                <Pause />
                <VerticalChunk>if and only</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>In particular,</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>as per this illustration...</VerticalChunk>
                <Pause />
                <Image src="/images/svg_ch5_ex_max_xy_angles.svg" />
                <Pause />
                <VerticalChunk>...and the maximum value of</VerticalChunk>
                <Pause />
                <MathBlock>$$ \Large \cos\theta\,\sin\theta $$</MathBlock>
                <Pause />
                <VerticalChunk>itself will be</VerticalChunk>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <VerticalChunk>
                  equivalently; though one should also note that
                </VerticalChunk>
                <Pause />
                <MathBlock>
                  $$ \Large \&#123;0.5\eta + 4\eta&#123;&#125;k : k \in
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <VerticalChunk>achieved for inputs in the set</VerticalChunk>
                  <Pause />
                  <MathBlock>
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <VerticalChunk>surprise or not) the curve</VerticalChunk>
                  <Pause />
                  <MathBlock>$$ xy = 2 $$</MathBlock>
                  <Pause />
                  <VerticalChunk>
                  ...
                  <Pause />
                  <VerticalChunk>of the curve</VerticalChunk>
                  <Pause />
                  <MathBlock>$$ xy = 1 $$</MathBlock>
                  <Pause />
                  <VerticalChunk>
                  ...
                  <Pause />
                  <VerticalChunk>More generally, the curve</VerticalChunk>
                  <Pause />
                  <MathBlock>$$ xy = C $$</MathBlock>
                  <Pause />
                  <VerticalChunk>
                  ...
                  <Pause />
                  <VerticalChunk>is the</VerticalChunk>
                  <Pause />
                  <CentralDisplayItalic>
                    {" "}
                    <NoBreak>
                  ...
                  <VerticalChunk indent={true}>(Indeed, since</VerticalChunk>
                  <Pause />
                  <MathBlock>$$ xy = C $$</MathBlock>
                  <Pause />
                  <VerticalChunk>if and only if</VerticalChunk>
            ...
            <Exercise exercise_number={22}>
              <VerticalChunk>
                <b>Exercise 22.</b> Express <Math>$A/B$</Math> as a function of{" "}
                <NoBreak>
                  <Math>$\theta$</Math>:
                </NoBreak>
              </VerticalChunk>
              ...
              <Solution solution_number={22}>
                ...
                <Pause />
                <VerticalChunk>The answer is therefore:</VerticalChunk>
                <Pause />
                <MathBlock>
            ...
            <Exercise exercise_number={23}>
              <VerticalChunk>
                <b>Exercise 23.</b> Express <Math>$A/B$</Math> as a function of{" "}
                <NoBreak>
                  <Math>$\theta$</Math>:
                </NoBreak>
              </VerticalChunk>
              ...
              <Solution solution_number={23}>
                <VerticalChunk>Here are two solutions:</VerticalChunk>
                <Pause />
                <VerticalChunk>
                ...
                <Pause />
                <VerticalChunk>Thus:</VerticalChunk>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <VerticalChunk>We find:</VerticalChunk>
                <Pause />
                <MathBlock>
                  $$ &#123;A\over B&#125; = &#123;&#123;B + A'&#125;\over
                ...
                <Pause />
                <VerticalChunk>by Exercise 22. (The End.)</VerticalChunk>
                <Pause />
                <SolutionNote>
                  <VerticalChunk>
            ...
            <Exercise exercise_number={24}>
              <VerticalChunk>
                <b>Exercise 24.</b> In general, <Math>$\sec(\theta)$</Math> and{" "}
                <Math>$\tan(\theta)$</Math> are defined for all{" "}
                <Math>$\theta$</Math> such that
              </VerticalChunk>
              <Pause />
              <MathBlock>$$ \cos(\theta) \ne 0 $$</MathBlock>
              <Pause />
              <VerticalChunk>with the definitions being...</VerticalChunk>
              ...
              <Solution solution_number={24}>
                ...
                <Pause />
                <VerticalChunk>and, by the definitions,</VerticalChunk>
                <Pause />
                <MathBlock>
            ...
            <Exercise exercise_number={25}>
              <VerticalChunk>
                <b>Exercise 25.</b> Run the computation of the previous exercise
                backwards, starting with
              </VerticalChunk>
              <Pause />
              <MathBlock>$$ \sec^2(\theta) $$</MathBlock>
              <Pause />
              <VerticalChunk>at the near end, and ending with</VerticalChunk>
              <Pause />
              ...
              <Solution solution_number={25}>
                <VerticalChunk>Viz:</VerticalChunk>
            ...
            <Exercise exercise_number={26}>
              <VerticalChunk>
                <b>Exercise 26.</b> Here are four function compositions depicted
                as “function box” diagrams, with inputs coming in the right and
                outputs going out the left (with <Math>$f$</Math> being some
                generic function):
              </VerticalChunk>
              <Pause />
              <Image src="/images/svg_ch5_ex_four_compositions.svg" />
              <Pause />
              <VerticalChunk>Rewrite each case:</VerticalChunk>
              <TextParent>
                <ol style="margin-top:0.5em;" class="l1">
                  <li>
              ...
              <Solution solution_number={26}>
                ...
                <Pause />
                <VerticalChunk>...etc. (All are correct.)</VerticalChunk>
                <Pause />
                <VerticalChunk>
            ...
            <Exercise exercise_number={28}>
              ...
              <Solution solution_number={28}>
                ...
                <MathBlock>
                  ...
                  2\eta)\\ =&\,\,\, \up&#123;1.2&#125;\cos(x + 2\eta)\cdot\sin(x
                  + 2\eta)\\ =&\,\,\,
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <VerticalChunk>is a shorthand for</VerticalChunk>
                  <Pause />
                  <MathBlock>
                    $$ \te&#123;“&#125;\rt&#123;0.1&#125;x \ra
                  ...
                  <Pause />
                  <VerticalChunk>...it unfolds to...</VerticalChunk>
                  <Pause />
            ...
            <Exercise exercise_number={29}>
              ...
              <Pause />
              <VerticalChunk>
                ...it <i>appears</i> that one graph is a translate of the other;
                if this were really so, what would the exact amounts of
                translation be? (Vertical <i>&</i> horizontal.) What algebraic
                identity would this imply? How to prove this identity?
              </VerticalChunk>
              <Pause />
              <Solution solution_number={29}>
                ...
                <Pause />
                <VerticalChunk>If true, this would indicate that</VerticalChunk>
                <center style="margin-top:1em;margin-bottom:1em;">
                ...
                <Pause />
                <VerticalChunk>...from which the product...</VerticalChunk>
                <Pause />
                ...
                <MathBlock>
                  ...
                  =\,\,&&#123;1\over 2&#125;\cdot(\cos^2(x) - (1 - \cos^2(x)))
                  \\ \up&#123;1.6&#125; =\,\,&&#123;1\over
                ...
                <SolutionNote>
                  ...
                  <MathBlock>
                    ...
                    \\ \up&#123;1.6&#125; =\,\,&&#123;1\over 2&#125;\cdot(\cos^2
                    x + 2\cos x\sin x + \sin^2 x) \\ \up&#123;1.6&#125;
                    =\,\,&&#123;1\over 2&#125;\cdot(1 + 2\cos x\sin x) \\
                    \up&#123;1.6&#125; =\,\,&&#123;1\over 2&#125; +
                  ...
                  <MathBlock>
                    ...
                    \cos^2(x - \eta/2) \\ \up&#123;1.7&#125; =\,\,&-&#123;1\over
                    2&#125; + \left(&#123;1\over 2&#125; + \cos(x)\sin(x)\right)
                    \\ \up&#123;1.7&#125; =\,\,&\cos(x)\sin(x)
                    \end&#123;align*&#125; $$
                  </MathBlock>
                  <Pause />
                  <VerticalChunk>as claimed.</VerticalChunk>
                </SolutionNote>
              </Solution>
            </Exercise>
            <Exercise exercise_number={30}>
              ...
              <VerticalChunk>
                ...
                can be conjectured to relate the two graphs? Can you prove this
                geometric relationship by algebra?
              </VerticalChunk>
              <Pause />
              <Solution solution_number={30}>
                ...
                <VerticalChunk>...by algebraic means.</VerticalChunk>
                <VerticalChunk indent={true}>
                ...
                <Pause />
                <VerticalChunk>which gives us</VerticalChunk>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align*&#125; &#123;1 + \cos(2x)\over 2&#125; &=
                  \up&#123;2.0&#125; &#123;1 + \cos^2(x) - \sin^2(x) \over
                  2&#125; \\ &= \up&#123;2.0&#125; &#123;(1 - \sin^2(x)) +
                  \cos^2(x)\over 2&#125; \\ &= \up&#123;2.0&#125;
                  &#123;\cos^2(x) + \cos^2(x)\over 2&#125; \\ &=
            ...
            <Exercise exercise_number={31}>
              ...
              <Solution solution_number={31}>
                <VerticalChunk>The angle-sum formula for sin is</VerticalChunk>
                <Pause />
                <MathBlock>
                  $$ \sin(A+B) = \cos A\sin B + \sin A\cos B $$
                </MathBlock>
                ...
                <MathBlock>
                  ...
                  \up&#123;1.6&#125; =&\,\, 2\sin x\cos x \end&#123;align*&#125;
                  $$
                </MathBlock>
                <Pause />
                <VerticalChunk>and</VerticalChunk>
            ...
            <Exercise exercise_number={32}>
              <VerticalChunk>
                ...
                can turn [the graph] <Math>$y = \sin(x)$</Math> into [the graph]{" "}
                <NoBreak>
            ...
            <Exercise exercise_number={33}>
              ...
              <Pause />
              <VerticalChunk>onto the graph</VerticalChunk>
              <Pause />
              <MathBlock>$$ y = \sin x + \cos x $$</MathBlock>
              <Pause />
              <VerticalChunk>
                ...? (Study Exercise 18, if you have no inspiration.) (PS: Prove
                your answer.)
              </VerticalChunk>
              <Pause />
              <Solution solution_number={33}>
                ...
                <Pause />
                <VerticalChunk>like a sinusoid, we have</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>...again, giving us...</VerticalChunk>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <VerticalChunk>...victory!!!!</VerticalChunk>
                <Pause />
                <SolutionNote>
                  <VerticalChunk>
                    <i>Note 1.</i> The fact that
                  ...
                  <Pause />
                  <VerticalChunk>that some might prefer.</VerticalChunk>
                </SolutionNote>
              </Solution>
            </Exercise>
            <Exercise exercise_number={34}>
              ...
              <Solution solution_number={34}>
                <VerticalChunk>One approach is to expand</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>comparing to</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>...that we can actually rewrite </VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>are the</VerticalChunk>
                <Pause />
                <CentralDisplayItalic>polar coordinates</CentralDisplayItalic>
                <Pause />
                <VerticalChunk>of the Cartesian point</VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>
                  of this exercise, and in which case we can set
                </VerticalChunk>
                <Pause />
                ...
                <Pause />
                <VerticalChunk>because the pair</VerticalChunk>
                <Pause />
                <MathBlock>
                  $$ (W, \,-\psi) \,=\, (\sqrt&#123;2&#125;, \,\,\eta/2) $$
                </MathBlock>
                ...
                <Pause />
                <VerticalChunk>(In fact, the fact that...</VerticalChunk>
                <center style="margin-top:1em;margin-bottom:1em;">
                  <div style="display:inline-block;border:1px solid red;padding:1em 1em;">
                    <MathBlock>
            ...
            <Exercise exercise_number={35}>
              ...
              <VerticalChunk indent={true}>
                ...
                to that exercise is bound to produce a mess—solving from scratch
                is recommended!)
              </VerticalChunk>
              <Pause />
              <Solution solution_number={35}>
                <VerticalChunk>Expanding</VerticalChunk>
                <Pause />
                <MathBlock>$$ \sin(x + \psi) $$</MathBlock>
                <Pause />
                <VerticalChunk>by the angle-sum formula gives</VerticalChunk>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <VerticalChunk>and equating to</VerticalChunk>
                <Pause />
                <MathBlock>$$ A_1\cdot\sin x + A_2\cdot\cos x $$</MathBlock>
                <Pause />
                <VerticalChunk>gives the system of equations</VerticalChunk>
                <Pause />
                <MathBlock>$$ W\cdot\cos \psi = A_1 $$</MathBlock>
                <Pause />
                <MathBlock>$$ W\cdot\sin \psi = A_2 $$</MathBlock>
            ...
            <Exercise exercise_number={36}>
              <VerticalChunk>
                <b>Exercise 36.</b> Similarly to Exercise 9, suggest a
              ...
              <Solution solution_number={36}>
                <VerticalChunk>We define</VerticalChunk>
                <Pause />
                <MathBlock>
