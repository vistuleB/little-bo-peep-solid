    ...
    <Article
      ...
      <SectionsBreadcrumbs>
        ...
        <BreadcrumbItem id="breadcrumb-1">
          <InChapterLink href="?id=section-2">§2. derivatives</InChapterLink>
        </BreadcrumbItem>
      ...
      <Section work="ing" id="section-1">
        <OuterP>
          <b>§1. Cos and sin. (“Cosine” and “sine”.)</b> We have already
          encountered the ‘cos’ function in{" "}
          <a href="/article/chapter3#_44_h.a.i_" class="out-chapter-link">
        ...
        <OuterP>
          ...
          <Math>$\sin(x)$</Math> goes diagonally through{" "}
          <NoBreak>
            <Math>$(0, 0)$</Math>:
          </NoBreak>
        </OuterP>
        ...
        <OuterP>
          ...
          <Math>$(1, 0)$</Math> on the unit circle. (Note that “a”
        </OuterP>
        <Pause />
        ...
        <OuterP>
          ...
          For example, observe from the graphs that{" "}
          <NoBreak>
        ...
        <OuterP>
          ...
          which is what a calculator equipped with ‘sin’ and ‘cos’ will tell
          us):
        </OuterP>
        <Pause />
        ...
        <Pause />
        <OuterP>
          Some thought reveals that such a value <Math>$x$</Math> does exist,
          and more precisely equals{" "}
        ...
        <OuterP>
          in{" "}
          <a href="/article/chapter4#_85_h.a.i_" class="out-chapter-link">
            Exercise 26 of Chapter 3
          </a>{" "}
          (by direct inspection of the graph{" "}
          <NoBreak>
            <Math>$y = \cos(x)$</Math>,
          </NoBreak>{" "}
  ...
  return (
    <>
      {showMore() && (
        <>
          <Pause />
          <Section _handle="trigonometry-derivatives" id="section-2">
            <OuterP>
              <b>§2. Derivatives.</b> Continuing the last topic, we can add two
              more particles to the diagram that defines ‘sin’ and ‘cos’ via{" "}
              <NoBreak>
                <Math>$x$</Math>
                -coordinates.
              </NoBreak>{" "}
            ...
            <Pause />
            <OuterP>which is also known simply as</OuterP>
            <Pause />
            <CentralDisplay>
              <NoBreak>
                “<Math>$-\!\sin$</Math>”
            ...
            <Pause />
            <OuterP>
              These are the same four curves that appear in{" "}
              <a href="/article/chapter4#_70_h.a.i_" class="out-chapter-link">
            ...
            <Pause />
            <OuterP>
              in general for any <Math>$f : \rr \ra \rr$</Math> (cf.{" "}
              <a href="/article/chapter4#_68_h.a.i_" class="out-chapter-link">
                Exercise 11
              </a>{" "}
              and{" "}
              <a href="/article/chapter4#_69_h.a.i_" class="out-chapter-link">
            ...
            <OuterP>
              ...
              remember the first two equations—though even better is to just
              remember the entire four-particle diagram, and never think about
              signs again!
            </OuterP>
          </Section>
          <Pause />
          <Section id="section-3">
            ...
            <OuterP>
              ...
              &#8288;,{" "}
              <a href="/article/chapter4#_89_h.a.i_" class="out-chapter-link">
                Chapter 4
              </a>
              &#8288;.) You should be able to verify each of these identities
              just by looking at them and thinking of the definitions of{" "}
              <NoBreak>
                <Math>$\sin(x)$</Math>,
              </NoBreak>{" "}
              <NoBreak>
              ...
              in some —casesbut in case something goes wrong, here is a cheat
          ...
          <Section id="section-5">
            <OuterP>
              <b>Parenthetization and powers.</b> It is allowed to write
            </OuterP>
            <Pause />
            <MathBlock>
              $$ \te&#123;“&#125;\cos x\rt&#123;0.2&#125;\te&#123;”&#125; $$
            ...
            <Pause />
            <OuterP>when the input is just one symbol. Also,</OuterP>
            <Pause />
            <MathBlock>$$ \cos^2(x) $$</MathBlock>
            <Pause />
            <OuterP>(or</OuterP>
            <Pause />
            <MathBlock>$$ \cos^2 x $$</MathBlock>
            <Pause />
            <OuterP>similarly to the just-introduced convention) means</OuterP>
            <Pause />
            <MathBlock>$$ (\cos(x))^2 $$</MathBlock>
            <Pause />
            <OuterP>which is a special case of the fact that</OuterP>
            <Pause />
            <MathBlock>$$ f^2(x) = (f(x))^2 $$</MathBlock>
            <Pause />
            <OuterP>
              for any function{" "}
              <NoBreak>
            ...
            <Pause />
            <OuterP>
              for all functions <Math>$f$</Math> and{" "}
              <NoBreak>
                <Math>$g$</Math>.
              </NoBreak>{" "}
          ...
          <Section id="section-7">
            ...
            <Pause />
            <OuterP>
              of an angle is the length of a circular arc subtended by the
              angle, divided by the radius of that arc:
            </OuterP>
            <Pause />
            <Image src="/build-img/svgo-svg/dau_.svg" />
            <Pause />
            <OuterP>
              By this definition, the radian measure of an angle coincides with
              the length of a subtended arc of radius{" "}
              <NoBreak>
                <Math>$1$</Math>:
              </NoBreak>
            </OuterP>
            ...
            <Pause />
            <OuterP>
              In particular, the radian measure of <Math>$90^\circ$</Math> is{" "}
              <NoBreak>
                <Math>$\eta$</Math>:
              </NoBreak>
            </OuterP>
            ...
            <OuterP>
              ...
              next to an angle, that means the angle is a radian.) From there,
              other radian measures can be proportionally deduced; for example,{" "}
              <Math>$45^\circ$</Math> is <Math>$\eta/2$</Math> radians:
            </OuterP>
            <Pause />
            ...
            <Example>
              <OuterP>
                ...
                <Math>$\cos(\eta/2)$</Math> and <Math>$\sin(\eta/2)$</Math> like
                this...
              </OuterP>
              <Pause />
              ...
              <Pause />
              <OuterP>
                ...with the input <Math>$\eta/2$</Math> being a displacement
                along the periphery of the unit circle, or like this...
              </OuterP>
              <Pause />
              <Image src="/build-img/svgo-svg/jn-F.svg" />
              <Pause />
              <OuterP>
                ...with the input <Math>$\eta/2$</Math> being the radian measure
            ...
            <Pause />
            <OuterP>
              <i>Note.</i> The definition of radians also implies that the
              length of a circular arc subtended by an angle is its radian
          ...
          <Section id="section-8">
            <OuterP>
              <b>The degree “°” notation.</b> We consider the degree notation{" "}
              <NoBreak>
                “<Math>$^\circ$</Math>”
              </NoBreak>{" "}
            ...
            <OuterP class="indent-10">Thus, for example,</OuterP>
            <Pause />
            <MathBlock>$$ \cos(90^\circ\hlfbk) = \cos(\eta) $$</MathBlock>
            <Pause />
            <OuterP>
              not because of anything to do with ‘cos’ or by some sort of
              convention, etc, but because <Math>$90^\circ$</Math> and{" "}
              <Math>$\eta$</Math> <i>are the same real number</i>.
            </OuterP>
          </Section>
          <Pause />
          <Section id="section-9">
            ...
            <Pause />
            <OuterP>
              and so on. (If you're curious, points of this family look like
              this:)
            </OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              Vice-versa, every point on the unit circle has the form (*) for
              some <Math>$0 \leq x \leq 1$</Math> and some choice of the{" "}
              <NoBreak>
                ‘<Math>$\pm$</Math>’
              </NoBreak>{" "}
              signs.
          ...
          <Section id="section-10">
            ...
            <Pause />
            <MathBlock>
              $$ \begin&#123;aligned&#125; Q_x &amp;= r\cdot\cos(\theta), \\ Q_y
              &amp;= r\cdot\sin(\theta) \up&#123;1.4&#125;
              \end&#123;aligned&#125; $$
            </MathBlock>
            <Pause />
            <OuterP>
          ...
          <Section id="section-12">
            ...
            <OuterP>
              ...
              function named <span class="code-cartouche">atan2</span> that will
              compute the <i>argument</i> (see Vocabulary below){" "}
            ...
            <OuterP class="indent-10">
              But the call goes <span class="code-cartouche">atan2(y, x)</span>{" "}
              not <span class="code-cartouche">atan2(x, y)</span> by some
              bizareness. (Well, actually a throwback to the fact that in this
              expression...
            </OuterP>
            <Pause />
            <CentralDisplay>
          ...
          <Section id="section-13">
            ...
            <Example>
              <OuterP>
                <b>Example 4.</b> In the following diagram...
              </OuterP>
              <Pause />
            ...
            <Example>
              ...
              <Pause />
              <MathBlock>
                $$ 14\cdot \cos(43^\circ\hlfbk)\cdot \sin(60^\circ\hlfbk)\cdot
                \sin(50^\circ\hlfbk) $$
              </MathBlock>
              <Pause />
              <OuterP>
          ...
          <Section id="section-15">
            ...
            <Pause />
            <OuterP>
              states that the length of the arc is less than or equal to the
              length of the segment, i.e., that
            </OuterP>
            <Pause />
            <MathBlock>$$ A\leq S $$</MathBlock>
            <Pause />
            <OuterP>
              where <Math>$A$</Math> is the length of the arc and{" "}
              <Math>$S$</Math> is the length of the segment, as in the figure.
            </OuterP>
            <OuterP class="indent-10">
              The proof is that, if this were not the case, the length{" "}
              <Math>$S$</Math> of the segment would lie to left of the length{" "}
              <Math>$A$</Math> of the arc on the number line...
            </OuterP>
            <Pause />
            <Image src="/build-img/svgo-svg/KxqB.svg" />
            <Pause />
            <OuterP>
              ...and in the space between <Math>$S$</Math> and{" "}
              <NoBreak>
                <Math>$A$</Math>,
              </NoBreak>{" "}
            ...
            <Pause />
            <OuterP>This last claim follows from the following diagram:</OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              ...on the number line is false—we have achieved a so-called{" "}
              <i>contradiction</i>
            ...
            <Pause />
            <OuterP>
              ...on the number line is an impossibility, i.e., it must be that{" "}
              <NoBreak>
                <Math>$S \geq A$</Math>.
              </NoBreak>{" "}
            ...
            <List
              ...
              <Item>
                <p>
                  ...
                  will still go through (so the segment does not need to{" "}
                  <i>strictly</i> clear the arc);
                </p>
              </Item>
              <Item>
                <p>
                  as long as the angle is nonzero, and the arc has nonzero
                  radius, the length of the segment will be STRICTLY GREATER
                  than the length of the arc, not just greater-or-equal-to
                </p>
              </Item>
            </List>
            <Pause />
          ...
          <Section id="section-18">
            ...
            <OuterP>
              ...
              (Or, more exactly, modulo the fact that what people think of as{" "}
              <NoBreak>
                “<Math>$\pm\infty$</Math>”
              </NoBreak>{" "}
            ...
            <Example id="_91_h.a.i_">
              <OuterP>
                <b>Example 6.</b> If the Earth [is modeled as] a sphere of
                radius <Math>$1$</Math> then, as stands to reason, the circle of
                latitude <Math>$\theta$</Math> has radius{" "}
                <NoBreak>
                  <Math>$\cos(\theta)$</Math>:
                </NoBreak>
              </OuterP>
              <Pause />
              <Image width="480px" src="/build-img/svgo-svg/_wct.svg" />
              <Pause />
              <OuterP>
                [&#8288;
                <InChapterLink
                ...
                height), the radius of a latitude is dilated by [a factor of]{" "}
                <NoBreak>
                  <Math>$\sec(\theta)$</Math>:
                </NoBreak>
              </OuterP>
              ...
              <OuterP>
                ...
                is the correct multiplicative factor to take the Earth-radius to
                the cylinder-radius. (Or just think of the fact that{" "}
                <NoBreak>
                  <Math>$1/\cos(\theta) = \sec(\theta)$</Math>,
                </NoBreak>{" "}
            ...
            <Pause />
            <OuterP>
              <b>**Vocabulary.</b> A (so-called <i>normal</i>){" "}
              <i>cylindrical projection</i> is a projection that maps the Earth
              to a vertical cylinder abutting the Earth at the equator while
              sending each latitude of the Earth to a circle on the cylinder,
              etc; besides the Lambert projection depicted above, two more
              examples are the <i>central cylindrical projection</i> and the{" "}
              <i>plate carée</i>:
            </OuterP>
            <Pause />
            <Image width="1300px" src="/build-img/svgo-svg/sA2I.svg" />
            <Pause />
            <OuterP>
              (In the plate carée, at right, longitudes are “unrolled” onto the
              cylinder, which preserves north-south distances.)
            </OuterP>
          </Section>
          <Pause />
          <Section work="ing" id="section-19">
            <OuterP>
          ...
          <Exercises
            ...
            <Exercise number={1}>
              <ExerciseStatement id="_92_h.a.i_">
                <OuterP>
                  <b>Exercise 1.</b> Guesstimate a function with this graph:
                </OuterP>
                <Pause />
              ...
              <Solution>
                ...
                <OuterP class="indent-10">
                  ...
                  <ImageLeft line={-2} src="/build-img/svgo-svg/9sIf.svg" />
                </OuterP>
                <Pause />
            ...
            <Exercise number={2}>
              <ExerciseStatement id="_93_h.a.i_">
                <OuterP>
                  <b>Exercise 2.</b> Guesstimate a function with this graph (we
              ...
              <Solution>
                ...
                <Pause />
                <MathBlock>$$ A\cdot 12^2 - A\cdot 0^2 \approx 6 $$</MathBlock>
                <Pause />
                <OuterP>
            ...
            <Exercise number={3}>
              <ExerciseStatement id="_94_h.a.i_">
                <OuterP>
                  <b>Exercise 3.</b> Guesstimate a function with this graph:
                </OuterP>
                <Pause />
            ...
            <Exercise number={4}>
              <ExerciseStatement id="_95_h.a.i_">
                <OuterP>
                  <b>Exercise 4.</b> Compute <Math>$A/B$</Math> assuming all
                  same-colored triangles are similar and with the help of a
                  calculator:
                </OuterP>
                <Pause />
                <Image
            ...
            <Exercise number={5}>
              <ExerciseStatement id="_96_h.a.i_">
                <OuterP>
                  <b>Exercise 5.</b> Which of these angles is <Math>$0.2$</Math>{" "}
                  radians?
                </OuterP>
                <Pause />
              ...
              <Solution>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> If you zoom in a little bit you can actually
                    see{" "}
                    <NoBreak>
                      “<Math>$100\%$</Math>
                      ”,
            ...
            <Exercise number={6}>
              <ExerciseStatement id="_97_h.a.i_">
                <OuterP>
                  <b>Exercise 6.</b> In the drawing below the oval is a circle
            ...
            <Exercise number={8}>
              ...
              <Solution>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> If we represent the vectors{" "}
                    <NoBreak>
                      <Math>$\vec&#123;u&#125;$</Math>,
                    </NoBreak>{" "}
            ...
            <Exercise number={9}>
              <ExerciseStatement id="_100_h.a.i_">
                <OuterP>
                  <b>Exercise 9.</b> If a particle in <Math>$\rr^2$</Math> (=
                  “in the plane”) has{" "}
                  <NoBreak>
                    <Math>$x$</Math>
                    -coordinate
              ...
              <Solution>
                ...
                <List style="padding-left:2em;">
                  <Item>
                    <p>
                      <Math>$B$</Math> is the <i>clockwise</i> angular
                      speed/angular frequency of the particle and{" "}
                      <Math>$C$</Math> is the <i>clockwise</i> starting angle of
                      the particle, as measured from a translate of the positive{" "}
                      <Math>$x$</Math> axis going through the center of the
                      circle
                    </p>
                  </Item>
                </List>
                ...
                <Pause />
                <OuterP>
                  is an amount of <i>clockwise</i> radians. This accounts for
                  the two solutions listed above. (But it can only be one of
                  those two solutions, having made the “Occam's razor”
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> The following diagram illustrates the two
                    possibilities:
                  </OuterP>
                  <Pause />
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> If you harbor any doubts about there being no
            ...
            <Exercise number={10}>
              <ExerciseStatement id="_101_h.a.i_">
                <OuterP>
                  <b>Exercise 10.</b> A point <Math>$P \in \rr^3$</Math> at
                  distance <Math>$R$</Math> from the origin forms an angle{" "}
                  <Math>$\phi$</Math> with the positive <Math>$z$</Math> axis,
                  while{" "}
                  <NoBreak>
                    <Math>$P$</Math>
                    's
                  ...
                  is at a counterclockwise angle <Math>$\theta$</Math> from the
                  positive <Math>$x$</Math> axis:
                </OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  <Math>$y$</Math> and <Math>$z$</Math> in terms of{" "}
                  <NoBreak>
                    <Math>$R$</Math>,
                  </NoBreak>{" "}
                  <Math>$\phi$</Math> and{" "}
              ...
              <Solution>
                <OuterP>
                  Since <Math>$\phi$</Math> is an ordinary geometric angle
                  between two lines, (as opposed to: an oriented angle, a.k.a.,
                  “signed angle”), we have
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ 0 \leq \phi \leq 2\eta $$
                ...
                <Pause />
                <MathBlock>$$ \sin(\phi) \geq 0 $$</MathBlock>
                <Pause />
                <OuterP>
                  and from which{" "}
                  <NoBreak>
                  ...
                  as it appears in the following diagram, is the actual{" "}
                  <i>length</i> of{" "}
                  <NoBreak>
                    <Math>$P$</Math>
                    's
                ...
                <Pause />
                <CentralDisplayItalic>signed length</CentralDisplayItalic>
                <Pause />
                <OuterP>as</OuterP>
                <Pause />
                <MathBlock>$$ \cos(\phi) $$</MathBlock>
                <Pause />
                <OuterP>
                  is negative for{" "}
                  <NoBreak>
                    <Math>$\eta &lt; \phi \leq 2\eta$</Math>,
                  </NoBreak>{" "}
                  positive for{" "}
                  <NoBreak>
                    <Math>$0 \leq \phi &lt; \eta$</Math>!
                  </NoBreak>{" "}
                  But in any case that is what we want, since <Math>$z$</Math>{" "}
                  switches from positive to negative at{" "}
                  <Math>$\phi = \eta$</Math> just like{" "}
                  <NoBreak>
                    <Math>$\cos(\phi)$</Math>,
                  </NoBreak>{" "}
                  giving us
                ...
                <Pause />
                <MathBlock>$$ z = R\cos(\phi) $$</MathBlock>
                <Pause />
                <OuterP>and “one coordinate down”.</OuterP>
                <OuterP class="indent-10">
                  For <Math>$x$</Math> and{" "}
                  <NoBreak>
                    <Math>$y$</Math>,
                  </NoBreak>{" "}
                  then, we are left in a “classical” situation of converting
                  polar coordinates to Cartesian coordinates in the{" "}
                  <NoBreak>
                    <Math>$xy$</Math>
                    -plane;
                  </NoBreak>{" "}
                  ...
                  of polar coordinates is now{" "}
                  <NoBreak>
                    “<Math>$R\sin(\phi)$</Math>”
                  </NoBreak>{" "}
                  (but which is nonnegative, happily, as noted):
                </OuterP>
                <Pause />
                ...
                <Boxed style="margin-bottom:-5px;">
                  <MathBlock>$$ x = R\sin(\phi)\cos(\theta) $$</MathBlock>
                  <Pause />
                  <MathBlock>$$ y = R\sin(\phi)\sin(\theta) $$</MathBlock>
                  <Pause />
                  <MathBlock>$$ z = R\cos(\phi) $$</MathBlock>
                </Boxed>
                <Pause />
            ...
            <Exercise number={11}>
              <ExerciseStatement id="_102_h.a.i_">
                <OuterP>
                  ...
                  <NoBreak>
                    <Math>$\phi \in [-\eta, \eta]$</Math>,
                  </NoBreak>{" "}
                  as illustrated below, how are the corresponding
                  change-of-coordinate formulas affected?
                </OuterP>
                <Pause />
              ...
              <Solution>
                <OuterP>Since</OuterP>
                <Pause />
                <MathBlock>$$ \phi \in [-\eta, \eta] $$</MathBlock>
                <Pause />
                <OuterP>one has</OuterP>
                <Pause />
                <MathBlock>$$ \cos(\phi) \geq 0 $$</MathBlock>
                <Pause />
                <OuterP>and</OuterP>
                <Pause />
                <MathBlock>$$ R\cos(\phi) \geq 0 $$</MathBlock>
                <Pause />
                <OuterP>
                  from which <Math>$R\cos(\phi)$</Math> becomes the length of{" "}
                  <NoBreak>
                    <Math>$P$</Math>
                    's
                  </NoBreak>{" "}
                ...
                <Pause />
                <OuterP>
                  The coordinate transformations are thus obtained by
                  interchanging{" "}
                  <NoBreak>
                    “<Math>$\sin(\phi)$</Math>”
                  </NoBreak>{" "}
                ...
                <Boxed style="margin-bottom:0em;">
                  <MathBlock>$$ x = R\cos(\phi)\cos(\theta) $$</MathBlock>
                  <Pause />
                  <MathBlock>$$ y = R\cos(\phi)\sin(\theta) $$</MathBlock>
                  <Pause />
                  <MathBlock>$$ z = R\sin(\phi) $$</MathBlock>
                </Boxed>
                <Pause />
                <StarDivider />
              </Solution>
            ...
            <Exercise number={12}>
              <ExerciseStatement id="_103_h.a.i_">
                <OuterP>
                  <b>Exercise 12.</b> Compute the vertical distance from{" "}
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>inches, which comes out to</OuterP>
                <Pause />
                <MathBlock>
                  $$ 212.65 $$
                  <ImageLeft
            ...
            <Exercise number={13}>
              <ExerciseStatement id="_104_h.a.i_">
                <OuterP>
                  <b>Exercise 13.</b> Given the following sketch, to what angle
                ...
                <List style="padding-left:2.2em;gap:0.2em;">
                  <Item>
                    <p>all distances are in inches</p>
                  </Item>
                  <Item>
                    <p>
                  ...
                  <Item>
                    <p>assume the door has negligible thicknesss</p>
                  </Item>
                </List>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                  The “key intermediate length” to compute is the distance from
                  the hinge-edge of the door to the ceiling near the top of the
                  door:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  For this we need the lengths marked ‘2’ and ‘4’ below, each of
                  which requires a separate mini-computation, including deducing
                  the width of the door (length ‘3’) in order to deduce the
                  length marked ‘4’ (we will also reuse length ‘3’ below|):
                </OuterP>
                <Pause />
            ...
            <Exercise number={14}>
              <ExerciseStatement id="_105_h.a.i_">
                <OuterP>
                  <b>Exercise 14.</b> If aliens descended on Earth, captured
              ...
              <Solution>
                ...
                <OuterP>
                  ...
                  where we start the sequence at{" "}
                  <NoBreak>
                    <Math>$\sec^0(\theta) = 1$</Math>.
                  </NoBreak>{" "}
                ...
                <OuterP>
                  ...
                  <Math>$\sec \theta$</Math> are performed by “dropping a height
                  up” onto the opposite side of the angle{" "}
                  <NoBreak>
                    <Math>$\theta$</Math>,
                  </NoBreak>{" "}
                ...
                <Pause />
                <OuterP>
                  Though in fact, this tower is already embedded as a subdiagram
                  of our first illustration (modulo scale and orientation) (!):
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/Xdq7.svg" />
                <Pause />
                <OuterP>
                  In each of these diagrams, in fact, successive “similar”
                  lengths are a factor <Math>$\sec(\theta)$</Math> from one
                  another—giving rise to many possibilities of labeling a single
                  diagram. For example, in the original diagram, the blue
                  lengths below also form a geometric sequence of ratio{" "}
                  <Math>$\sec(\theta)$</Math> [below left], leading to an
                  alternate labeling of the tower [below middle], or the snail
                  stack could be labeled from the outside [below right]:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/ICZK.svg" />
                <Pause />
                <OuterP>
                  Two slight variants on another diagram (for which more
                  labelings are also possible):
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/CvsG.svg" />
                <Pause />
                <OuterP>
                  ...and other more-or-less logical diagrams are possible, but
                  this seems to content the aliens!
                </OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> One way to formally verify that...
                  </OuterP>
                  <Pause />
                  <Image src="/build-img/svgo-svg/ci-a.svg" />
                  <Pause />
                  <OuterP>...in this diagram...</OuterP>
                  <Pause />
                  <Image src="/build-img/svgo-svg/UspN.svg" />
                  <Pause />
                  <OuterP>...is to note that...</OuterP>
                  <Pause />
            ...
            <Exercise number={15}>
              <ExerciseStatement id="_106_h.a.i_">
                <OuterP>
                  <b>Exercise 15.</b> What are the maximum and minimum values of
                </OuterP>
                <Pause />
                <MathBlock>$$ \theta \ra \cos\theta\sin\theta $$</MathBlock>
                <Pause />
                <OuterP>
                  and for which <Math>$\theta$</Math> are they attained? (Reason
                  geometrically or algebraically, not by calculus.)
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                  <i>Solution 1.</i> For a geometric solution we start by
                  reminding to ourselves that if we plot all the solutions of
                </OuterP>
                <Pause />
                <MathBlock>$$ xy = 1 $$</MathBlock>
                <Pause />
                <OuterP>we find the curve</OuterP>
                <Pause />
                <MathBlock>$$ y = &#123;1\over x&#125; $$</MathBlock>
                <Pause />
                <OuterP>(equivalent!) whose general aspect is...</OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/HPwG.svg" width="470px" />
                <Pause />
                <OuterP>
                  ...like so; a little more generally, “isosets” of the
                  two-variable function...
                </OuterP>
                <Pause />
                <MathBlock>$$ (x, y) \ra xy $$</MathBlock>
                <Pause />
                <OuterP>...have this general aspect...</OuterP>
                <Pause />
                <Image
                ...
                <OuterP>
                  ...
                  among a mix of other such curves, of the form{" "}
                  <NoBreak>
                    <Math>$xy = C$</Math>;
                  </NoBreak>{" "}
                  what will give us a maybe even better level of insight is the
                  following “heatmap” of{" "}
                  <NoBreak>
                    <Math>$(x, y) \ra xy$</Math>,
                  </NoBreak>{" "}
                  where the curves above show up as boundaries between the
                ...
                <Pause />
                <OuterP>
                  The geometric insight that is of interest to is that, at any
                  given distance from the origin, the lines
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  hold the largest and smallest values, respectively, of{" "}
                  <NoBreak>
                    <Math>$xy$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>In other words,</OuterP>
                <Pause />
                <MathBlock>$$ \cos(\theta)\cdot\sin(\theta), $$</MathBlock>
                <Pause />
                <OuterP>
                  ...
                  of a point confined to the unit circle, will reach its maximum
                  when
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ (\cos \theta, \sin \theta) = \pm(\sqrt&#123;0.5&#125;,
                  \sqrt&#123;0.5&#125;) $$
                </MathBlock>
                <Pause />
                <OuterP>where it attains value</OuterP>
                <Pause />
                <MathBlock>
                  $$ \sqrt&#123;0.5&#125; \cdot \sqrt&#123;0.5&#125; =
                  &#123;1\over 2&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>and will reach its minimum when</OuterP>
                <Pause />
                <MathBlock>
                  $$ (\cos \theta, \sin \theta) = \pm(-\sqrt&#123;0.5&#125;,
                  \sqrt&#123;0.5&#125;) $$
                ...
                <Pause />
                <OuterP>
                  while, to answer the last part of the question, the set of{" "}
                  <NoBreak>
                    <Math>$\theta$</Math>
                    's
                  </NoBreak>{" "}
                  for which the maximum and minimum are reached will be...
                </OuterP>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <OuterP>...respectively, as illustrated...</OuterP>
                <Pause />
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> Here are annotated graphs of{" "}
                    <NoBreak>
                      <Math>$x \ra \cos x\sin x$</Math>,
                    </NoBreak>{" "}
                    in radians and in degrees, proudly displaying the newly
                    discovered max &amp; min:
                  </OuterP>
                  <Pause />
                  <Image
            ...
            <Exercise number={17}>
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>
                  In each case, the digits of the quotient are about to restart
                  from the first digit after the decimal point; the answers are
                  therefore:
                </OuterP>
                <Boxed>
                  <MathBlock>
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <OuterP>
                    ...though each estimate is only accurate to two decimal
                    places, meaning that the last four digits of the period are
                    “wasted (in)accuracy”.
                  </OuterP>
                </SolutionNote>
              </Solution>
            ...
            <Exercise number={18}>
              <ExerciseStatement id="_109_h.a.i_">
                <OuterP>
                  <b>Exercise 18.</b> To close our division skills: use the
            ...
            <Exercise number={19}>
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>for ‘?’, giving us</OuterP>
                <Pause />
                <MathBlock>
                  $$ \te&#123;?&#125; = 2\eta - \eta - \theta $$
                </MathBlock>
                <Pause />
                <OuterP>or an answer of...</OuterP>
                <Boxed>
                  <MathBlock>$$ \eta - \theta $$</MathBlock>
                </Boxed>
                <OuterP>...!!</OuterP>
                <Pause />
                <SolutionNote>
            ...
            <Exercise number={20}>
              <ExerciseStatement id="_111_h.a.i_">
                <OuterP>
                  <b>Exercise 20.</b> What is the angle marked ‘?’, as a
                  function of{" "}
                  <NoBreak>
                    <Math>$\theta$</Math>?
                  </NoBreak>
            ...
            <Exercise number={21}>
              <ExerciseStatement id="_112_h.a.i_">
                <OuterP>
                  <b>Exercise 21.</b> Argue that, in the following figure, the
                  angle marked ‘?’ equals{" "}
                  <NoBreak>
                    <Math>$\theta$</Math>,
                  </NoBreak>{" "}
              ...
              <Solution>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> Here is an attempt at verbalization:
                  </OuterP>
                  <Pause />
                  <CentralDisplayItalic>
                    the counterclockwise angle from the positive{" "}
                    <Math>$x$</Math> axis to the radial vector [of angle{" "}
                    <NoBreak>
                      <Math>$\theta$</Math>]
                    </NoBreak>{" "}
                    equals the counterclockwise angle from the positive{" "}
                    <Math>$y$</Math> axis to the counterclockwise tangent [of
                    angle{" "}
                    <NoBreak>
                      <Math>$\theta$</Math>]
                    </NoBreak>
                  ...
                  <Pause />
                  <OuterP>With the various terms illustrated here:</OuterP>
                  <Pause />
                  <Image src="/build-img/svgo-svg/hFz7.svg" />
                  <Pause />
                  <OuterP>
                    ...but if it was such a great verbalization we wouldn't need
                    to illustrate it, ergo, we failed!
                  </OuterP>
                </SolutionNote>
              </Solution>
            </Exercise>
            ...
            <Exercise number={24}>
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>because latitudes are stretched by a factor of</OuterP>
                <Pause />
                <MathBlock>$$ \sec(\theta) $$</MathBlock>
                <Pause />
                <OuterP>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> As a consequence, the area of a shape on the
                    sphere is equal to the area of the projection of that shape
                    onto the cylinder, for any shape. We will refer to this
                    (strange?) fact as the
                  </OuterP>
                  <Pause />
                  <CentralDisplayItalic>
                  ...
                  <Pause />
                  <OuterP>of the sphere.</OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> For example, the following two orange areas,
                    one on the sphere and one on the cylinder, are equal, by the
                    Archimedean property (this is a Lambert projection):
                  </OuterP>
                  <Pause />
                  <Image src="/build-img/svgo-svg/pG5W.svg" />
                  <Pause />
                  <OuterP>
                    For a second, more exotic example, the 8 “tube sections” of
                    each circle in this diagram...
                  </OuterP>
                  <Pause />
                  <Image src="/build-img/svgo-svg/7Dao.svg" />
                  <Pause />
                  <OuterP>
                    ...have equal areas on the cylinder, even though dissimilar
                    in shape, since those sections have equal area to one
                    another on the sphere. (For each circle separately, we
                    mean.)
                  </OuterP>
                </SolutionNote>
              </Solution>
            ...
            <Exercise number={25}>
              <ExerciseStatement id="_116_h.a.i_">
                <OuterP>
                  <b>Exercise 25.</b> Rank the <Math>$7$</Math> slices of this
            ...
            <Exercise number={26}>
              <ExerciseStatement id="_117_h.a.i_">
                <OuterP>
                  <b>Exercise 26.</b> Give a formula for the area of a sphere of
                  radius{" "}
                  <NoBreak>
                    <Math>$r$</Math>.
                  </NoBreak>
            ...
            <Exercise number={27}>
              <ExerciseStatement id="_118_h.a.i_">
                <OuterP>
                  <b>Exercise 27.</b> Give a formula for the volume of a sphere
            ...
            <Exercise number={28}>
              <ExerciseStatement id="_119_h.a.i_">
                <OuterP>
                  <b>Exercise 28.</b> An access staircase goes up the side of a
                  hemispheric gas tank. It keeps a constant angle of{" "}
                  <Math>$45^\circ$</Math> to vertical at its inside edge until
                  it reaches <Math>$45^\circ$</Math> up the tank, at which point
                  it makes a beeline for the top:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/wF1d.svg" />
                <Pause />
                <OuterP>
                  How long, roughly, is the inside handrail of the staircase as
                  a function of the radius of the tank?
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                  Putting <Math>$r$</Math> for the radius, the answer is
                </OuterP>
                <Pause />
                <MathBlock>$$ \approx r(1 + \eta/2) $$</MathBlock>
                <Pause />
                <OuterP>where</OuterP>
                <Pause />
                <MathBlock>$$ r\cdot 1=r $$</MathBlock>
                <Pause />
                <OuterP>
                  accounts for the first (lower) portion of the handrail, and
                </OuterP>
                <Pause />
                <MathBlock>$$ r\cdot(\eta/2) $$</MathBlock>
                <Pause />
                <OuterP>
                  accounts for the upper portion of the handrail. (Ignoring that
                  the handrail doesn't quite follow through to the tippy-top of
                  the gas tank, per the picture.)
                </OuterP>
                <OuterP class="indent-10">
                  To reason about the lower portion of the handrail imagine a
                  butterly that follows up the handrail by flying straight up
                  and straight over, then straight up and straight over again,
                  etc, like so:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  The total length of the handrail is the sum of all the
                  diagonal segments (in dotted white) above. Because the
                  diagonal segment has length
                </OuterP>
                <Pause />
                <MathBlock>$$ \sqrt&#123;2&#125;h $$</MathBlock>
                <Pause />
                <OuterP>
                  ...
                  the total length of the diagonal segments is
                </OuterP>
                <Pause />
                <MathBlock>$$ \sqrt&#123;2&#125; $$</MathBlock>
                <Pause />
                <OuterP>
                  times the total amount that the butterfly goes up for the
                  first half of the handrail. But this amount—call it{" "}
                  <NoBreak>
                    <Math>$H$</Math>
                    —is
                  </NoBreak>
                ...
                <Pause />
                <MathBlock>
                  $$ r\cdot\sin(45^\circ) = r\cdot &#123;1\over
                  \sqrt&#123;2&#125;&#125; = &#123;r\over
                  \sqrt&#123;2&#125;&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>as illustrated here:</OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/VrOC.svg" />
                <Pause />
                <OuterP>
                  And therefore the sum of the white diagonal segments is
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \sqrt&#123;2&#125;\cdot H = \sqrt&#123;2&#125;\cdot
                  &#123;r\over \sqrt&#123;2&#125;&#125; = r $$
                </MathBlock>
                <Pause />
                <OuterP>
                ...
                <OuterP class="indent-10">
                  On the other hand, the upper portion of the handrail has
                  length
                </OuterP>
                <Pause />
                <MathBlock>$$ r\cdot(\eta/2) $$</MathBlock>
                <Pause />
                <OuterP>
                  (modulo the kerfuffle at the top) simply by the fact that, in
                  a circle of radius{" "}
                  <NoBreak>
                    <Math>$r$</Math>,
                  </NoBreak>{" "}
                  an angle of <Math>$\alpha$</Math> radians subtends an arc of
                  length{" "}
                  <NoBreak>
                    <Math>$r\alpha$</Math>:
                  </NoBreak>
                ...
                <Pause />
                <OuterP>
                  ...and hence the <i>total</i> length of the handrail is...
                </OuterP>
                <Pause />
                <MathBlock>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> Another way to think about the length of the
                    lower portion of the handrail is via the green triangle
                    depicted below, that drops down onto the handrail like a
                    curtain, starting at the top of the lower portion of the
                    handrail:
                  </OuterP>
                  <Pause />
                  ...
                  <Pause />
                  <OuterP>
                    If we “unroll” the triangle onto a vertical plane while
                    keeping its left edge vertical we find a triangle with a
                    straight lower edge at <Math>$45^\circ$</Math> to
                    horizontal, because that is the property of the handrail to
                    maintain this angle everywhere:
                  </OuterP>
                  <Pause />
                  <Image src="/build-img/svgo-svg/-SnV.svg" />
                  <Pause />
                  <OuterP>
                    Hence the length of the lower half of the handrail is
                  </OuterP>
                  <Pause />
                  <MathBlock>$$ \large \sqrt&#123;2&#125;H $$</MathBlock>
                  <Pause />
                  <OuterP>
                    with <Math>$H = r/\sqrt&#123;2&#125;$</Math> as previously
                    defined.
                  </OuterP>
                </SolutionNote>
              </Solution>
            ...
            <Exercise number={29}>
              <ExerciseStatement id="_120_h.a.i_">
                <OuterP>
                  <b>Exercise 29.</b> Give a decimal approximation to
                </OuterP>
                <Pause />
                <MathBlock>$$ r(1 + \eta/2) $$</MathBlock>
                <Pause />
                <OuterP>
                  for{" "}
                  <NoBreak>
              ...
              <Solution>
                <OuterP>Since</OuterP>
                <Pause />
                <MathBlock>$$ \eta \approx &#123;11\over 7&#125; $$</MathBlock>
                <Pause />
                <OuterP>within 1/1000th, we have</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align*&#125; r(1 + \eta/2)\,\,
                  \approx&amp;\,\,\,\dn&#123;1.3&#125;\up&#123;0.0&#125;
                  r\left(1 + &#123;11\over 14&#125;\right)\\
                  =&amp;\,\,\,\dn&#123;1.3&#125;\up&#123;1.3&#125;
                  r\left(&#123;14 + 11\over 14&#125;\right)\\
                  =&amp;\,\,\,\dn&#123;1.3&#125;\up&#123;1.3&#125; r\cdot
                  &#123;25\over 14&#125;\\
                  =&amp;\,\,\,\dn&#123;1.3&#125;\up&#123;1.3&#125; r\cdot
                  &#123;28 - 3\over 14&#125;\\
                  =&amp;\,\,\,\dn&#123;1.3&#125;\up&#123;1.3&#125; r\left(2 -
                  &#123;3\over 14&#125;\right)\\
                  \approx&amp;\,\,\,\dn&#123;1.3&#125;\up&#123;1.3&#125;
                  r\left(2 - &#123;3\over 15&#125;\right)\\
                  =&amp;\,\,\,\dn&#123;1.3&#125;\up&#123;1.3&#125; r\left(2 -
                  &#123;1\over 5&#125;\right)\\
                ...
                <Pause />
                <OuterP>leading to an approximation of</OuterP>
                <Pause />
                <MathBlock>$$ \approx 180\te&#123;m&#125; $$</MathBlock>
                <Pause />
                <OuterP>
                  for{" "}
                  <NoBreak>
                  ...
                  For a different, coarser approach, one can even use
                </OuterP>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <MathBlock>$$ 1 + \eta/2 \approx 1.75 $$</MathBlock>
                <Pause />
                <OuterP>and a final approximation of</OuterP>
                <Pause />
                <MathBlock>$$ \approx 175\te&#123;m&#125; $$</MathBlock>
                <Pause />
                <OuterP>
                  for{" "}
                  <NoBreak>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> The two approximations given produce{" "}
                    <NoBreak>
                      1<Math>$\%$</Math>
                    </NoBreak>{" "}
                    and{" "}
                    ...
                    of error, respectively, or <Math>$\approx 0.8\%$</Math> and{" "}
                    <NoBreak>
                      <Math>$\approx 1.9\%$</Math>,
                    </NoBreak>{" "}
                    more exactly, respectively. (For the second approximation,
                  </OuterP>
                  <Pause />
                  ...
                  <OuterP>
                    ...
                    less than <Math>$\eta/2$</Math> right off the bat, but the
                    fraction represented by this error is diluted by the fact
                    that we add 1.)
                  </OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  ...
                  <Pause />
                  <MathBlock>$$ \eta/2 = 0.785\dots $$</MathBlock>
                  <Pause />
                  <OuterP>and some, as</OuterP>
                  <Pause />
                  <MathBlock>$$ \eta = 1.570\dots $$</MathBlock>
                  <Pause />
                  <OuterP>
                    and some. (Note that half of <Math>$0.07$</Math> is{" "}
                    <NoBreak>
                      <Math>$0.035$</Math>,
                    </NoBreak>{" "}
                    and that{" "}
                    <NoBreak>
                      <Math>$0.75 + 0.035 = 0.785$</Math>
                      .)
                    </NoBreak>{" "}
                    (PS: In fact, doing the division
                  </OuterP>
                  <Pause />
                  <MathBlock>$$ 1.57/2 $$</MathBlock>
                  <Pause />
                  <OuterP>
                    “by head” constitutes another perfectly valid method of
                    approximation, if you can remember that{" "}
                    <NoBreak>
                      <Math>$\eta = 1.570\dots$</Math>
                      .)
                    </NoBreak>
                  </OuterP>
                </SolutionNote>
            ...
            <Exercise number={30}>
              <ExerciseStatement id="_121_h.a.i_">
                <OuterP>
                  <b>Exercise 30.</b> From the first three steps of the division
                  of <Math>$11$</Math> by <Math>$7$</Math> we find{" "}
                  <NoBreak>
                    <Math>$\eta \approx 1.57$</Math>:
                  </NoBreak>
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  Use this approximation of <Math>$\eta$</Math> to approximate
                </OuterP>
                <Pause />
                <CentralDisplayItalic>
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>
                  is one-quarter the circumference of a circle divided by its
                  radius,
                </OuterP>
                <Pause />
                <MathBlock>$$ 3\eta $$</MathBlock>
                <Pause />
                <OuterP>
                  is three-quarters the circumference of a circle divided by its
                  radius; using{" "}
                  <NoBreak>
                    <Math>$\eta \approx 1.57$</Math>,
                  </NoBreak>{" "}
                  <Math>$3\eta$</Math> is approximately
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ 3 \times 1.57 = 3\times (1.5 + 0.07) = 3 \times 1.5 +
                  3\times 0.07 $$
                </MathBlock>
                <Pause />
                <MathBlock>$$ =\,\,4.5 + 0.21 $$</MathBlock>
                <Pause />
                <MathBlock>$$ =\,\,4.71 $$</MathBlock>
                <Pause />
                <OuterP>
                ...
                <Pause />
                <MathBlock>
                  $$ \approx 4.71 \times 100\te&#123;m&#125; =
                  471\te&#123;m&#125;. $$
                </MathBlock>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> The following table gives approximation
                    ratios going from <Math>$n = 1$</Math> to{" "}
                    <Math>$n = 4$</Math> quarters, similarly computed, that one
                    might as well remember:
                  </OuterP>
                  <Pause />
                  <MathBlock>
                    $$ \begin&#123;array&#125;&#123;c|c|c&#125;
                    \,\,\,\,n\,\,\,\, &amp; n(1.5 + 0.07) &amp; \,\,\,\,\approx
                    n\eta\,\,\,\,\Rule&#123;0pt&#125;&#123;0.8em&#125;&#123;0.5em&#125;
                    \\ \hline 1 &amp; \up&#123;1.2&#125; 1.5 + 0.07 &amp; 1.57\\
                    2 &amp; \up&#123;1.2&#125; 3.0 + 0.14 &amp; 3.14\\ 3 &amp;
                    \up&#123;1.2&#125; 4.5 + 0.21 &amp; 4.71\\ 4 &amp;
                    \up&#123;1.2&#125; 6.0 + 0.28 &amp; 6.28
                    \end&#123;array&#125; $$
                  </MathBlock>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  ...
                  <Pause />
                  <OuterP>is about half-a-part-in-a-thousand</OuterP>
                  <Pause />
                  <CentralDisplayItalic>too large</CentralDisplayItalic>
                  <Pause />
                  <OuterP>
                    ...
                    the approximations above just so turn out to be (really
                    nearly quite exactly) half-a-part-in-a-thousand
                  </OuterP>
                  <Pause />
                  <CentralDisplayItalic>too small</CentralDisplayItalic>
                  <Pause />
                  <OuterP>
                    due to the fact that the the long division of{" "}
                    <Math>$11$</Math> by <Math>$7$</Math> is terminated early.
                    But if we pursue the division for just one more step, which
                    adds a{" "}
                    <NoBreak>
                      ‘<Math>$1$</Math>’
                    </NoBreak>{" "}
                  ...
                  <Pause />
                  <OuterP>...we obtain the modified approximation...</OuterP>
                  <Pause />
                  <MathBlock>$$ \eta \approx 1.571 $$</MathBlock>
                  <Pause />
                  <OuterP>
                    ...that is, for its part, an <i>overestimate</i> of{" "}
                    <NoBreak>
                      <Math>$\eta$</Math>.
                    </NoBreak>{" "}
                    (Whereas
                  ...
                  <Pause />
                  <MathBlock>$$ 1.57 $$</MathBlock>
                  <Pause />
                  <OuterP>
                    is still an <i>underestimate</i>
                    .) From there, any further digits that are added to the
                    quotient only worsen the approximation, since we are already
                    overshooting!
                  </OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 3.</i> In fact, the true value of{" "}
                    <Math>$\eta$</Math> is roughly half-way between
                  </OuterP>
                  <Pause />
                  <MathBlock>$$ 1.57 $$</MathBlock>
                  <Pause />
                  ...
                  <OuterP>being</OuterP>
                  <Pause />
                  <MathBlock>$$ \,\eta = 1.570796\dots $$</MathBlock>
                  <Pause />
                  <OuterP>
                    per the calculator. (That knows this value by heart.) Taking
                    into account that
                  </OuterP>
                  <Pause />
                  <MathBlock>$$ 1.570796 $$</MathBlock>
                  <Pause />
                  <OuterP>
                    is <i>basically</i>
                  </OuterP>
                  <Pause />
                  <MathBlock>$$ 1.5708 $$</MathBlock>
                  <Pause />
                  <OuterP>
                    ...
                    based on adding multiples of{" "}
                    <NoBreak>
                      ‘<Math>$08$</Math>’
                    </NoBreak>{" "}
                    to the tail end of our previous approximations:
                  </OuterP>
                  <Pause />
                  <MathBlock>
                    $$ \begin&#123;array&#125;&#123;c|c|c&#125;
                    ...
                    \,\,\,\,\approx
                    n\eta\,\,\,\,\Rule&#123;0pt&#125;&#123;0.8em&#125;&#123;0.5em&#125;
                    \\ \hline 1 &amp; \up&#123;1.2&#125; 1.5 + 0.07 + 0.0008
                    &amp; 1.5708\\ 2 &amp; \up&#123;1.2&#125; 3.0 + 0.14 +
                    0.0016 &amp; 3.1416\\ 3 &amp; \up&#123;1.2&#125; 4.5 + 0.21
                    + 0.0024 &amp; 4.7124\\ 4 &amp; \up&#123;1.2&#125; 6.0 +
                    0.28 + 0.0032 &amp; 6.2832 \end&#123;array&#125; $$
                  </MathBlock>
                  <Pause />
                  <OuterP>
                    ...with these approximations being good to{" "}
                    <i>three parts in a million</i>. (Improved, namely, from{" "}
                    <i>half a part in a thousand</i>
                    .)
                  </OuterP>
                </SolutionNote>
              </Solution>
            ...
            <Exercise number={31}>
              <ExerciseStatement id="_122_h.a.i_">
                <OuterP>
                  <b>Exercise 31.</b> A ship travels from the South pole of a
                  watery copy of the Earth to the North pole while maintaining a
                  constant compass bearing of <Math>$5^\circ$</Math> North of
                  East. (See Fig.) What is the length of the curve traced by the
                  ship?
                </OuterP>
                <Pause />
              ...
              <Solution>
                <OuterP>
                  Imagine that a butterfly that only flies by small steps East
                  and North, alternately, follows with the boat:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/tjm5.svg" />
                <Pause />
                <OuterP>(We replace</OuterP>
                <Pause />
                <MathBlock>$$ \Huge 5^\circ $$</MathBlock>
                <Pause />
                <OuterP>by</OuterP>
                <Pause />
                <MathBlock>$$ \Huge \alpha $$</MathBlock>
                <Pause />
                <OuterP>
                  radians for more generality, that will make the problem no
                  more nor less easy.) The total of all the small northward legs
                  that the butterfly travels is
                </OuterP>
                <Pause />
                <MathBlock>$$ 20004\,\te&#123;km&#125; $$</MathBlock>
                <Pause />
                <OuterP>
                  or one-half the so-called <i>meridional circumference</i> of
                  the Earth. But the total distance traveled by the ship is
                </OuterP>
                <Pause />
                <MathBlock>$$ \Huge \csc(\alpha) $$</MathBlock>
                <Pause />
                <OuterP>
                ...
                <Pause />
                <OuterP>
                  The total distance traveled by the ship is therefore
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \Large 20004\,\te&#123;km&#125;\cdot \csc \alpha =
                  &#123;20004\,\te&#123;km&#125; \over \sin \alpha&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>that comes out to</OuterP>
                <Pause />
                <MathBlock>
                ...
                <OuterP>
                  with{" "}
                  <NoBreak>
                    <Math>$\alpha = 5^\circ$</Math>.
                  </NoBreak>
                </OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> In reality the butterly's triangle is drawn
                    on a spherical shell and it is only because the triangle is
                    very small compared to the radius of the shell that it
                    resembles an ordinary triangle, without quite being an
                    ordinary triangle. But what is important is that the{" "}
                    <i>ratios</i> of the lengths of the butterly triangle
                    approach those of an ordinary right triangle of angle{" "}
                    <Math>$\alpha$</Math> as we make the butterfly's triangle
                    sufficiently small. (Which is believable.)
                  </OuterP>
                </SolutionNote>
              </Solution>
            </Exercise>
            <Exercise number={32}>
              <ExerciseStatement id="_123_h.a.i_">
                <OuterP>
                  <b>Exercise 32.</b> Below are four function compositions
                ...
                <List
                  ...
                  <Item>
                    <p>as an expression of the form</p>
                    <Pause />
            ...
            <Exercise number={33}>
              ...
              <Solution>
                <OuterP>For reference again, the four functions are:</OuterP>
                <Pause />
                <MathBlock>
                  $$ \te&#123;1.&#125;\,\, x \ra f(x + A) $$
                </MathBlock>
                ...
                <Pause />
                <List marker="decimal" style="padding-left:2em;">
                  <Item>
                    <p>
            ...
            <Exercise number={34}>
              <ExerciseStatement id="_125_h.a.i_">
                ...
                <Pause />
                <MathBlock>$$ f(x) = A\cos(Bx + C) + D $$</MathBlock>
                <Pause />
                <OuterP>
                  ...
                  <Math>$C$</Math> and <Math>$D$</Math> is connected to a dial,
                  ...
                  <Math>$C$</Math> and <Math>$D$</Math> to{" "}
                  <NoBreak>
                    <Math>$1$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                  ...
                  respectively. Then, in the following order, we...
                </OuterP>
                <Pause />
                <List marker="decimal" style="padding-left:20%;">
                  <Item>
                    <p>
                      ...increase <Math>$C$</Math> from <Math>$0$</Math> to{" "}
                      <NoBreak>
                        <Math>$1&#123;&#125;.33$</Math>;
                      </NoBreak>{" "}
                      and
                  ...
                  <Item>
                    <p>
                      ...increase <Math>$B$</Math> from <Math>$1$</Math> to{" "}
                      <NoBreak>
                        <Math>$2.33$</Math>;
                      </NoBreak>{" "}
                      and
                  ...
                  <Item>
                    <p>
                      ...increase <Math>$A$</Math> from <Math>$1$</Math> to{" "}
                      <NoBreak>
                        <Math>$3.33$</Math>;
                      </NoBreak>{" "}
                      and
                  ...
                  <Item>
                    <p>
                      ...increase <Math>$D$</Math> from <Math>$0$</Math> to{" "}
                      <NoBreak>
                        <Math>$4.33$</Math>.
                      </NoBreak>
                    </p>
                ...
                <Pause />
                <OuterP>
                  How does the graph of <Math>$f$</Math> react to each of these
                  changes, as they occur in sequence?
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                ...
                <List style="padding-left:33px;padding-right:2em;">
                  <Item>
                    <p>
                      step 1: advances the initial position of particle{" "}
                      <Math>$C$</Math> radians forward, so the graph shifts{" "}
                      <i>left</i> by <Math>$C = 1.33$</Math> units (so that the
                      value <Math>$y = \sin(C)$</Math> finds itself at{" "}
                      <NoBreak>
                        <Math>$x = 0$</Math>)
                      </NoBreak>
                    </p>
                  ...
                  <Item>
                    <p>
                      step 2: speeds up the angular velocity of the particle
                      from <Math>$1$</Math> radian per unit time to{" "}
                      <Math>$B = 2.33$</Math> radians per unit time; this can
                      simply be thought of as a “speeding up of time”, and
                      compresses the graph horizontally about the{" "}
                      <Math>$y$</Math> axis by a factor <Math>$2.33$</Math>{" "}
                      (while keeping <Math>$y = \sin(C)$</Math> at{" "}
                      <NoBreak>
                        <Math>$x = 0$</Math>,
                      </NoBreak>{" "}
                      as should be);
                  ...
                  <Item>
                    <p>
                      step 3: increases the radius of the circle from{" "}
                      <Math>$1$</Math> to{" "}
                      <NoBreak>
                        <Math>$A = 3.33$</Math>,
                      </NoBreak>{" "}
                      which results in a vertical dilation of the graph by a
                      factor{" "}
                      <NoBreak>
                        <Math>$3.33$</Math>;
                      </NoBreak>
                  ...
                  <Item>
                    <p>
                      ...
                      if we are thinking of <Math>$f$</Math> as reading off the{" "}
                      <NoBreak>
                        <Math>$y$</Math>
                        -coordinate
                      </NoBreak>{" "}
                      of the particle) from <Math>$y = 0$</Math> to{" "}
                      <NoBreak>
                        <Math>$y = D = 4.33$</Math>,
                      </NoBreak>{" "}
                      resulting in a vertical translation upwards of the graph
                      by <Math>$4.33$</Math> units!
                    </p>
                  </Item>
                </List>
                <Pause />
                <OuterP>
                  <i>Solution 2.</i> One can understand
                </OuterP>
                <Pause />
                <MathBlock>$$ f = x \ra A\sin(Bx + C) + D $$</MathBlock>
                <Pause />
                <OuterP>
                  as a 5-fold composition (with functions boxes going right to
                  left):
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  In the initial setting of the variables with{" "}
                  <Math>$A = B = 1$</Math> and <Math>$C = D = 0$</Math> the four
                  boxes on the periphery are the identity*:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/sweo.svg" />
                <Pause />
                <OuterP>(*When we say “the identity” we mean</OuterP>
                <Pause />
                <CentralDisplayItalic>
                ...
                <OuterP class="indent-10">
                  As we dial <Math>$C$</Math> up from <Math>$0$</Math> to{" "}
                  <NoBreak>
                    <Math>$1.33$</Math>,
                  </NoBreak>{" "}
                  the box to the right of sin is “brought online”:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/2ziI.svg" />
                <Pause />
                <OuterP>
                  The effect of adding such a box to the right of sin is to
                  translate the graph of sin to the left by{" "}
                  <NoBreak>
                    <Math>$C$</Math>,
                  </NoBreak>{" "}
                  as discussed in{" "}
                ...
                <Pause />
                <OuterP>
                  Because this box is to the right of all we have so far (which
                  is{" "}
                  <NoBreak>
                    <Math>$x \ra \sin(x + C)$</Math>
                    ),
                  </NoBreak>{" "}
                  it compresses the [current] graph horizontally by a factor{" "}
                  <NoBreak>
                    <Math>$B$</Math>,
                  </NoBreak>{" "}
                ...
                <Pause />
                <OuterP>
                  ...which scales the graph-so-far vertically by a factor{" "}
                  <NoBreak>
                    <Math>$A$</Math>,
                  </NoBreak>{" "}
                  as discussed in{" "}
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> Concerning the second solution, for
                    simplicity of analysis it's important to bring the pre- and
                    post-processing functions online “from the inside out”,
                    gluing new boxes on to what's already there:
                  </OuterP>
                  <Pause />
                  <Image src="/build-img/svgo-svg/EsiI.svg" />
                  <Pause />
                  <OuterP>(Otherwise, things get more complicated.)</OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> The problem uses ‘sin’ as an example but the
                    same reasoning (with boxes) applies to any function. Namely,
                    the graph
                  </OuterP>
                  <Pause />
                  <MathBlock>$$ y = A\cdot f(Bx + C) + D $$</MathBlock>
                  <Pause />
                  <OuterP>
                    is the graph <Math>$y = f(x)$</Math> translated left by{" "}
                    <NoBreak>
                      <Math>$C$</Math>,
                    </NoBreak>{" "}
                    ...
                    etc. (Well, “etc.”: translated vertically by{" "}
                    <NoBreak>
                      <Math>$D$</Math>
                      .)
                    </NoBreak>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 3.</i> A function that can be written as
                  </OuterP>
                  <Pause />
                  <MathBlock>$$ x \ra A\sin(Bx + C) + D $$</MathBlock>
                  <Pause />
                  <OuterP>
                    for some values of{" "}
                    <NoBreak>
                    ...
                    <Math>$D \in \rr$</Math> is called a
                  </OuterP>
                  <Pause />
                  <CentralDisplayItalic>sinusoid</CentralDisplayItalic>
                  <Pause />
                  <OuterP>
                    (if we switch ‘sin’ to ‘cos’ it gives the same class of
                    functions:{" "}
                    <NoBreak>
                      <Math>$\sin(Bx + C) = \cos(Bx + C - \eta)$</Math>
                      ).
                    </NoBreak>
                  </OuterP>
                  <OuterP class="indent-10">Moreover:</OuterP>
                  <Pause />
                  <List style="padding-left:33px;padding-right:2em;">
                    <Item>
                      <p>
                        ...
                        may be referred to as the <i>phase</i> of the sinuoid
                        (but which is only uniquely determined if you have
                        decided whether your sinusoid is written in terms of
                        ‘cos’ or ‘sin’, and even then only determined up to{" "}
                        <NoBreak>
                          <Math>$360^\circ = 4\eta$</Math>,
                        </NoBreak>{" "}
                        or, even worse, up to <Math>$180^\circ = 2\eta$</Math>{" "}
                        if negative values of <Math>$A$</Math> are allowed)
                      </p>
                    </Item>
                    <Item>
                      <p>
                        ...
                        may be referred to as the <i>amplitude</i> of the
                        sinusoid
                      </p>
                    </Item>
                    <Item>
                      <p>
                        ...
                        may be referred to as the <i>angular speed</i> or{" "}
                        <i>angular frequency</i> of the sinusoid
                      </p>
                    </Item>
                    <Item>
                      <p>
                        ...
                        may be referred to as the <i>vertical shift</i> or{" "}
                        <i>mean</i> (mathematics) or as the <i>DC bias</i> or{" "}
                        <i>DC offset</i> (engineering) or as the{" "}
                        <i>equilibrium position</i> (physics) of the sinusoid
                      </p>
                    </Item>
                  </List>
                </SolutionNote>
            ...
            <Exercise number={35}>
              <ExerciseStatement id="_126_h.a.i_">
                <OuterP>
                  <b>Exercise 35.</b> Illustrate the “Gregorinovich sandwich”
                  with a picture that actually looks like a sandwich.
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>The sandwich, which states that</OuterP>
                <Pause />
                <MathBlock>
                ...
                <OuterP>
                  ...
                  is hereby illustrated, using the fact that{" "}
                  <Math>$\theta$</Math> equals subtended arc length on the unit
                  circle:
                </OuterP>
                <Pause />
            ...
            <Exercise number={36}>
              <ExerciseStatement id="_127_h.a.i_">
                <OuterP>
                  <b>Exercise 36.</b> In the figure below, where can
                </OuterP>
                <Pause />
                <MathBlock>$$ \Large ab\cos\theta_&#123;ab&#125; $$</MathBlock>
                <Pause />
                <OuterP>
              ...
              <Solution>
                <OuterP>
                  It appears two places; it is the area of both of these
                  rectangles:
                </OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  <NoBreak>
                    “<Math>$b\cdot\cos\theta_&#123;ab&#125;$</Math>”
                  </NoBreak>{" "}
                  and{" "}
                  <NoBreak>
                    “<Math>$a\cdot\cos\theta_&#123;ab&#125;$</Math>”
                  </NoBreak>{" "}
                ...
                <Pause />
                <OuterP>Thus the rectangles respectively have areas...</OuterP>
                <Pause />
                <MathBlock>
                  $$ \Large a(b\cdot \cos\theta_&#123;ab&#125;) =
                  ab\cos\theta_&#123;ab&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>...and...</OuterP>
            ...
            <Exercise number={37}>
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>
                  But by a similar argument, these rectangles can also be shown
                  to have have the same area:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/Sie8.svg" />
                <Pause />
                <OuterP>This gives...</OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/Prt-.svg" />
                <Pause />
                <OuterP>...thiiiis...</OuterP>
                <Boxed>
                  <MathBlock>
                    $$ c = \sqrt&#123;a^2 + b^2 -
                    2ab\cos\theta_&#123;ab&#125;&#125; $$
                ...
                <OuterP>...formula!</OuterP>
              </Solution>
            </Exercise>
            <Exercise number={38}>
              <ExerciseStatement id="_129_h.a.i_">
                <OuterP>
                  <b>Exercise 38.</b> Find expressions for areas A—F and use
                  these to give a formula for <Math>$c$</Math> in terms of{" "}
                  <NoBreak>
                    <Math>$a$</Math>,
                  </NoBreak>{" "}
                  <Math>$b$</Math> and{" "}
              ...
              <Solution>
                <OuterP>Keeping in mind that</OuterP>
                <Pause />
                <MathBlock>$$ \cos(2\eta - x) = -\cos x $$</MathBlock>
                <Pause />
                <OuterP>
                  for all{" "}
                  <NoBreak>
                ...
                <OuterP>
                  ...
                  <Math>$0 &lt; 2\eta - \theta_&#123;ab&#125; &lt; \eta$</Math>{" "}
                  is an acute angle, the areas are:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>where we use the fact that</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; \te&#123;D&#125; =
                  \te&#123;E&#125;\, \\ \up&#123;1.4&#125;\te&#123;C&#125; =
                ...
                <Pause />
                <OuterP>in the third equality, and the fact that</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; \te&#123;E&#125; = a^2 +
                  \te&#123;B&#125;\, \\ \up&#123;1.4&#125;\te&#123;F&#125; = b^2
                  + \te&#123;A&#125;\, \end&#123;gathered&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>in the fourth equality, and the fact that</OuterP>
                <Pause />
                <MathBlock>
                  $$ \te&#123;A&#125; = \te&#123;B&#125; =
                  -ab\cos\theta_&#123;ab&#125; $$
            ...
            <Exercise number={39}>
              <ExerciseStatement id="_130_h.a.i_">
                <OuterP>
                  <b>Exercise 39.</b> Find expressions for areas A—F and use
                  these to give a formula for <Math>$c$</Math> in terms of{" "}
                  <NoBreak>
                    <Math>$a$</Math>,
                  </NoBreak>{" "}
              ...
              <Solution>
                <OuterP>
                  ...
                  <Math>$\times$</Math> height” while keeping in mind that{" "}
                  <Math>$\cos\theta_&#123;ac&#125; &lt; 0$</Math> (or more
                  exactly that{" "}
                  <NoBreak>
                    <Math>
                      $\cos(2\eta - \theta_&#123;ac&#125;) =
                ...
                <Pause />
                <MathBlock>
                  $$ \Large c = \sqrt&#123;c^2&#125; = \sqrt&#123;B - D&#125; =
                  \sqrt&#123;E - C&#125; = \sqrt&#123;(b^2 - A) - (F -
                  a^2)&#125; = \sqrt&#123;(b^2 - ab\cos\theta_&#123;ab&#125;) -
                  (ab\cos\theta_&#123;ab&#125; - a^2)&#125; = \sqrt&#123;a^2 +
                  b^2 - 2ab\cos\theta_&#123;ab&#125;&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>...where we use the fact that</OuterP>
                <Pause />
            ...
            <Exercise number={40}>
              <ExerciseStatement id="_131_h.a.i_">
                <OuterP>
                  <b>Exercise 40.</b> Keeping a triangle with sides{" "}
                  <NoBreak>
                    <Math>$a$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                  ...
                  <Math>$c$</Math> with opposing angles{" "}
                  <NoBreak>
                    <Math>$\theta_&#123;bc&#125;$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                  ...
                  <Math>$\theta_&#123;ab&#125;$</Math> respectively, prove{" "}
                  <i>Jack's rule</i>, which is the triplet of equations...
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; a\cos\theta_&#123;ac&#125; +
                  b\cos\theta_&#123;bc&#125; = c \\ b\cos\theta_&#123;ab&#125; +
                  c\cos\theta_&#123;ac&#125; = a \up&#123;1.4&#125;\\
                  a\cos\theta_&#123;ab&#125; + c\cos\theta_&#123;bc&#125; = b
                  \up&#123;1.4&#125; \end&#123;gathered&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                  ...and then prove the <i>cosine rule</i>, which is the
                  equation...
                </OuterP>
                <Pause />
                <MathBlock>
              ...
              <Solution>
                <OuterP>
                  ...
                  Jack's rule are symmetric it suffices to prove the first
                  equation. We need to consider two cases according to whether
                  side <Math>$c$</Math> is adjacent to <Math>$0$</Math> or{" "}
                  <Math>$1$</Math> obtuse angles (the two sub-cases in which
                  there is <Math>$1$</Math> obtuse angle are symmetric to one
                  another, we consider only one):
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/YaSq.svg" />
                <Pause />
                <OuterP>In Case 1 we obviously have</OuterP>
                <Pause />
                <MathBlock>
                ...
                <OuterP>
                  ...
                  Jack's rule, whereas, in Case 2, note that
                </OuterP>
                <Pause />
                <MathBlock>$$ -a\cos\theta_&#123;ab&#125; $$</MathBlock>
                <Pause />
                <OuterP>
                  is positive—it's a <i>length</i> as the diagram indicates—so
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ c = b\cos\theta_&#123;bc&#125; -
                  (-a\cos\theta_&#123;ac&#125;) = b\cos\theta_&#123;bc&#125; +
                  a\cos\theta_&#123;ac&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                  ...
                  Jack's rule, and which completes the proof thereof.{" "}
                  <InlineImage
                ...
                <OuterP class="indent-10">
                  Next, for the algebraic manipulation of the equations, start
                  by multiplying each equation{" "}
                  <NoBreak>
                    in
                    <Math>$\rt&#123;0.1&#125;$</Math>
                  </NoBreak>{" "}
                  Jack's rule by its own right-hand side, obtaining...
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; ac\cos\theta_&#123;ac&#125; +
                  bc\cos\theta_&#123;bc&#125; = c^2 \\
                  ab\cos\theta_&#123;ab&#125; + ac\cos\theta_&#123;ac&#125; =
                  a^2 \up&#123;1.4&#125;\\ ab\cos\theta_&#123;ab&#125; +
                  bc\cos\theta_&#123;bc&#125; = b^2 \up&#123;1.4&#125;
                  \end&#123;gathered&#125; $$
                  <ImageRight
                ...
                <Pause />
                <OuterP>
                  ...but then if we subtract the last two equations from the
                  first we obtain...
                  <ImageLeft
                ...
                <Pause />
                <OuterP>...which is the cosine rule, rearranged!</OuterP>
              </Solution>
            </Exercise>
            <Exercise number={41}>
              <ExerciseStatement id="_132_h.a.i_">
                <OuterP>
                  <b>Exercise 41.</b> Let points <Math>$P_1$</Math> and{" "}
                  <Math>$P_2$</Math> have polar coordinates{" "}
                  <Math>$(r_1, \theta_1)$</Math> and{" "}
                  <NoBreak>
                    <Math>$(r_2, \theta_2)$</Math>,
                  </NoBreak>{" "}
                  respectively:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  What is the distance from <Math>$P_1$</Math> to{" "}
                  <Math>$P_2$</Math> as a function of{" "}
                  <NoBreak>
                    <Math>$r_1$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                  ...
                  <Math>$\theta_1$</Math> and{" "}
                  <NoBreak>
                    <Math>$\theta_2$</Math>?
                  </NoBreak>{" "}
                  (Keep an eye out for algebraic simplifications and, in
                  particular, for the fact that the distance should depend only
                  on
                </OuterP>
                <Pause />
                <MathBlock>$$ \theta_1 - \theta_2 $$</MathBlock>
                <Pause />
                <OuterP>or, even, only on</OuterP>
                <Pause />
                <MathBlock>$$ |\theta_1 - \theta_2| $$</MathBlock>
                <Pause />
                <OuterP>
                  as opposed to depending on the individual values of{" "}
                  <Math>$\theta_1$</Math> and <Math>$\theta_2$</Math>{" "}
                  separately, since we can rotate the entire diagram while
                  keeping the distance from <Math>$P_1$</Math> to{" "}
                  <Math>$P_2$</Math> constant.)
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>As a preliminary, we first note that</OuterP>
                <Boxed>
                  <MathBlock>
                ...
                <Pause />
                <OuterP>
                  for all <Math>$A, B \in \rr$</Math> implies
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;aligned&#125; \cos(A -
                ...
                <OuterP class="indent-10">(There is a similar formula</OuterP>
                <Boxed>
                  <MathBlock>
                ...
                <OuterP>
                  for the sine of a difference, but that one is hardly as
                  important or useful, you should forget it even though we just
                  boxed it.)
                </OuterP>
                <OuterP class="indent-10">
                  We now apply the Cartesian formula for distance
                </OuterP>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <MathBlock>
                  $$ \sqrt&#123;x_1^2 + x_2^2 + y_1^2 + y_2^2 - 2(x_1x_2 +
                  y_1y_2)&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                  to be applied with{" "}
                  <NoBreak>
                    <Math>$(x_1, y_1) = P_1$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                    <Math>$(x_2, y_2) = P_2$</Math>,
                  </NoBreak>{" "}
                  i.e., with
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;aligned&#125; (x_1, y_1) = (r_1\cos\theta_1,
                  r_1\sin\theta_1) \\ (x_2, y_2) = (r_2\cos\theta_2,
                  r_2\sin\theta_2)\up&#123;1.4&#125; \end&#123;aligned&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>by definition of polar coordinates, from which</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;aligned&#125; \,&amp;x_1^2 + y_1^2 =
                  r_1^2\cos^2\theta_1 + r_1^2\sin^2\theta_1 =
                  r_1^2(\cos^2\theta_1 + \sin^2\theta_1) =
                  r_1^2,\up&#123;1.3&#125; \\ &amp;x_2^2 + y_2^2 =
                  r_2^2\cos^2\theta_2 + r_2^2\sin^2\theta_2 =
                  r_2^2(\cos^2\theta_2 + \sin^2\theta_2) =
                  r_2^2\up&#123;1.4&#125; \end&#123;aligned&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>and</OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>(in fact, we know that</OuterP>
                <Pause />
                <MathBlock>$$ x_1^2 + y_1^2 = r_1^2 $$</MathBlock>
                <Pause />
                <OuterP>and</OuterP>
                <Pause />
                <MathBlock>$$ x_2^2 + y_2^2 = r_2^2 $$</MathBlock>
                <Pause />
                <OuterP>
                  just by common lore of polar coordinates, but anyway), while
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;aligned&#125; \,x_1x_2 =\, r_1\cos\theta_1\cdot
                  r_2\cos\theta_2 =
                  r_1r_2\cos\theta_1\cos\theta_2,\up&#123;0.9&#125; \\ y_1y_2
                  =\, r_1\sin\theta_1\cdot r_2\sin\theta_2 =
                  r_1r_2\sin\theta_1\sin\theta_2\up&#123;1.5&#125;\,\,
                  \end&#123;aligned&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>from which</OuterP>
                <Pause />
                <MathBlock>
                  $$ x_1x_2 + y_1y_2 = r_1r_2(\cos\theta_1\cos\theta_2 +
                ...
                <Pause />
                <OuterP>by the first remark, so</OuterP>
                <Pause />
                <MathBlock>
                  $$ x_1y_1 + x_2y_2 = r_1r_2\cos(\theta_1 - \theta_2) $$
                </MathBlock>
                <Pause />
                <OuterP>and, altogether, the distance...</OuterP>
                <Pause />
                <MathBlock>
                  $$ \sqrt&#123;x_1^2 + x_2^2 + y_1^2 + y_2^2 - 2(x_1x_2 +
                  y_1y_2)&#125; $$
                ...
                <Boxed>
                  <MathBlock>
                    $$ \sqrt&#123;r_1^2 + r_2^2 - 2r_2r_2\cos(\theta_1 -
                    \theta_2)&#125; $$
                  </MathBlock>
                </Boxed>
                <OuterP>...that, as can be seen, depends only on</OuterP>
                <Pause />
                <MathBlock>$$ \theta_1 - \theta_2 $$</MathBlock>
                <Pause />
                <OuterP>or, even, only on</OuterP>
                ...
                <Pause />
                <OuterP>
                  since <Math>$\cos(x) = \cos(-x) = \cos(|x|)$</Math> for all{" "}
                  <NoBreak>
                    <Math>$x\in\rr$</Math>.
                  </NoBreak>
                </OuterP>
                <OuterP class="indent-10">
                  A SECOND SOLUTION—first solution is over—starts by rotating{" "}
                  <NoBreak>
                    <Math>$P_1$</Math>,
                  </NoBreak>{" "}
                  <Math>$P_2$</Math> by <Math>$-\theta_2$</Math> radians about
                  the origin, to new points <Math>$P_1'$</Math> and{" "}
                  <Math>$P_2'$</Math> such that <Math>$P_2'$</Math> is aligned
                  with the <Math>$x$</Math> axis and <Math>$P_1'$</Math> has
                  argument{" "}
                  <NoBreak>
                ...
                <Pause />
                <OuterP>
                  Since the rotation does not affect distances, the answer
                  becomes the previous formula
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \sqrt&#123;x_1^2 + y_1^2 + x_2^2 + y_2^2 - 2(x_1y_1 +
                  x_2y_2)&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>applied with</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gather&#125; (x_1, y_1) \,=\, \,P_1' \,=\,
                  (r_1\cos(\theta_1 - \theta_2),\, r_1\sin(\theta_1 -
                  \theta_2)),\\ (x_2, y_2) \,=\, P_2' \,=\, (r_2,
                  0)\up&#123;1.8&#125; \end&#123;gather&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>which gives</OuterP>
                <Boxed>
                  <MathBlock>
                    $$ \sqrt&#123;r_1^2 + r_2^2 - 2r_1r_2\cos(\theta_1 -
                    \theta_2)&#125; $$
                  </MathBlock>
                </Boxed>
                <OuterP>again, since, namely,</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; x_1^2 + y_1^2 = r_1^2 \\ x_2^2 +
                  y_2^2 = \up&#123;1.5&#125;r_2^2 \\ x_1y_1 = \up&#123;1.5&#125;
                  r_1\cos(\theta_1 - \theta_2)\cdot r_2 \\ x_2y_2 =
                  \up&#123;1.5&#125; r_1\cos(\theta_1 - \theta_2)\cdot 0 = 0
                  \end&#123;gathered&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> As a result, the <i>distance squared</i>{" "}
                    between <Math>$P_1$</Math> and <Math>$P_2$</Math> is (peel
                    off the square root):
                  </OuterP>
                  <Boxed>
                    <MathBlock>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> The distance squared reduces to
                  </OuterP>
                  <Boxed>
                    <MathBlock>$$ r_1^2 + r_2^2 $$</MathBlock>
                  </Boxed>
                  <OuterP>and the ordinary distance reduces to</OuterP>
                  <Boxed>
                    <MathBlock>$$ \sqrt&#123;r_1^2 + r_2^2&#125; $$</MathBlock>
                  </Boxed>
                  <OuterP>
                    if <Math>$P_1$</Math> and <Math>$P_2$</Math> are at right
                    angle, since{" "}
                    <Math>$\cos|\theta_1 - \theta_2| = \cos\eta = 0$</Math> in
                    that case. This accords with the Pythagorean theorem, and
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 3.</i> Comparing the two solutions actually shows
                    that
                  </OuterP>
                  <Boxed>
                    <MathBlock>
                  ...
                  <OuterP>
                    in and of itself. This is a “second proof” of the angle-sum
                    formula for cos.
                  </OuterP>
                  <OuterP class="indent-10">
                    (*Some would say <i>first</i> proof, as our original proof
                    with the “famous diagram” put some restrictions on the range
                    of the angles, such as{" "}
                    <NoBreak>
                      <Math>$0 \leq \theta_1, \theta_2 \leq \eta$</Math>,
                    </NoBreak>{" "}
                    specifically.)
            ...
            <Exercise number={42}>
              <ExerciseStatement id="_133_h.a.i_">
                <OuterP>
                  <b>Exercise 42.</b> What is the dotted line distance as a
                  function of{" "}
                  <NoBreak>
                    <Math>$a$</Math>,
                  </NoBreak>{" "}
              ...
              <Solution>
                <OuterP>Recalling the “polar distance” formula</OuterP>
                <Pause />
                <MathBlock>
                  $$ \sqrt&#123;r_1^2 + r_2^2 - 2r_1r_2\cos(\theta_1 -
                  \theta_2)&#125; $$
                ...
                <OuterP>
                  ...
                  <Math>$r_2 = b$</Math> and{" "}
                  <Math>$\theta_1 - \theta_2 = \theta$</Math> in that formula.
                </OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
            ...
            <Exercise number={43}>
              <ExerciseStatement id="_134_h.a.i_">
                <OuterP>
                  <b>Exercise 43.</b> How to express the two sides marked ‘?’ as
                  functions of{" "}
                  <NoBreak>
                    <Math>$\alpha$</Math>,
                  </NoBreak>{" "}
                  ...
                  (NB: You can trust the drawing's suggestion that{" "}
                  <NoBreak>
                    <Math>$\beta &gt; \eta$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
              ...
              <Solution>
                <OuterP>The bottom length of ‘?’ is</OuterP>
                <Pause />
                <MathBlock>$$ a\cdot\sin\gamma\cdot\csc\alpha $$</MathBlock>
                <Pause />
                <OuterP>or, equivalently,</OuterP>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <OuterP>The top length of ‘?’, on the other hand, is</OuterP>
                <Pause />
                <MathBlock>$$ a\cdot\sin\beta\cdot\csc\alpha $$</MathBlock>
                <Pause />
                <OuterP>or, equivalently,</OuterP>
                <Pause />
                <MathBlock>
                ...
                <OuterP>
                  ...
                  <Math>$\sin(2\eta - x) = \sin(x)$</Math> for all{" "}
                  <NoBreak>
                    <Math>$x \in \rr$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>That's it!</OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> One more generally has...
                  </OuterP>
                  <Boxed>
                    <MathBlock>
                      $$ \begin&#123;gather*&#125; &#123;b\over a&#125; =
                      &#123;\sin \beta\over \sin\alpha&#125; \qquad &#123;a\over
                      b&#125; = &#123;\sin \alpha\over \sin\beta&#125; \\
                      &#123;c\over a&#125; = &#123;\sin \gamma\over
                      \sin\alpha&#125; \up&#123;2.2&#125; \qquad &#123;a\over
                      c&#125; = &#123;\sin \alpha\over \sin\gamma&#125;\\
                      &#123;c\over b&#125; = &#123;\sin \gamma\over
                      \sin\beta&#125; \up&#123;2.2&#125; \qquad &#123;b\over
                      c&#125; = &#123;\sin \beta\over \sin\gamma&#125; \\
                      \end&#123;gather*&#125; $$
                    </MathBlock>
                  </Boxed>
                  <OuterP>
                    ...(it's <Math>$6$</Math> times the same equation, no use
                    looking at all of them) for a general triangle of
                    sidelengths{" "}
                    <NoBreak>
                      <Math>$a$</Math>,
                    </NoBreak>{" "}
                  ...
                  <Boxed>
                    <MathBlock>
                      $$ \begin&#123;gather*&#125; &#123;a\over \sin\alpha&#125;
                      = &#123;b\over \sin\beta&#125; \\ &#123;a\over
                      \sin\alpha&#125; = &#123;c\over \sin\gamma&#125;
                      \up&#123;2.2&#125; \\ &#123;b\over \sin\beta&#125; =
                      &#123;c\over \sin\gamma&#125; \up&#123;2.2&#125;
                      \end&#123;gather*&#125; $$
                    </MathBlock>
                  </Boxed>
                  <OuterP>...or even to a single line...</OuterP>
                  <Boxed>
                    <MathBlock>
                      $$ &#123;a\over \sin\alpha&#125; = &#123;b\over
                      \sin\beta&#125; = &#123;c\over \sin\gamma&#125; $$
                    </MathBlock>
                  </Boxed>
                  <OuterP>...through cross-multiplication/division!</OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> This result (e.g., the last boxed equation
                    above) is known as the <i>sine rule</i>.
                  </OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 3.</i> Amusingly (but not that we really care) the
                    same equations hold if we change the definitions of{" "}
                    <NoBreak>
                      <Math>$\alpha$</Math>,
                    </NoBreak>{" "}
                    <NoBreak>
                    ...
                    and <Math>$\gamma$</Math> to be the exterior angles of the
                    triangle:
                  </OuterP>
                  <Pause />
                  ...
                  <OuterP>
                    ...
                    <Math>$\sin \gamma$</Math> changes sign <i>and only sign</i>{" "}
                    (<del>sine?</del> sign), leaving the original equations
                    intact.
                    <ImageRight line="1.0" src="/build-img/svgo-svg/NoGZ.svg" />
                  </OuterP>
                </SolutionNote>
              </Solution>
            </Exercise>
            <Exercise number={44}>
              <ExerciseStatement id="_135_h.a.i_">
                <OuterP>
                  <b>Exercise 44.</b> In the drawing below, at what coordinates,
                  expressed as a function of{" "}
                  <NoBreak>
                    <Math>$\theta$</Math>,
                  </NoBreak>{" "}
                  does the tangent to the circle intersect the <Math>$x$</Math>{" "}
                  and <Math>$y$</Math> axes?
                </OuterP>
                <Pause />
              ...
              <Solution>
                <OuterP>
                  Start by assuming that <Math>$\theta$</Math> lies in the first
                  quadrant, in which case both coordinates are nonnegative, and,
                  more specifically, are equal to the two purple lengths below:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/nF2I.svg" />
                <Pause />
                <OuterP>Regarding this diagram, note that:</OuterP>
                <Pause />
                <List style="gap:1em">
                  <Item>
                    <p>
                      we have already “used up” the fact that the radius of the
                      circle is <Math>$1$</Math> by making the dropped height
                      (which used to be a radius) length{" "}
                      <NoBreak>
                        <Math>$1$</Math>;
                      </NoBreak>
                    </p>
                  ...
                  <Item>
                    <p>
                      we use a “the complement of my complement is myself”-type
                      argument to deduce that the upper left angle is{" "}
                      <NoBreak>
                        <Math>$\theta$</Math>,
                      </NoBreak>{" "}
                      as well (cf.{" "}
                ...
                <Pause />
                <OuterP>
                  Because <Math>$1 \cdot \sec(\theta) = \sec(\theta)$</Math> the
                  bottom length is <Math>$\sec(\theta)$</Math> while the
                  vertical length is{" "}
                  <NoBreak>
                    <Math>$1\cdot \csc(\theta) = \csc(\theta)$</Math>,
                  </NoBreak>{" "}
                  similarly:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  ...i.e., in the first quadrant, at least, the coordinates are{" "}
                  <Math>$\sec(\theta)$</Math> and $\csc( theta):
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/i6Bn.svg" />
                <Pause />
                <OuterP>
                  For the other quadrants we can reason by symmetry with the
                  first quadrant:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  In more detail, the product of the two coordinates marked by
                  purple arrows is the same in all four quadrants, because
                  “minus times minus is plus”; but in first quadrant, the
                  product is{" "}
                  <NoBreak>
                    <Math>$1$</Math>,
                  </NoBreak>{" "}
                  because we know the product takes the form{" "}
                  <Math>$\cos\theta\cdot\sec\theta$</Math> in that quadrant;
                  therefore the product is <Math>$1$</Math> in <i>all</i>{" "}
                  quadrants; but the coordinate marked by the inside purple
                  arrow is <Math>$\cos\theta$</Math> in all quadrants;
                  therefore, lastly, the coordinate marked by the <i>outside</i>{" "}
                  purple arrow is <Math>$\sec\theta$</Math> in all quadrants,
                  since <Math>$\sec\theta$</Math> is the unique number whose
                  product with <Math>$\cos\theta$</Math> is{" "}
                  <NoBreak>
                    <Math>$1$</Math>;
                  </NoBreak>{" "}
                  similarly the inside orange arrow marks coordinate{" "}
                  <Math>$\sin\theta$</Math> is all quadrants, so the outside
                  orange arrow (by similar reasoning) has coordinate{" "}
                  <Math>$\csc\theta$</Math> in all quadrants, QED. (I.e., the
                  grand conclusion is that the two coordinates are
                </OuterP>
                <Pause />
                <MathBlock>$$ \Huge \sec\theta $$</MathBlock>
                <Pause />
                <OuterP>
                  for the{" "}
                  <NoBreak>
                ...
                <Pause />
                <MathBlock>$$ \Huge \csc\theta $$</MathBlock>
                <Pause />
                <OuterP>
                  for the{" "}
                  <NoBreak>
            ...
            <Exercise number={45}>
              <ExerciseStatement id="_136_h.a.i_">
                ...
                <Pause />
                <OuterP>
                  as definitions of tan <i>&amp;</i> cot, where can we find{" "}
                  <Math>$\tan(\theta)$</Math> <i>&amp;</i>{" "}
                  <Math>$\cot(\theta)$</Math> as geometric quantities that exist
                  in relation to the unit circle, in all quadrants? (I.e., find
                  “unit circle interpretations” of tan <i>&amp;</i> cot.)
                </OuterP>
              </ExerciseStatement>
              <Solution>
                ...
                <Pause />
                <OuterP>
                  can be understood as a fraction of the form “rise over run”,
                  i.e., the slope of the line from <Math>$(0, 0)$</Math> to{" "}
                  <NoBreak>
                    <Math>$(\cos\theta, \sin\theta)$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  However, one way to “materialize” a slope as a displacement is
                  to scale the triangle “rise over run” until the “run” becomes{" "}
                  <NoBreak>
                    <Math>$1$</Math>,
                  </NoBreak>{" "}
                  whereby the rise becomes equal to the slope, leading to this
                  construction of{" "}
                  <NoBreak>
                    <Math>$\tan\theta$</Math>:
                  </NoBreak>
                ...
                <Pause />
                <OuterP>
                  This also works if <Math>$\theta$</Math> is in other
                  quadrants, with a negative scaling factor if necessary:
                </OuterP>
                <Pause />
                <Image
                ...
                />
                <Pause />
                <OuterP>Symmetrically, the ratio</OuterP>
                <Pause />
                <MathBlock>
                  $$ \cot\theta = &#123;\cos\theta \over \sin\theta&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                  has the form “run over rise”, and can be evaluated by scaling
                  the same triangle until “rise” becomes{" "}
                  <NoBreak>
                    <Math>$1$</Math>,
                  </NoBreak>{" "}
                  in which case the corresponding (scaled) “run” becomes the
                  value of{" "}
                  <NoBreak>
                    <Math>$\cot\theta$</Math>:
                  </NoBreak>
                ...
                <Pause />
                <OuterP>
                  Overall, to give self-contained verbalizations of these
                  constructions, we have...
                </OuterP>
                <Pause />
                <CentralDisplayItalic>
                  <Math>$\tan\theta$</Math> is the{" "}
                  <NoBreak>
                    <Math>$y$</Math>
                    -coordinate
                  </NoBreak>{" "}
                  of the intersection of <Math>$x = 1$</Math> with the line
                  through the origin and <Math>$(\cos\theta, \sin\theta)$</Math>
                </CentralDisplayItalic>
                <Pause />
                <OuterP>
                  ...for{" "}
                ...
                <Pause />
                <CentralDisplayItalic>
                  <Math>$\cot\theta$</Math> is the{" "}
                  <NoBreak>
                    <Math>$x$</Math>
                    -coordinate
                  </NoBreak>{" "}
                  of the intersection of <Math>$y = 1$</Math> with the line
                  through the origin and <Math>$(\cos\theta, \sin\theta)$</Math>
                </CentralDisplayItalic>
                <Pause />
                <OuterP>
            ...
            <Exercise number={46}>
              <ExerciseStatement id="_137_h.a.i_">
                <OuterP>
                  ...
                  and a value <Math>$A &gt; 1$</Math> are marked on a line...
                </OuterP>
                <Pause />
                <Image
                ...
                />
                <Pause />
                <OuterP>...how can we find the placement of...</OuterP>
                <Pause />
                <MathBlock>$$ 1 / A $$</MathBlock>
                <Pause />
                <OuterP>
                  ...on the same line by a purely geometric construction? What
                  about if{" "}
                  <NoBreak>
                    <Math>$0 &lt; A &lt; 1$</Math>,
                  </NoBreak>{" "}
              ...
              <Solution>
                <OuterP>
                  <i>Solution 1.</i> The basic idea of this solution is to find
                  an angle <Math>$\theta$</Math> such that{" "}
                  <NoBreak>
                    <Math>$A = \sec(\theta)$</Math>,
                  </NoBreak>{" "}
                  if{" "}
                  <NoBreak>
                    <Math>$|A| &gt; 1$</Math>,
                ...
                <Pause />
                <OuterP>
                  <i>Step 1.</i> Find the midpoint between <Math>$0$</Math> and{" "}
                  <NoBreak>
                    <Math>$A$</Math>;
                  </NoBreak>{" "}
                  for this, the procedure is to use two circles of equal radius:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/JM7s.svg" />
                <Pause />
                <OuterP>
                  <i>Step 2.</i> Draw a semicircle of radius <Math>$A/2$</Math>{" "}
                  whose center is that midpoint:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/eQmC.svg" />
                <Pause />
                <OuterP>
                  <i>Step 3.</i> Draw a circle of radius <Math>$1$</Math> whose
                  center is{" "}
                  <NoBreak>
                    <Math>$(0, 0)$</Math>:
                  </NoBreak>
                ...
                <Pause />
                <OuterP>
                  <i>Step 4.</i> Draw a line through the intersections of the
                  two circles to find the position of{" "}
                  <NoBreak>
                    <Math>$1/A$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  (The reason that the whole procedure works is that this
                  triangle...
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  ...is actually right-angled at its upper corner by the
                  Peloponnesian circle theorem. This implies that the line from{" "}
                  <Math>$(A, 0)$</Math> to that corner is tangent to the circle
                  of radius{" "}
                  <NoBreak>
                    <Math>$1$</Math>,
                  </NoBreak>{" "}
                  which is what we want/need.)
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; x = 1 \\ y = 1
                  \end&#123;gathered&#125; $$
                </MathBlock>
                <Pause />
                <CentralDisplayItalic>
                ...
                <OuterP>
                  ...
                  start by marking points at equal distance to <Math>$A$</Math>{" "}
                  by drawing a circle centered at{" "}
                  <NoBreak>
                    <Math>$A$</Math>,
                  </NoBreak>{" "}
                  of any radius:
                ...
                <Pause />
                <OuterP>
                  <i>Step 2.</i> Use these points to draw a perpendicular
                  through{" "}
                  <NoBreak>
                    <Math>$A$</Math>,
                  </NoBreak>{" "}
                  similarly to the first step of the case{" "}
                  <NoBreak>
                    <Math>$|A| &gt; 1$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  <i>Step 3.</i> Draw a circle of radius <Math>$1$</Math>{" "}
                  centered at{" "}
                  <NoBreak>
                    <Math>$(0, 0)$</Math>,
                  </NoBreak>{" "}
                  and draw a line through <Math>$(0, 0)$</Math> and the upper
                ...
                <Pause />
                <OuterP>
                  <i>Step 4.</i> Construct a perpendicular to this line at the
                  point of intersection by repeating the process of the first
                  two steps; the intersection of that line with the main axis is{" "}
                  <NoBreak>
                    <Math>$1/A$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  <i>Solution 2.</i> Note that for an angle
                </OuterP>
                <Pause />
                <MathBlock>$$ \theta $$</MathBlock>
                <Pause />
                <OuterP>the values</OuterP>
                <Pause />
                <MathBlock>$$ \tan\theta $$</MathBlock>
                <Pause />
                <OuterP>and</OuterP>
                ...
                <Pause />
                <OuterP>However,</OuterP>
                <Pause />
                <MathBlock>$$ \,\cot\theta = 1/\tan\theta, $$</MathBlock>
                <Pause />
                <OuterP>
                  so if <Math>$\tan\theta = A$</Math> then{" "}
                  <NoBreak>
                    <Math>$\cot\theta = 1/A$</Math>,
                  </NoBreak>{" "}
                  which gives rise to the following idea for a geometric
                  construction of{" "}
                  <NoBreak>
                    <Math>$1/A$</Math>,
                  </NoBreak>{" "}
                  shown here for <Math>$0 &lt; A &lt; 1$</Math> (though it works
                  for all{" "}
                  <NoBreak>
                    <Math>$A \in \rr$</Math>
                    ):
                ...
                <Pause />
                <OuterP>
                  Or, symmetrically, we can treat <Math>$A$</Math> as{" "}
                  <NoBreak>
                    <Math>$\cot\theta$</Math>,
                  </NoBreak>{" "}
                  from which <Math>$\tan\theta$</Math> becomes{" "}
                  <NoBreak>
                    <Math>$1/A$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  The second diagram can also be understood in terms of
                  “materializing” the slope of a line of slope{" "}
                  <Math>$1/A$</Math> by scaling a “rise over run” triangle until
                  the run hits{" "}
                  <NoBreak>
                    <Math>$1$</Math>
                    ...
                ...
                <Pause />
                <OuterP>
                  ...like so; and symmetrically, the first diagram can be
                  understood in terms of scaling a “rise over run” triangle
                  until the <i>rise</i> hits{" "}
                  <NoBreak>
                    <Math>$1$</Math>
                    ...
                  </NoBreak>
                ...
                <OuterP>
                  ...
                  by the time ‘rise’ hits{" "}
                  <NoBreak>
                    <Math>$1$</Math>,
                  </NoBreak>{" "}
                  implying{" "}
                  <NoBreak>
                    “<Math>$\te&#123;run&#125; = &#123;1\over A&#125;$</Math>
                    ”,
                  </NoBreak>{" "}
                  since the slope is{" "}
                  <NoBreak>
                ...
                <OuterP class="indent-10">
                  Complete compass-and-ruler constructions can easily be
                  reconstituted from the above diagrams, and we hereby declare
                  the second solution finished!!
                </OuterP>
              </Solution>
            </Exercise>
            <Exercise number={47}>
              <ExerciseStatement id="_138_h.a.i_">
                <OuterP>
                  <b>Exercise 47.</b> Given a number line with{" "}
                  <NoBreak>
                    <Math>$0$</Math>,
                  </NoBreak>{" "}
                  <Math>$1$</Math> and a value <Math>$A &gt; 0$</Math>{" "}
                  indicated, how can we construct the values <Math>$A^2$</Math>{" "}
                  and <Math>$A^3$</Math> as lengths, using only ruler and
                  compass?
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                  ...
                  start by constructing a perpendicular to the <Math>$x$</Math>{" "}
                  axis (“the number line” = “the <Math>$x$</Math> axis”) through{" "}
                  <NoBreak>
                    <Math>$1$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  Take the intersection of this line with a circle of center{" "}
                  <Math>$(0, 0)$</Math> of radius{" "}
                  <NoBreak>
                    <Math>$A$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  This gives us an angle <Math>$\theta$</Math> such that{" "}
                  <NoBreak>
                    <Math>$\sec\theta = A$</Math>:
                  </NoBreak>
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  Now it suffices to apply one of the “powers of secant”
                  constructions to obtain powers of{" "}
                  <NoBreak>
                    <Math>$A$</Math>,
                  </NoBreak>{" "}
                ...
                <OuterP class="indent-10">
                  ...
                  on the other hand, do the same initial steps but with{" "}
                  <NoBreak>
                    ‘<Math>$1$</Math>’
                  </NoBreak>{" "}
                  and{" "}
                  ...
                  reversed, resulting in an angle <Math>$\theta$</Math> for
                  which{" "}
                  <NoBreak>
                    <Math>$A = \cos\theta$</Math>:
                  </NoBreak>
                ...
                <Pause />
                <OuterP>
                  We can then do a “powers of cosine” construction, that is
                  symmetric to powers of secant, to find powers of{" "}
                  <NoBreak>
                    <Math>$A$</Math>,
                  </NoBreak>{" "}
                  for example:
                ...
                <Pause />
                <OuterP>
                  Though in this case, it bears discussing how we construct,
                  say, this perpendicular:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/1-DQ.svg" />
                <Pause />
                <OuterP>...because this perpendicular must</OuterP>
                <Pause />
                <CentralDisplayItalic>arrive</CentralDisplayItalic>
                <Pause />
                <OuterP>perpendicularly at a given line, not</OuterP>
                <Pause />
                <CentralDisplayItalic>depart</CentralDisplayItalic>
                <Pause />
                <OuterP>
                  perpendicularly from a given line. (In the order in which the
                  construction unfolds, this perpendicular “originates” from its
                  upper end, which is a situation that we have not encountered
                  yet.) In this case, the procedure is to draw a circle, in
                  orange below, whose center is the starting point of the
                  perpendicular, and that crosses the
                  line-to-which-we-must-be-perpendicular in two places:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/FFkM.svg" />
                <Pause />
                <OuterP>
                  Then use those crossings as the centers of two more circles of
                  equal radius...
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  ...whose intersection gives us a second point (even two more
                  points, if we use a radius different from the first orange
                  circle), and the means to draw the perpendicular itself.
                </OuterP>
                <Pause />
                <OuterP>
                  <i>Solution 2.</i> Regardless of whether{" "}
                  <Math>$A &lt; 1$</Math> or{" "}
                  <NoBreak>
                    <Math>$A &gt; 1$</Math>,
                  </NoBreak>{" "}
                  draw a perpendicular to the number line through{" "}
                  <Math>$x = 1$</Math> and use a compass to report{" "}
                  <Math>$A$</Math> onto this line (here with{" "}
                  <NoBreak>
                    <Math>$A &lt; 1$</Math>
                    ):
                  </NoBreak>
                ...
                <Pause />
                <OuterP>
                  This defines a an angle <Math>$\theta$</Math> such that{" "}
                  <NoBreak>
                    <Math>$A = \tan\theta$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  Then we can use any construction for powers of tan, for
                  example this spiral construction:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/PFh1.svg" />
                <Pause />
                <OuterP>
                  (Again, constructing the spiral means constructing a sequence
                  of perpendiculars, but we can do that!)
                </OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> If <Math>$A &lt; 1$</Math> there is a clever
                    construction, variant of solution 1, that one can use to
                    construct powers of <Math>$A$</Math> using only one compass
                    stroke and one ruler stroke per power of <Math>$A$</Math>{" "}
            ...
            <Exercise number={48}>
              <ExerciseStatement id="_139_h.a.i_">
                <OuterP>
                  <b>Exercise 48.</b> Given two lengths <Math>$A$</Math> and{" "}
                  <NoBreak>
                    <Math>$B$</Math>,
                  </NoBreak>{" "}
                  how can
                ...
                <Pause />
                <MathBlock>$$ \sqrt&#123;AB&#125; $$</MathBlock>
                <Pause />
                <OuterP>be constructed using only ruler and compass?</OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                  A preliminary “arithmetic” observation is that there is a
                  common multiplicative factor
                </OuterP>
                <Pause />
                <MathBlock>$$ \gamma $$</MathBlock>
                <Pause />
                <OuterP>
                  separating{" "}
                  <NoBreak>
                ...
                <Pause />
                <OuterP>The proof is that</OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;\sqrt&#123;AB&#125;\over A&#125; =
                  &#123;B\over\sqrt&#123;AB&#125;&#125; $$
                ...
                <Pause />
                <OuterP>is equivalent to</OuterP>
                <Pause />
                <MathBlock>$$ (\sqrt&#123;AB&#125;)^2 = AB $$</MathBlock>
                <Pause />
                <OuterP>
                  ...
                  a second proof (we can't help ourselves) is that...
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;\sqrt&#123;AB&#125;\over A&#125; =
                  &#123;\sqrt&#123;A&#125;\cdot\sqrt&#123;B&#125;\over A&#125; =
                  &#123;\sqrt&#123;B&#125;\over \sqrt&#123;A&#125;&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>...while...</OuterP>
                ...
                <OuterP>
                  ...
                  as well, from the second proof. (Indeed, if you multiply twice
                  by <Math>$\sqrt&#123;B&#125;/\sqrt&#123;A&#125;$</Math> you're
                  going to remove one factor of <Math>$A$</Math> while
                  introducing one factor of{" "}
                  <NoBreak>
                    <Math>$B$</Math>
                    .)
                  </NoBreak>
                ...
                <Pause />
                <OuterP>
                  <i>Solution 1.</i> Assume wlog (= “without loss of
                  generality”) that{" "}
                  <NoBreak>
                    <Math>$B &gt; A$</Math>.
                  </NoBreak>{" "}
                  We report the lengths <Math>$A$</Math> and <Math>$B$</Math>{" "}
                  onto a common number line such that the left end of each
                  length is identified with{" "}
                  <NoBreak>
                    <Math>$0$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  We construct <Math>$B/2$</Math> by intersecting two
                  sufficiently large circles of centers{" "}
                  <NoBreak>
                    <Math>$0$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                ...
                <Pause />
                <OuterP>
                  We draw a half-circle of radius <Math>$B/2$</Math> and of
                  center{" "}
                  <NoBreak>
                    <Math>$B/2$</Math>,
                  </NoBreak>{" "}
                ...
                <OuterP>
                  ...
                  Peloponnesian circle theorem, so we have effectively succeeded
                  in constructing this diagram, for some angle{" "}
                  <NoBreak>
                    <Math>$\theta$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <MathBlock>$$ &#123;B\over A&#125; = \sec^2\theta $$</MathBlock>
                <Pause />
                <OuterP>in this case, implying that</OuterP>
                <Pause />
                <MathBlock>
                  $$ \sec\theta =
                  &#123;\sqrt&#123;B&#125;\over\sqrt&#123;A&#125;&#125; $$
                ...
                <Pause />
                <OuterP>
                  is the factor <Math>$\gamma$</Math> mentioned in the
                ...
                <Pause />
                <OuterP>
                  ...here, in our construction from a few lines above.
                </OuterP>
                <Pause />
                <OuterP>
                  <i>Solution 2.</i> Place <Math>$A$</Math> and <Math>$B$</Math>{" "}
                  end-to-end:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  Find the middle of the combined segment and use it to draw a
                  semicircle whose diameter is the combined segment:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/OwXA.svg" />
                <Pause />
                <OuterP>
                  Draw a perpendicular to the segment at the point where{" "}
                  <Math>$A$</Math> and <Math>$B$</Math> meet, which defines
                  again a right triangle by the Peloponnesian circle theorem:
                </OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  lower —leftif we label it —suchis also repeated middle top
                ...
                <Pause />
                <OuterP>
                  The ratio that takes <Math>$A$</Math> to the middle height and
                  that takes the middle height to <Math>$B$</Math> are therefore
                  both{" "}
                  <NoBreak>
                    <Math>$\tan(\theta)$</Math>:
                  </NoBreak>
                ...
                <Pause />
                <OuterP>This implies that</OuterP>
                <Pause />
                <MathBlock>$$ \tan(\theta) $$</MathBlock>
                <Pause />
                <OuterP>
                  is the factor <Math>$\gamma$</Math> such that{" "}
                  <Math>$A\gamma^2 = B$</Math> mentioned at the outset, and that
                  said “middle height” is{" "}
                  <NoBreak>
                    <Math>$\sqrt&#123;AB&#125;$</Math>!
                  </NoBreak>
                </OuterP>
                <Pause />
                <OuterP>
                  <i>Vocabulary.</i> The square-root-of-the-product
                </OuterP>
                <Pause />
                <MathBlock>$$ \sqrt&#123;xy&#125; $$</MathBlock>
                <Pause />
                <OuterP>is called the</OuterP>
                <Pause />
                <CentralDisplayItalic>geometric mean</CentralDisplayItalic>
                <Pause />
                <OuterP>
                  of <Math>$x$</Math> and{" "}
                  <NoBreak>
                ...
                <Pause />
                <MathBlock>$$ &#123;x + y\over 2&#125; $$</MathBlock>
                <Pause />
                <OuterP>which is called the</OuterP>
                <Pause />
                <CentralDisplayItalic>arithmetic mean</CentralDisplayItalic>
                <Pause />
                <OuterP>
                  (or just “mean”) of <Math>$x$</Math> and{" "}
                  <NoBreak>
                    <Math>$y$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> Legend has it that a
                  </OuterP>
                  <Pause />
                  <CentralDisplayItalic>
                  ...
                  <Pause />
                  <OuterP>
                    is so-called because each term in the sequence that is not
                    the first or the last is the geometric mean of the two terms
                    on either side, and that similarly an
                  </OuterP>
                  <Pause />
                  <CentralDisplayItalic>
                  ...
                  <OuterP>
                    is so-called because each term in the sequence that is not
                    the first or the last is the arithematic mean of the two
            ...
            <Exercise work="ing" number={49}>
              <ExerciseStatement id="_140_h.a.i_">
                <OuterP>
                  <b>Exercise 49.</b> What are the orthogonal (= perpendicular)
                  projections of the vectors{" "}
                  <NoBreak>
                    <Math>$(1, 0)$</Math>,
                  </NoBreak>{" "}
                  <Math>$(0, 1)$</Math> onto a{" "}
                  <NoBreak>
                    <Math>$(-1, 1)$</Math>
                    -ruler
                  </NoBreak>{" "}
                  placed at angle <Math>$\theta$</Math> in the unit circle?
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/QGG0.svg" />
                <Pause />
                <OuterP>
                  (I.e., find the ruler-readings marked ‘1’ and ‘2’ above as a
              ...
              <Solution>
                <OuterP>
                  <i>Solution 1.</i> If we rotate the diagram by{" "}
                  <Math>$-\theta$</Math> to align the ruler with the{" "}
                  <Math>$x$</Math> axis the new angles of the vectors are{" "}
                  <Math>$-\theta$</Math> and <Math>$\eta - \theta$</Math>{" "}
                  (changed from <Math>$0$</Math> and{" "}
                  <NoBreak>
                    <Math>$\eta$</Math>,
                  </NoBreak>{" "}
                  respectively):
                ...
                <Pause />
                <OuterP>The ruler-readings are therefore</OuterP>
                <Pause />
                <MathBlock>$$ \cos(-\theta) = \cos(\theta) $$</MathBlock>
                <Pause />
                <OuterP>and</OuterP>
                <Pause />
                <MathBlock>$$ \cos(\eta - \theta) = \sin(\theta) $$</MathBlock>
                <Pause />
                <OuterP>
                  respectively (in order ‘1’, ‘2’), making use of basic
                  identities. (See the section “Identities with{" "}
                  <NoBreak>
                    <Math>$\eta$</Math>”
                  </NoBreak>{" "}
                  in this chapter.)
                ...
                <Pause />
                <OuterP>
                  <i>Solution 2.</i> Recalling first...
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/h28T.svg" />
                <Pause />
                <OuterP>
                  ...this figure from the chapter, we note that there is an
                  alternate set of definitions for sin and cos that is based on
                ...
                <Pause />
                <OuterP>
                  Now comparing these definitions to this figure...
                </OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  it becomes trivial to see that the two ruler-readings are just{" "}
                  <Math>$\cos(\theta)$</Math> (‘1’) and{" "}
                  <Math>$\sin(\theta)$</Math> (‘2’).
                </OuterP>
                <Pause />
                <OuterP>
                  <i>Solution 3.</i> More generally, when a unit vector is
                  projected onto a “unit ruler”, we can switch the ruler{" "}
                  <i>&amp;</i> vector positions without affecting the
                  ruler-reading:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  (Because what counts is the angle between the “forward end” of
                  the ruler and the forward end of the vector, measured as an
                  angle between <Math>$0^\circ$</Math> and{" "}
                  <NoBreak>
                    <Math>$180^\circ$</Math>,
                  </NoBreak>{" "}
                  and this angle remains the same.) If we apply this to the
                  problem statement the unique ruler is replaced by a unique
                  vector while the two vectors are each replaced by a ruler:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/Xur8.svg" />
                <Pause />
                <OuterP>
                  ...and in the new configuration, at bottom right, one can see
                  by the original definitions of sin and cos that the
                  projections are are <Math>$\cos(\theta)$</Math> (‘1’),{" "}
                  <Math>$\sin(\theta)$</Math> (‘2’).
                </OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> The original definitions of sin and cos
                    involve a single point rotating around the unit circle
                    projected onto two fixed rulers, resulting in two functions:
                  </OuterP>
                  <Pause />
                  <Image
                  ...
                  <Pause />
                  <CentralDisplayItalic>
                    the positive part of the ruler goes to meet the point
                  </CentralDisplayItalic>
                  <Pause />
                  <OuterP>
            ...
            <Exercise work="ing" number={50}>
              <ExerciseStatement id="_141_h.a.i_">
                <OuterP>
                  <b>Exercise 50.</b> Show that
                </OuterP>
                <Pause />
                <MathBlock>
                ...
                <OuterP>
                  ...
                  <Math>$\beta \in \rr$</Math> via a geometric argument. (I.e.,
                  AVOID using the angle-sum formula.)
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                  We know (or should know, or are about to know) (or are about
                  to <i>believe</i>) that
                </OuterP>
                <Pause />
                <MathBlock>$$ \cos(\alpha - \beta) $$</MathBlock>
                <Pause />
                <OuterP>
                  is the projection of a unit vector of angle{" "}
                  <Math>$\alpha$</Math> onto a ruler of angle{" "}
                  <NoBreak>
                    <Math>$\beta$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <OuterP>
                  ...
                  respectively, for the vectors <Math>$(1, 0)$</Math> and{" "}
                  <Math>$(0, 1)$</Math> (in the manner of physicists):
                </OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  <Math>$\sin\beta$</Math> respectively on the ruler:
                </OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  <Math>$(\cos\alpha, \sin\alpha)$</Math> is the sum of a scaled
                  copy of <Math>$\vecb&#123;i&#125;$</Math> and scaled copy of{" "}
                  <NoBreak>
                    <Math>$\vecb&#123;j&#125;$</Math>,
                  </NoBreak>{" "}
                  specifically the sum of{" "}
                  <Math>$\vecb&#123;i&#125;\cdot\cos(\alpha)$</Math> and{" "}
                  <NoBreak>
                    <Math>$\vecb&#123;j&#125;\cdot\sin(\alpha)$</Math>:
                  </NoBreak>
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  The scaled copy of <Math>$\vecb&#123;i&#125;$</Math> projects
                  to <Math>$\cos(\alpha)\cdot\cos(\beta)$</Math> on the ruler,
                ...
                <OuterP>
                  ...
                  <Math>$\vecb&#123;j&#125;$</Math> projects to{" "}
                  <NoBreak>
                    <Math>$\sin(\alpha)\cdot\sin(\beta)$</Math>,
                  </NoBreak>{" "}
                  by scaling the projection of{" "}
                  <NoBreak>
                    <Math>$\vecb&#123;j&#125;$</Math>:
                ...
                <Pause />
                <OuterP>
                  Moreover, the sum-of-projections is the projection-of-the-sum:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/cfa7.svg" />
                <Pause />
                <OuterP>This gives us</OuterP>
                <Boxed>
                  <MathBlock>
                    $$ \cos(\alpha-\beta) = \cos\alpha\cos\beta +
                    \sin\alpha\sin\beta $$
                ...
                <OuterP>
                  ...
                  <Math>$(\cos \alpha, \sin \alpha)$</Math> onto the ruler of
                  angle{" "}
                  <NoBreak>
                    <Math>$\beta$</Math>.
                  </NoBreak>
            ...
            <Exercise work="ing" number={51}>
              <ExerciseStatement id="_142_h.a.i_">
                <OuterP>
                  <b>Exercise 51.</b> A unit vector
                </OuterP>
                <Pause />
                <MathBlock>$$ (x_1, y_1, z_1) \in \rr^3 $$</MathBlock>
                <Pause />
                <OuterP>
                  [meaning:{" "}
                  <NoBreak>
                    <Math>$x_1^2 + y_1^2 + z_1^2 = 1$</Math>]
                  </NoBreak>{" "}
                  is projected onto a ruler whose{" "}
                  <NoBreak>
                    ‘<Math>$0$</Math>’
                  </NoBreak>{" "}
                  is at <Math>$(0, 0, 0)$</Math> and whose{" "}
                  <NoBreak>
                    ‘<Math>$1$</Math>’
                  </NoBreak>{" "}
                  is at{" "}
              ...
              <Solution>
                <OuterP>Putting</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; \vi = (1,\, 0,\, 0), \\ \vj =
                  (0,\, 1,\, 0),\up&#123;1.2&#125; \\ \vk = (0,\, 0,\,
                  1)\,\up&#123;1.2&#125; \end&#123;gathered&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>we have</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; x_1\cdot\vi = (x_1, \,0, \,0),
                  \\ y_1\cdot\vj = (0, \,y_1, \,0)\up&#123;1.2&#125;, \\
                  z_1\cdot\vk = (0, \,0, \,z_1)\up&#123;1.2&#125;\,
                  \end&#123;gathered&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>giving</OuterP>
                <Pause />
                <MathBlock>
                  $$ (x_1, y_1, z_1) = x_1\!\cdot\vi + y_1\!\cdot\vj +
                  z_1\!\cdot\vk $$
                </MathBlock>
                <Pause />
                <OuterP>
                  because vectors are added component-wise. This sum can be
                  illustrated:
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  As discussed in Note 1 of Exercise 11 we can translate vectors
                  to anywhere in space while preserving their projection onto
                  the ruler. In particular, keeping the same positioning in
                  space of the vectors as above shows that the projection of{" "}
                  <Math>$(x_1, y_1, z_1)$</Math> is the sum of the three
                  separate projections of{" "}
                  <NoBreak>
                    <Math>$x_1\vi$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                    <Math>$y_1\rt&#123;0.1&#125;\vj$</Math>,
                  </NoBreak>{" "}
                  <NoBreak>
                    <Math>$z_1\vk$</Math>:
                  </NoBreak>
                ...
                <Pause />
                <OuterP>
                  However, the projection of <Math>$z_1\vk$</Math> is just{" "}
                  <Math>$z_1$</Math> times the projection of{" "}
                  <NoBreak>
                    <Math>$\vk$</Math>,
                  </NoBreak>{" "}
                  as illustrated below, so it suffices to find the projection of{" "}
                  <Math>$\vk$</Math> to find the projection of{" "}
                  <NoBreak>
                    <Math>$z_1\vk$</Math>:
                  </NoBreak>
                </OuterP>
                ...
                <Pause />
                <OuterP>
                  The projection of <Math>$\vk$</Math> is the same as the
                  projection of <Math>$(x_2, y_2, z_2)$</Math> onto a ruler with
                  ‘0’ at the origin and ‘1’ at{" "}
                  <NoBreak>
                    <Math>$\vk$</Math>,
                  </NoBreak>{" "}
                  because when one unit vector is projected onto another the
                  situation is symmetric, and we can always switch the role of
                  which vector is the ruler, and which is being projected (cf.
                  Solution 3 of Exercise 0):
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/k0fx.svg" />
                <Pause />
                <OuterP>
                  But the projection of <Math>$(x_2, y_2, z_2)$</Math> onto{" "}
                  <Math>$\vk$</Math> equals simply
                </OuterP>
                <Pause />
                <MathBlock>$$ z_2 $$</MathBlock>
                <Pause />
                <OuterP>
                  by the fact that we are projecting onto the <Math>$z$</Math>{" "}
                  axis, so the projection of <Math>$\vk$</Math> onto{" "}
                  <Math>$(x_2, y_2, z_2)$</Math> is
                </OuterP>
                <Pause />
                <MathBlock>$$ z_2 $$</MathBlock>
                <Pause />
                <OuterP>
                  as well, and the projection of <Math>$z_1\vk$</Math> onto{" "}
                  <Math>$(x_2, y_2, z_2)$</Math> is
                </OuterP>
                <Pause />
                <MathBlock>$$ z_1z_2 $$</MathBlock>
                <Pause />
                <OuterP>by scaling.</OuterP>
                <OuterP class="indent-10">Likewise, we find that</OuterP>
                <Pause />
                <MathBlock>$$ y_1y_2 $$</MathBlock>
                <Pause />
                <OuterP>
                  is the projection of <Math>$y_1\rt&#123;0.1&#125;\vj$</Math>{" "}
                  onto{" "}
                  <NoBreak>
                    <Math>$(x_2, y_2, z_2)$</Math>,
                  </NoBreak>{" "}
                ...
                <Pause />
                <MathBlock>$$ x_1x_2 $$</MathBlock>
                <Pause />
                <OuterP>
                  is the projection of <Math>$x_1\vi$</Math> onto{" "}
                  <NoBreak>
                    <Math>$(x_2, y_2, z_2)$</Math>,
                  </NoBreak>{" "}
                  so
                ...
                <Boxed>
                  <MathBlock>$$ x_1x_2 + y_1y_2 + z_1z_2 $$</MathBlock>
                </Boxed>
                <OuterP>
                  is the projection of <Math>$(x_1, y_1, z_1)$</Math> onto{" "}
                  <NoBreak>
                    <Math>$(x_2, y_2, z_2)$</Math>,
                  </NoBreak>{" "}
            ...
            <Exercise number={52}>
              <ExerciseStatement id="_143_h.a.i_">
                <OuterP>
                  <b>Exercise 52.</b> Which function is most plausibly
                  associated to which graph?
                </OuterP>
                <Pause />
                <table
                  class="slice"
              ...
              <Solution>
                <OuterP>Since</OuterP>
                <Pause />
                <MathBlock>$$ x \ra \sin^2 x $$</MathBlock>
                <Pause />
                <MathBlock>$$ x \ra \cos^2 x $$</MathBlock>
                <Pause />
                <OuterP>
                  are nonnegative [the square of a number is nonnegative] these
                  functions must either be the top right or bottom left graphs,
                  as the other two graphs weave in and out of negative
                  territory; given additionally that
                </OuterP>
                <Pause />
                <MathBlock>$$ \,\cos(0) = 1, $$</MathBlock>
                <Pause />
                <MathBlock>$$ \sin(0) = 0 $$</MathBlock>
                <Pause />
                <OuterP>we can further deduce that</OuterP>
                <Pause />
                <MathBlock>$$ x \ra \sin^2 x $$</MathBlock>
                <Pause />
                <OuterP>can only be the top right graph, and</OuterP>
                <Pause />
                <MathBlock>$$ x \ra \cos^2 x $$</MathBlock>
                <Pause />
                <OuterP>
                ...
                <Pause />
                <MathBlock>$$ |\sin x \cdot \cos x| \leq 1 $$</MathBlock>
                <Pause />
                <OuterP>
                  for all <Math>$x \in \rr$</Math> (as the product of two
                  numbers that are between <Math>$-1$</Math> and{" "}
                  <Math>$1$</Math> is itself between <Math>$-1$</Math> and{" "}
                  <NoBreak>
                    <Math>$1$</Math>
                    ),
                  </NoBreak>{" "}
                  whereas the top left graph is at times greater than{" "}
                  <Math>$1$</Math> and at times less than{" "}
                  <NoBreak>
                    <Math>$-1$</Math>,
                  </NoBreak>{" "}
                ...
                <Pause />
                <OuterP>...this one!</OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> These are in fact the actual graphs of the
                    stated functions, not just “plausible” graphs.
                  </OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> It is indeed quite striking that all of these
                    functions seem to be <i>sinusoids</i>, given the appearance
                    of their graphs. (A “sinusoid” is formally defined as a
                    function of the form{" "}
                    <Math>$x \ra A\cdot \sin(Bx + C) + D$</Math> for some
                    constants{" "}
                    <NoBreak>
                      <Math>$A$</Math>,
                    </NoBreak>{" "}
                    ...
                    There is <i>a priori</i> no good reason for this.
                  </OuterP>
                </SolutionNote>
              </Solution>
            </Exercise>
            <Exercise number={53}>
              <ExerciseStatement id="_144_h.a.i_">
                <OuterP>
                  <b>Exercise 53.</b> Where or how, if at all, is the
                </OuterP>
                <Pause />
                <CentralDisplayItalic>
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>
                  It seems that if we would vertically flip one of the cutouts
                  (in this case{" "}
                  <NoBreak>
                    <Math>$y = \cos^2(x)$</Math>
                    ),
                ...
                />
                <Pause />
                <OuterP>This is no illusion: it occurs because</OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  i.e., because of the pythagorean identity!
                </OuterP>
              </Solution>
            </Exercise>
            <Exercise number={54}>
              <ExerciseStatement id="_145_h.a.i_">
                <OuterP>
                  <b>Exercise 54.</b> Based on the graphs of{" "}
                  <InChapterLink
                    href="/article/chapter5#_143_h.a.i_"
                    class="in-chapter-link">
                    Exercise 52
                  ...
                  <Math>$x \ra \sin^2 x$</Math> and{" "}
                  <Math>$x \ra \cos x\sin x$</Math> are more closely related to
                </OuterP>
                <Pause />
                <MathBlock>$$ \sin(x/2) $$</MathBlock>
                <Pause />
                <OuterP>
                  and/or{" "}
                  <NoBreak>
              ...
              <Solution>
                <OuterP>
                  ...
                  <Math>$\sin^2$</Math> and <Math>$\sin\cdot\cos$</Math> that
                  these functions cycle “twice as fast” as sine or cosine, just
                  like <Math>$x \ra \sin(2x)$</Math> and{" "}
                  <Math>$x\ra \cos(2x)$</Math> cycle twice as fast. The answer
                  is therefore: the latter. (I.e.,{" "}
                  <NoBreak>
                    “<Math>$\sin(2x)$</Math>
                  </NoBreak>{" "}
                  and/or{" "}
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> More mathematically, say that{" "}
                    <Math>$f : \rr \ra \rr$</Math>
                  </OuterP>
                  <Pause />
                  <CentralDisplayItalic>
                    has period <Math>$T$</Math>
                  </CentralDisplayItalic>
                  <Pause />
                  <OuterP>or</OuterP>
                  <Pause />
                  <CentralDisplayItalic>
                    is periodic mod <Math>$T$</Math>
                  </CentralDisplayItalic>
                  <Pause />
                  <OuterP>
                    for some number <Math>$T \in \rr$</Math> if
                  </OuterP>
                  <Pause />
                  ...
                  <OuterP>
                    ...
                    <Math>$\cos^2$</Math> and <Math>$\sin\cos$</Math> are not
                    only periodic mod <Math>$4\eta$</Math> but accomplish the
                    further feat of being
                  </OuterP>
                  <Pause />
                  <CentralDisplayItalic>
                    periodic mod <Math>$2\eta$</Math>
                  </CentralDisplayItalic>
                  <Pause />
                  <OuterP>since, for example,</OuterP>
                  <Pause />
                  <MathBlock>
                    $$ \sin(x + 2\eta)\cos(x + 2\eta) = (-\sin x)(-\cos x) =
                    \sin x\cos x $$
                    <ImageLeft
            ...
            <Exercise number={55}>
              <ExerciseStatement id="_146_h.a.i_">
                ...
                <List marker="decimal">
                  <Item>
                    <p>
                      Choose either <Math>$\cos(2x)$</Math> or{" "}
                      <Math>$\sin(2x)$</Math> as a “most closely related
                      starting point”, according to your sense of which of{" "}
                      <Math>$\cos(2x)$</Math> or <Math>$\sin(2x)$</Math> is more
                      closely related to the given function.
                    </p>
                  </Item>
                  <Item>
                    <p>
                      Conjecture a sequence of geometric transformations of the
                      plane that takes either <Math>$\cos(2x)$</Math> or{" "}
                      <NoBreak>
                        <Math>$\sin(2x)$</Math>,
                      </NoBreak>{" "}
                      depending on which you chose, onto the graph of the given
                      function (be it{" "}
                      <NoBreak>
                        <Math>$\cos\sin$</Math>,
                      </NoBreak>{" "}
                  ...
                  <Item>
                    <p>Prove your conjecture by algebra.</p>
                  </Item>
                </List>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                  For <Math>$\cos^2$</Math> we take
                </OuterP>
                <Pause />
                <MathBlock>$$ \cos(2x) $$</MathBlock>
                <Pause />
                <OuterP>
                  as our starting point, since the graph of{" "}
                  <Math>$\cos(2x)$</Math> seems more closely related to the
                  graph of <Math>$\cos^2(x)$</Math> than <Math>$\sin(2x)$</Math>{" "}
                ...
                <OuterP>
                  ...
                  <Math>$\cos^2$</Math> is the graph of{" "}
                  <NoBreak>
                    <Math>$\cos(2x)$</Math>
                    ...
                  </NoBreak>
                ...
                <CentralDisplayItalic>
                  ...
                  vertically scaled by <Math>$1/2$</Math>
                ...
                <CentralDisplayItalic>
                  ...
                  translated up by <Math>$1/2$</Math>
                  <ImageLeft src="/build-img/svgo-svg/Hkfc.svg" />
                </CentralDisplayItalic>
                <Pause />
                <OuterP>...equivalently; for the proof, the sum-formula</OuterP>
                <Pause />
                <MathBlock>
                  $$ \cos(A + B) = \cos A\cos B - \sin A\sin B $$
                </MathBlock>
                <Pause />
                <OuterP>implies</OuterP>
                <Pause />
                <MathBlock>$$ \cos(2x) = \cos^2 x - \sin^2 x $$</MathBlock>
                <Pause />
                <OuterP>from which</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;aligned&#125;
                  \phantom&#123;=&#125;&amp;\,\,(\cos(2x) + 1)\cdot &#123;1\over
                  2&#125; \\ =&amp;\,\,\up&#123;1.4&#125;(\cos^2 x - \sin^2 x +
                  1)\cdot &#123;1\over 2&#125; \\
                  =&amp;\,\,\up&#123;1.4&#125;(\cos^2 x + \cos^2 x)\cdot
                  &#123;1\over 2&#125; \\ =&amp;\,\,\up&#123;1.4&#125;\cos^2 x
                  \end&#123;aligned&#125; $$
                  <ImageLeft
                ...
                <Pause />
                <OuterP>which completes the proof, since</OuterP>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <OuterP>
                  is <Math>$\cos(2x)$</Math> translated up by{" "}
                  <NoBreak>
                    <Math>$1$</Math>,
                  </NoBreak>{" "}
                  scaled vertically by{" "}
                ...
                <OuterP class="indent-10">
                  For <Math>$\sin^2$</Math> we can similarly conjecture that{" "}
                  <Math>$\sin^2$</Math> is the graph of <Math>$\cos(2x)$</Math>
                </OuterP>
                <Pause />
                <CentralDisplayItalic>
                  vertically scaled by{" "}
                ...
                <Pause />
                <OuterP>and, indeed,</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;aligned&#125;
                  \phantom&#123;=&#125;&amp;\,\,-&#123;1\over 2&#125;\cos(2x) +
                  &#123;1\over 2&#125;\\
                  =&amp;\,\,\up&#123;1.4&#125;-&#123;1\over 2&#125;(\cos^2 x -
                  \sin^2 x) + &#123;1\over 2&#125;\\
                  =&amp;\,\,\up&#123;1.4&#125;&#123;1\over 2&#125;\sin^2 x +
                  &#123;1\over 2&#125;(1 - \cos^2 x)\\
                  =&amp;\,\,\up&#123;1.4&#125;&#123;1\over 2&#125;\sin^2 x +
                  &#123;1\over 2&#125;\sin^2 x\\
                  =&amp;\,\,\up&#123;1.4&#125;\sin^2 x \end&#123;aligned&#125;
                  $$
                  <ImageLeft
                ...
                <Pause />
                <OuterP>which completes a proof.</OuterP>
                <OuterP class="indent-10">
                  For <Math>$\sin\cdot\cos$</Math> it seems that{" "}
                  <Math>$\sin(2x)$</Math> is more closely related:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/ADAv.svg" />
                <Pause />
                <OuterP>
                  In fact, it seems that <Math>$\sin\cdot\cos$</Math> is just{" "}
                  <Math>$y = \sin(2x)$</Math>
                </OuterP>
                <Pause />
                <CentralDisplayItalic>
                ...
                <Pause />
                <OuterP>as per the conjecture!</OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> Here is a “pretty” rearrangement of the
                    formulas discovered above:
                  </OuterP>
                  <Boxed>
                    <MathBlock>
                      $$ \begin&#123;gathered&#125; \cos^2(x) = &#123;1\over
                      2&#125; + &#123;1\over 2&#125;\cos(2x) \\
                      \up&#123;2.1&#125;\sin^2(x) = &#123;1\over 2&#125; -
                      &#123;1\over 2&#125;\cos(2x) \\
                      \up&#123;2.1&#125;\sin(x)\cos(x) = &#123;1\over
                      2&#125;\sin(2x) \end&#123;gathered&#125; $$
                    </MathBlock>
                  </Boxed>
                  <OuterP>Another pretty arrangement:</OuterP>
                  <Boxed>
                    <MathBlock>
                      $$ \begin&#123;gathered&#125; \cos^2(x) = &#123;1 +
                      \cos(2x) \over 2&#125;\\ \up&#123;2.1&#125;\sin^2(x) =
                      &#123;1 - \cos(2x) \over 2&#125; \\
            ...
            <Exercise number={56}>
              <ExerciseStatement id="_147_h.a.i_">
                ...
                <Pause />
                <OuterP>
                  Reasoning geometrically, what is this maximum value, and for
                  which value(s) of <Math>$x$</Math> is it achieved?
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>By the definition,</OuterP>
                <Pause />
                <MathBlock>$$ \cos x + \sin x $$</MathBlock>
                <Pause />
                <OuterP>
                  ...
                  We can represent the coordinates as two displacements
                  (changes), one in{" "}
                  <NoBreak>
                    <Math>$x$</Math>,
                  </NoBreak>{" "}
                ...
                <Pause />
                <OuterP>
                  The displacements can be summed geometrically by tipping the{" "}
                  <NoBreak>
                    “<Math>$\sin x$</Math>”
                  </NoBreak>{" "}
                  displacement to be horizontal on its side:
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/byhq.svg" />
                <Pause />
                <OuterP>For short:</OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/2Wso.svg" />
                <Pause />
                <OuterP>Some more examples (if need be):</OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/yFHg.svg" />
                <Pause />
                <OuterP>
                  Given this description, it seems obvious (or: it <i>is</i>{" "}
                  obvious) that the value of <Math>$x$</Math> that maximizes{" "}
                  <Math>$\cos x + \sin x$</Math> is{" "}
                  <NoBreak>
                    <Math>$x = \eta/2$</Math>,
                  </NoBreak>{" "}
                  to make the line that rains down at <Math>$-45^\circ$</Math>{" "}
                  tangent to the circle at the top right corner of the circle,
                  and for which{" "}
                  <NoBreak>
                    <Math>$\cos x + \sin x = \sqrt&#123;2&#125;$</Math>:
                  </NoBreak>
                </OuterP>
                <Pause />
                <Image src="/build-img/svgo-svg/xwF6.svg" />
                <Pause />
                <OuterP>(Individually, we have</OuterP>
                <Pause />
                <MathBlock>
                  $$ \,\cos(\eta/2)= \sqrt&#123;0.5&#125; = &#123;1 \over
                  \sqrt&#123;2&#125;&#125;, $$
                </MathBlock>
                <Pause />
                <MathBlock>
                  $$ \sin(\eta/2)=\sqrt&#123;0.5&#125; = &#123;1 \over
                  \sqrt&#123;2&#125;&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                ...
                <Pause />
                <CentralDisplayItalic>
                  any multiple of <Math>$4\eta$</Math> can be added
                </CentralDisplayItalic>
                <Pause />
                <OuterP>
                  [we don't need to say “or subtracted” because “multiple”
                  intimates “integer multiple”, which subsumes negative
                  multiples] to{" "}
                  <NoBreak>
                    <Math>$x = \eta/2$</Math>,
                  </NoBreak>{" "}
                  resulting in an infinite set of points at which the maximum is
                  achieved.
                </OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> A similar minimum of
                  </OuterP>
                  <Pause />
                  <MathBlock>$$ \large -\sqrt&#123;2&#125; $$</MathBlock>
                  <Pause />
                  <OuterP>occurs at the other end of the circle.</OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> Annotating the graph of{" "}
                    <Math>$x \ra \cos x + \sin x$</Math> with this new
                    information, in degrees and in radians:
                  </OuterP>
                  <Pause />
                  ...
                  <Pause />
                  <OuterP>
                    (Note that <Math>$45^\circ = 0.78539\ldots = \eta/2$</Math>{" "}
                    as a real number, the two graphs really express the same
                    thing. Also...
                  </OuterP>
                  <Pause />
                  <MathBlock>
                    $$ \Large \begin&#123;aligned&#125; &#123;\eta\over 2&#125;
                    + 180^\circ =&amp;\,\,\up&#123;1.5&#125; &#123;\eta\over
                    2&#125; + 2\eta\\ =&amp;\,\,\up&#123;1.5&#125;
                    &#123;\eta\over 2&#125; + &#123;4\eta\over 2&#125;\\
                    =&amp;\,\,\up&#123;1.5&#125; &#123;5\eta\over 2&#125;
                    \end&#123;aligned&#125; $$
                  </MathBlock>
                  <Pause />
                  <OuterP>
                    ...in case you haven't seen this kind of arithmetic before.)
                  </OuterP>
                </SolutionNote>
              </Solution>
            </Exercise>
            <Exercise number={57}>
              <ExerciseStatement id="_148_h.a.i_">
                <OuterP>
                  <b>Exercise 57.</b> A geometric interpretation of{" "}
                  ...
                  onto the <Math>$x$</Math> axis, as illustrated here:
                </OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  <Math>$x \ra \cos x + \sin x$</Math> as a function of the form
                </OuterP>
                <Pause />
                <MathBlock>$$ x \ra A\cdot\cos(Bx + C) + D $$</MathBlock>
                <Pause />
                <OuterP>
                  for some constants{" "}
                  <NoBreak>
                  ...
                  (Deduce the answer using geometry, and, if you have the heart,
                  verify using algebra.)
                </OuterP>
              </ExerciseStatement>
              <Solution>
                <OuterP>
                  Imagine a large ruler living below the <Math>$x$</Math> axis,
                ...
                <OuterP>
                  ...
                  <Math>$x$</Math> axis in the same place, but need only go from{" "}
                  <Math>$-\sqrt&#123;2&#125;$</Math> to{" "}
                  <NoBreak>
                    <Math>$\sqrt&#123;2&#125;$</Math>,
                  </NoBreak>{" "}
                  those being the minimum and maximum values of{" "}
                  <NoBreak>
                ...
                <OuterP>
                  ...
                  to recover the original “scale” of the horizontal ruler.
                  However, the value on the diagonal ruler is
                </OuterP>
                <Pause />
                <MathBlock>$$ \cos(x - \eta/2) $$</MathBlock>
                <Pause />
                <OuterP>
                  as one can see by rotating the entire diagram{" "}
                  <Math>$45^\circ$</Math> clockwise until that ruler aligns with
                  the <Math>$x$</Math> axis; therefore,
                </OuterP>
                <Boxed>
                  <MathBlock>
                ...
                <OuterP>
                  ...where you can think of the left-hand side of the equation
                  as the value on the original “big” horizontal ruler (from{" "}
                  <Math>$-\sqrt&#123;2&#125;$</Math> to{" "}
                  <NoBreak>
                    <Math>$\sqrt&#123;2&#125;$</Math>
                    ),
                  </NoBreak>{" "}
                  and the value on the right-hand side as the coordinate read
                  off of the “small diagonal ruler” re-normalized by the factor{" "}
                  <NoBreak>
                    <Math>$\sqrt&#123;2&#125;$</Math>.
                  </NoBreak>{" "}
                  Concretely,
                ...
                <Pause />
                <MathBlock>
                  $$ \begin&#123;gathered&#125; A = \sqrt&#123;2&#125;,\\ B =
                  \up&#123;1.3&#125;1,\\ C = \up&#123;1.3&#125;-\eta/2,\\ D =
                  \up&#123;1.3&#125;0, \end&#123;gathered&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                ...
                <OuterP class="indent-10">
                  Now for the ALGEBRAIC VERIFICATION that can accompany this
                  geometric observation, we use the angle-sum formula
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \cos(A + B) = \cos A\cos B - \sin A\sin B $$
                ...
                <Pause />
                <OuterP>for cosine, giving us...</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;aligned&#125; &amp;\,\, \sqrt&#123;2&#125;\cdot
                  \cos(x - \eta/2) \\ \up&#123;1.6&#125; =&amp;\,\,
                  ...
                  =&amp;\,\,
                  \sqrt&#123;2&#125;\cdot\sqrt&#123;0.5&#125;\cdot(\cos x + \sin
                  x) \\ \up&#123;1.6&#125; =&amp;\,\, \sqrt&#123;2 \cdot
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <OuterP>previously discussed.</OuterP>
                </SolutionNote>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 2.</i> If we admit
                  </OuterP>
                  <Pause />
                  <MathBlock>
                    $$ \cos(A - B) = \cos A\cos B + \sin A\sin B $$
                  ...
                  <Pause />
                  <OuterP>
                    (replace <Math>$B$</Math> by <Math>$-B$</Math> in the
                    angle-sum formula for cosine, and use the fact that{" "}
                    <NoBreak>
                      <Math>$\cos(-B) = \cos B$</Math>,
                    </NoBreak>{" "}
                    <Math>$\sin(-B) = -\sin B$</Math> for all{" "}
                    <NoBreak>
                      <Math>$B\in \rr$</Math>)
                    </NoBreak>{" "}
                    into the “roster of known formulas”, the algebraic proof
                    becomes...
                  </OuterP>
                  <Pause />
                  <MathBlock>
                ...
                <SolutionNote>
                  <OuterP>
                    <i>Note 3.</i> Note that the graph...
                  </OuterP>
                  <Pause />
                  <MathBlock>
                  ...
                  <Pause />
                  <OuterP>...as it is the graph of the composition...</OuterP>
                  <Pause />
                  ...
                  <Pause />
                  <CentralDisplayItalic>
                    1. translating horizontally by <Math>$\eta/2$</Math> to the
                    right
                  </CentralDisplayItalic>
                  <Pause />
                  <CentralDisplayItalic>
                    2. dilating vertically by <Math>$\sqrt&#123;2&#125;$</Math>
                  </CentralDisplayItalic>
                  <Pause />
                  <OuterP>
                  ...
                  <Pause />
                  <OuterP>
                    ...it certainly <i>looks like</i> this curve could be
                    obtained by translating the graph <Math>$y = \cos x$</Math>{" "}
                    horizontally by <Math>$\eta/2$</Math> and then scaling
                    vertically by{" "}
                    <NoBreak>
                      <Math>$\sqrt&#123;2&#125;$</Math>.
                    </NoBreak>{" "}
                    And it <i>looks</i> so because it <i>is</i> so! (We know
                    that, now, because we have proved that{" "}
                    <Math>
            ...
            <Exercise number={58}>
              <ExerciseStatement id="_149_h.a.i_">
                <OuterP>
                  <b>Exercise 58.</b> Show that for all{" "}
                  <Math>$A, B \in \rr$</Math> there exists{" "}
                  <NoBreak>
                    <Math>$W$</Math>,
                  </NoBreak>{" "}
                  <Math>$\psi \in \rr$</Math> such that
                </OuterP>
                <Pause />
                <MathBlock>
              ...
              <Solution>
                <OuterP>Starting from the desired endpoint, note that</OuterP>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <MathBlock>$$ W\cdot\cos(x - \psi) $$</MathBlock>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  where we suggestively group the terms to underscore that all
                  we need to do in order to “win” is to satisfy the equations
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;aligned&#125; A &amp;= W\cos\psi,\\ B &amp;=
                  \up&#123;1.5&#125;W\rt&#123;0.1&#125;\sin\psi\,
                  \end&#123;aligned&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                  and this can be done simply by setting{" "}
                  <Math>$(W, \psi)$</Math> to be the polar coordinates of the
                  cartesian point{" "}
                  <NoBreak>
                    <Math>$(A, B) \in \rr^2$</Math>!
                  </NoBreak>{" "}
                  I.e., put
                </OuterP>
                <Pause />
                <MathBlock>$$ W = \sqrt&#123;A^2 + B^2&#125; $$</MathBlock>
                <Pause />
                <OuterP>and...</OuterP>
                <Pause />
                <MathBlock>
                  $$ \psi = \begin&#123;cases&#125; \arctan(B/A)&amp;\te&#123;if
                  &#125;\, A \ne 0, \,\te&#123;else&#125; \\
                  \up&#123;1.2&#125;\te&#123;arccot&#125;(A/B) &amp;\te&#123;if
                  &#125;\, B \ne 0, \,\te&#123;else&#125; \\
                  \up&#123;1.2&#125;\rm&#123;anything&#125; &amp;\te&#123;if
                  &#125;\, A = 0, B = 0 \end&#123;cases&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                  ...where we copy-paste a formula from the chapter. (Or just{" "}
                  <span class="code-cartouche">psi = atan2(B, A)</span> if we
                  were writing python.*) (*Indeed,{" "}
                  <NoBreak>
                    “<Math>$\psi$</Math>”
                  </NoBreak>{" "}
                  is “psi”.)
            ...
            <Exercise number={59}>
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>but this is the special case</OuterP>
                <Pause />
                <MathBlock>$$ A = B = 1 $$</MathBlock>
                <Pause />
                <OuterP>
                  of{" "}
                  <InChapterLink
