  ...
  return (
    ...
    >
      ...
      <Section id="first-section">
        <OuterP>
          <b>Square roots.</b> Due to the fact that “minus times minus is plus”
          (the enemy of my enemy is my friend) and that “plus times plus is
          plus”, any nonzero number multiplied by itself is positive. For
          example,
        </OuterP>
        <Pause />
        <MathBlock>$$ (-2) \times (-2) = 4 $$</MathBlock>
        <Pause />
        <OuterP>is positive, while, of course,</OuterP>
        <Pause />
        <MathBlock>$$ 2 \times 2 = 4 $$</MathBlock>
        <Pause />
        <OuterP>
          is positive as well. But <Math>$\sqrt&#123;4&#125;$</Math> is, by
          definition, the unique <i>nonnegative</i> solution to{" "}
          <NoBreak>
            <Math>$x^2 = 4$</Math>.
          </NoBreak>{" "}
          Hence,
        ...
        <OuterP>
          ...
          where <Math>$|x|$</Math> denotes the absolute value of{" "}
          <NoBreak>
            <Math>$x$</Math>.
          </NoBreak>
        </OuterP>
        <OuterP class="indent-10">
          ...
          <Math>$x^2 = 4$</Math> you can always use the notation{" "}
          <NoBreak>
            “<Math>$\pm \sqrt&#123;4&#125;$</Math>
            ”.
          </NoBreak>{" "}
        ...
        <Pause />
        <OuterP>
          for the solutions to <Math>$x$</Math> to{" "}
          <NoBreak>
            <Math>$ax^2 + bx + c = 0$</Math>
            .)
          </NoBreak>
        </OuterP>
        <OuterP class="indent-10">We will next ponder the value of</OuterP>
        <Pause />
        <MathBlock>$$ \sqrt&#123;0.5&#125; $$</MathBlock>
        <Pause />
        <OuterP>
          which is, by definition, the unique nonnegative solution{" "}
          <Math>$x$</Math> to
        </OuterP>
        <Pause />
        ...
        <Pause />
        <OuterP>
          so <Math>$x = &#123;1\over 4&#125;$</Math> is not a solution of the
          equation, being apparently too small. Increasing <Math>$x$</Math> to{" "}
          <NoBreak>
        ...
        <Pause />
        <OuterP>
          which is better, since <Math>$1/4$</Math> is closer to{" "}
          <NoBreak>
            <Math>$1/2$</Math>,
          </NoBreak>{" "}
          but still too small. Increasing <Math>$x$</Math> by <Math>$1/4$</Math>{" "}
          again, say, to{" "}
          <NoBreak>
        ...
        <OuterP>
          ...
          <Math>$\sqrt&#123;0.5&#125;$</Math> must be a little <i>less</i> than{" "}
          <NoBreak>
        ...
        <OuterP>
          ...
          <Math>$\sqrt&#123;0.5&#125;$</Math> is <i>greater</i> than{" "}
          <Math>$0.5$</Math> is often perceived as counterintuitive.
        </OuterP>
        <OuterP class="indent-10">
          ...
          is like taking <Math>$70.71\%$</Math> of that value—for example, say,
        </OuterP>
        <Pause />
        <MathBlock>$$ 605 \cdot 0.7071 = 427.7955 $$</MathBlock>
        <Pause />
        <OuterP>
          is <Math>$70.71\%$</Math> of{" "}
          <NoBreak>
            <Math>$605$</Math>,
          </NoBreak>{" "}
          and so on—so if we multiply <i>twice</i> by <Math>$0.7071$</Math> we
          obtain{" "}
          <NoBreak>
            “<Math>$70.71\%$</Math>
          </NoBreak>{" "}
      ...
      {showMore() && (
        <>
          ...
          <Section id="section-1">
            <OuterP>
              <b>Fractions and Division.</b> An elementary fraction, or
              division, such as
            </OuterP>
            <Pause />
            <MathBlock>$$ &#123;50 \over 2&#125; $$</MathBlock>
            <Pause />
            <OuterP>can be thought of in a few different ways:</OuterP>
            <Pause />
            <List marker="decimal" style="gap:2px;">
              <Item>
                <p>
                  Fifty halves (i.e.,{" "}
                  <NoBreak>
              ...
              <Item>
                <p>
                  The size obtained when something of size fifty is divided into
                  two equal parts (answer:{" "}
                  <NoBreak>
                    <Math>$25$</Math>
                    ).
                  </NoBreak>
              ...
              <Item>
                <p>
                  The number of times that <Math>$2$</Math> goes into{" "}
                  <Math>$50$</Math> (answer:{" "}
                  <NoBreak>
                    <Math>$25$</Math>,
                  </NoBreak>{" "}
            ...
            <Pause />
            <OuterP>
              But <Math>$50/2$</Math> is a ratio of integers, and for a ratio of
            ...
            <OuterP>
              ...
              Thankfully, though, we can still characterize this fraction as the
              answer to the question “how many times does <Math>$0.01$</Math> go
              into{" "}
              <NoBreak>
                <Math>$1$</Math>
                ?”,
              </NoBreak>{" "}
              as in the third option above—from which,
            </OuterP>
            <Pause />
            <MathBlock>$$ &#123;1 \over 0.01&#125; \,=\,100 $$</MathBlock>
            <Pause />
            <OuterP>
              because <Math>$0.01$</Math> goes <Math>$100$</Math> times into{" "}
              <NoBreak>
                <Math>$1$</Math>.
              </NoBreak>{" "}
              For that matter,
            ...
            <Pause />
            <MathBlock>
              $$ &#123; 1 \over 0.001&#125; = 1000,\qquad&#123;1 \over
              0.0001&#125; = 10000,\quad\,\,\,\,\textrm&#123;(etc)&#125; $$
            </MathBlock>
            <Pause />
            <OuterP>
              by the same reasoning, which explains why dividing by smaller and
              smaller numbers produces larger and larger results. (Also, why
              dividing by <Math>$0$</Math> is undefined.)
            </OuterP>
            <Pause />
            <OuterP>
            ...
            <Pause />
            <MathBlock>
              $$ &#123;1.42 \over 0.8&#125; = &#123;100 \cdot 1.42 \over 100
              \cdot 0.8&#125; = &#123;142 \over 80&#125; = &#123;71 \over
              40&#125;. $$
            </MathBlock>
            <Pause />
            <OuterP>
              This example was chosen randomly, and, if you allow, we would like
              to see how large <Math>$71/40$</Math> really is (one second!):
            </OuterP>
            <Pause />
            <MathBlock>
              $$ \begin&#123;align&#125; &#123;71 \over 40&#125; \,&amp;=\,
              &#123;40 + 30 + 1 \over 40&#125; \,=\, &#123;40 \over 40&#125; +
              &#123;30 \over 40&#125; + &#123;1 \over 40&#125;\\ \,&amp;=\, 1 +
              &#123;3 \over 4&#125; + &#123;1 \over 4&#125;\!\cdot \!&#123;1
              \over 10&#125;\up&#123;1.5&#125;\\ \,&amp;=\, 1 + 0.75 + 0.025 =
              1.775\up&#123;1.5&#125; \end&#123;align&#125; $$
            </MathBlock>
            <Pause />
            <OuterP>
              ...so we find, among others, that <Math>$71$</Math> is exactly{" "}
              <Math>$77.5\%$</Math> greater than{" "}
              <NoBreak>
                <Math>$40$</Math>.
              </NoBreak>{" "}
              (Check yourself: <Math>$70$</Math> is <Math>$75\%$</Math> greater
              than{" "}
              <NoBreak>
                <Math>$40$</Math>
                .)
          ...
          <Section id="section-2">
            ...
            <Pause />
            <OuterP>(five times twelve equals fifty plus ten), or</OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>we really mean</OuterP>
            <Pause />
            <MathBlock>$$ (5\!\cdot\!10) + (5\!\cdot\!2) $$</MathBlock>
            <Pause />
            <OuterP>as opposed to something else, such as</OuterP>
            <Pause />
            <MathBlock>$$ ((5\!\cdot\!10) + 5)\!\cdot\! 2, $$</MathBlock>
            <Pause />
            <OuterP>
              because multiplication takes precedence over addition, absent
              parentheses.)
            </OuterP>
            <OuterP class="indent-10">
            ...
            <Pause />
            <OuterP>
              that come from multiplying every term of the first parenthesis
              with every term of the second parenthesis. Indeed,
            </OuterP>
            <Pause />
            <MathBlock>$$ (a + b)(C + D) = (a + b)C + (a + b)D $$</MathBlock>
            <Pause />
            <OuterP>by one application of distributivity, while</OuterP>
            <Pause />
            <MathBlock>$$ (a + b)C = aC + bC $$</MathBlock>
            <Pause />
            <MathBlock>$$ (a + b)D = aD + bD $$</MathBlock>
            <Pause />
            <OuterP>by distributivity again.</OuterP>
            <Pause />
            <Example>
              <OuterP>
              ...
              <Pause />
              <MathBlock>
                $$ \begin&#123;aligned&#125; (10 + 2)(10 + 4) \,&amp;=\,
                10\!\cdot\!10 \,+\, 10\!\cdot\!4 \,+\, 2\!\cdot\!10 \,+\,
                2\!\cdot\!4 \\ \,&amp;=\, 100 \,+\, 40 \,+\, 20 \,+\, 8
                \up&#123;1.1&#125;\\ \,&amp;=\, 168 \up&#123;1.1&#125;
                \end&#123;aligned&#125; $$
              </MathBlock>
              <Pause />
            ...
            <Example id="_21_h.a.i_">
              ...
              <Pause />
              <MathBlock>
                $$ \begin&#123;align&#125; (10 + 3)(10 + 3) \,&amp;=\,
                10\!\cdot\!10 \,+\, 10\!\cdot\!3 \,+\, 3\!\cdot\!10 \,+\,
                3\!\cdot\!3\\ \,&amp;=\, 100 \,+\, 30 \,+\, 30 \,+\, 9
                \up&#123;1.1&#125;\\ \,&amp;=\, 169 \up&#123;1.1&#125;
                \end&#123;align&#125; $$
              </MathBlock>
              <Pause />
            ...
            <Pause />
            <OuterP>
              (The fact that <Math>$13 \times 13$</Math> is exactly one greater
              than <Math>$12 \times 14$</Math> is a bit curious indeed.)
            </OuterP>
            <OuterP class="indent-10">
            ...
            <Example>
              ...
              <MathBlock>
                ...
                \,&amp;=\, 10\!\cdot\!10 \,+\, 2\!\cdot\!3\!\cdot\!10 \,+\,
                3\!\cdot\!3 \\ \up&#123;1&#125; \,&amp;=\, 100 + 60 + 9
                \up&#123;1.1&#125;\\ \up&#123;1&#125; \,&amp;=\, 169
                \up&#123;1.1&#125; \end&#123;align&#125; $$
              </MathBlock>
              <Pause />
            ...
            <OuterP>
              ...
              that is.) (NB: “Factored” means “written as a product”.)
            </OuterP>
            <Pause />
            <Example>
              <OuterP>
              ...
              <Pause />
              <OuterP>
                is a difference of squares, <Math>$19$</Math> can be factored.
                (On the other hand <Math>$19$</Math> is a prime number, but
                nevermind.)
              </OuterP>
            </Example>
            <Pause />
            <Example>
              <OuterP>
                <b>Example 5.</b> The expression
              </OuterP>
              <Pause />
              <MathBlock>$$ 1 - x^2 $$</MathBlock>
              <Pause />
              <OuterP>can be factored, because</OuterP>
              <Pause />
              <MathBlock>$$ 1 = 1^2 $$</MathBlock>
              <Pause />
              <OuterP>implies that</OuterP>
              <Pause />
              <MathBlock>$$ 1 - x^2 $$</MathBlock>
              <Pause />
              <OuterP>truly is “a difference of squares”. And, indeed,</OuterP>
              <Pause />
            ...
            <Pause />
            <OuterP>
              In relation to distributivity, we should also mention the simple
              but important fact that multiplying a difference by{" "}
              <Math>$-1$</Math> <i>reverses</i> the difference. That is,
            </OuterP>
            <Pause />
            <MathBlock>$$ (-1)(a - b) \,=\, b - a $$</MathBlock>
            <Pause />
            <OuterP>or, for short,</OuterP>
            <Pause />
            <MathBlock>$$ -(a - b) \,=\, b - a $$</MathBlock>
            <Pause />
            <OuterP>because, indeed,</OuterP>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <OuterP>by distributivity (used in the second step).</OuterP>
            <Pause />
            <Example>
              <OuterP>
          ...
          <Section id="section-3">
            ...
            <Pause />
            <OuterP>...? Well if you observe, additionally, that</OuterP>
            <Pause />
            <MathBlock>
              $$ \begin&#123;align&#125; 11\,\cdot\,13 &amp;= 12^2 - 1\\
              10\,\cdot\,12 &amp;= 11^2 - 1 \up&#123;1.1&#125;\\ 9\,\cdot\,11
              &amp;= 10^2 - 1 \up&#123;1.1&#125; \end&#123;align&#125; $$
            </MathBlock>
            <Pause />
            <OuterP>
            ...
            <Pause />
            <OuterP>
              for <i>every</i> real number <Math>$n$</Math> because of the
              formula
            </OuterP>
            <Pause />
            <MathBlock>$$ (a - b)(a + b) \,=\, a^2 - b^2 $$</MathBlock>
            <Pause />
            <OuterP>for a difference of squares!</OuterP>
          </Section>
          <Pause />
          <Section id="section-4">
            ...
            <Pause />
            <OuterP>is a conjugate pair, as is</OuterP>
            <Pause />
            <MathBlock>
          ...
          <Pause />
          <Exercises at_end_of_page={true} show_curlicue={true} id="_24_h.a.i_">
            <Exercise number={1}>
              <ExerciseStatement id="_22_h.a.i_">
                ...
                >
                  ...
                  <Item>
                    f. <Math>$2^&#123;30&#125; &gt; 1000^3$</Math>
                  </Item>
                  <Item>
                    g. <Math>$&#123;1 \over 0.95&#125; &gt; 1.05$</Math>
                  </Item>
                  <Item>
                    h. <Math>$(-1)^&#123;101&#125; = -1$</Math>
                  </Item>
              ...
              <Solution>
                <OuterP>Part by part:</OuterP>
                <Pause />
                <OuterP>a. (True) We have</OuterP>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <OuterP>
                  and <Math>$0.1$</Math> is nonnegative, so{" "}
                  <NoBreak>
                ...
                <OuterP class="indent-10">
                  Technically, however, a number <Math>$x$</Math> such that
                </OuterP>
                <Pause />
                ...
                <OuterP class="indent-10">
                  ...
                  are both <i>nonnegative</i> numbers (taken as obvious), and
                  which implies that they are the <i>unique nonnegative</i>{" "}
                  solution to{" "}
                  <NoBreak>
                    <Math>$x^6 = 2$</Math>.
                  </NoBreak>
                ...
                <Pause />
                <OuterP>d. (True) In general,</OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;\sqrt&#123;x&#125; \over \sqrt&#123;y&#125;&#125; =
                ...
                <OuterP>
                  ...
                  <Math>$y &gt; 0$</Math> (you need each root to be defined), so
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;\sqrt&#123;2&#125; \over 2&#125; =
                ...
                <OuterP>
                  ...
                  <Math>$&#123;\sqrt&#123;2&#125; \over 2&#125;$</Math> is not
                  negative, establishes that{" "}
                  <NoBreak>
                    <Math>
                      $&#123;\sqrt&#123;2&#125; \over 2&#125; =
                      \sqrt&#123;0.5&#125;$
                ...
                <Pause />
                <OuterP>Or by direct verification:</OuterP>
                <Pause />
                <MathBlock>
                  $$ \left(&#123;1 \over
                  \sqrt&#123;2&#125;&#125;\right)^&#123;\!2&#125; = &#123;1
                  \over \sqrt&#123;2&#125;&#125;\cdot&#123;1 \over
                  \sqrt&#123;2&#125;&#125; = &#123;1 \over
                ...
                <Pause />
                <OuterP>
                  (And <Math>$1 \over \sqrt&#123;2&#125;$</Math> is
                  nonnegative.) Or by reducing to part d:
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;1 \over \sqrt&#123;2&#125;&#125; =
                ...
                <Pause />
                <OuterP>
                  <i>Note 2.</i> The first ten or so powers of <Math>$2$</Math>{" "}
                ...
                <MathBlock>
                  $$ \begin&#123;array&#125;&#123;c|c&#125; \,\,\,\,n\,\,\,\,
                  &amp; 2^n\dn&#123;0.3&#125; \\ \hline 0 &amp; 1
                  \up&#123;1.1&#125;\\ 1 &amp; 2 \\ 2 &amp; 4 \\ 3 &amp; 8 \\ 4
                  &amp; 16 \\ 5 &amp; 32 \\ 6 &amp; 64 \\ 7 &amp; 128 \\ 8 &amp;
                  256 \\ 9 &amp; 512 \\ 10 &amp; 1024 \end&#123;array&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>Among which, the fact that</OuterP>
                <Pause />
                <MathBlock>$$ 2^&#123;10&#125; \approx 10^3 $$</MathBlock>
                <Pause />
                <OuterP>
                  can be particularly useful to know! For example, if a
                  1-millimeter-thick napkin is folded <Math>$50$</Math> times
                  over, doubling the width each time, one obtains something of
                  thickness
                </OuterP>
                <Pause />
                <MathBlock>
                ...
                <Pause />
                <OuterP>
                  or <i>one billion</i> kilometers. By comparison, the distance
                  from the Earth to the Sun is a mere <Math>$150$</Math> million
                  kilometers. (The point being: that we could go from the
                ...
                <Pause />
                <OuterP>to the relatively less mysterious</OuterP>
                <Pause />
                <MathBlock>
                  $$
                  \te&#123;“&#125;\fw10^&#123;15&#125;\te&#123;mm&#125;\te&#123;”&#125;
                ...
                <Pause />
                <OuterP>
                  g. (True) As an inequality can be multiplied on both sides by
                  a positive number while preserving the inequality, one has
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align&#125; &amp; &#123;1 \over 0.95&#125; &gt;
                  1.05\\ \iff &amp; 1 &gt; 1.05 \cdot 0.95\up&#123;1.4&#125;\\
                ...
                <OuterP>
                  ...
                  the number <Math>$1 + \epsilon$</Math> remains a good
                  approximation to{" "}
                  <NoBreak>
                ...
                <Pause />
                <OuterP>is a good approximation to</OuterP>
                <Pause />
                <MathBlock>$$ &#123;1 \over 0.99&#125; $$</MathBlock>
                <Pause />
                <OuterP>while</OuterP>
                ...
                <Pause />
                <OuterP>
                  h. (True) Here are the first few powers of <Math>$-1$</Math>{" "}
                  (note how each additional multiplication by <Math>$-1$</Math>{" "}
                ...
                <Pause />
                <OuterP>
                  (Etc.) Obviously, even powers of <Math>$(-1)$</Math> are equal
                  to{" "}
                  <NoBreak>
                    <Math>$1$</Math>,
                  </NoBreak>{" "}
                  while odd powers of <Math>$(-1)$</Math> are equal to{" "}
                  <NoBreak>
                    <Math>$-1$</Math>.
                  </NoBreak>{" "}
                  As <Math>$101$</Math> is odd,{" "}
                  <Math>$(-1)^&#123;101&#125;$</Math> is{" "}
                  <NoBreak>
                    <Math>$-1$</Math>.
                  </NoBreak>
                ...
                <OuterP>
                  ...
                  <Math>$x = 0$</Math> on the number line. This hare runs
                  forward by one unit and backwards by half a unit, stopping at
                  the number
                </OuterP>
                <Pause />
                ...
                <Pause />
                <OuterP>
                  by virtue of this back-and-forth movement. The hare then
                  proceeds to run forward by <i>half</i> a unit and back by a{" "}
                  <i>third</i> of a unit, stopping at
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align&#125; &amp;\, \left(1 - &#123;1 \over
                  2&#125;\right) \\ + \,&amp;\, \left(&#123;1 \over 2&#125; -
                  &#123;1 \over 3&#125;\right) \\ \hline = \,&amp;\, \left(1 -
                  &#123;1 \over 3&#125;\right) \end&#123;align&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                  for another break. Keeping with this pattern, the hare then
                  stops at
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align&#125; &amp;\, \left(1 - &#123;1 \over
                  2&#125;\right)\\ + \,&amp;\, \left(&#123;1 \over 2&#125; -
                  &#123;1 \over 3&#125;\right)\\ + \,&amp;\, \left(&#123;1 \over
                  3&#125; - &#123;1 \over 4&#125;\right)\\ \hline = \,&amp;\,
                  \left(1 - &#123;1 \over 4&#125;\right) \end&#123;align&#125;
                  $$
                </MathBlock>
                <Pause />
                <OuterP>and then at</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align&#125; &amp;\, \left(1 - &#123;1 \over
                  2&#125;\right)\\ + \,&amp;\, \left(&#123;1 \over 2&#125; -
                  ...
                  \hline = \,&amp;\, \left(1 - &#123;1 \over 5&#125;\right)
                  \end&#123;align&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>
                  and so on. Clearly, the successive positions at which the hare
                  stops are approaching the number <Math>$1$</Math> from the
                  left, pointing to the fact that the <i>infinite</i> sum
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align&#125; &amp;\, \left(1 - &#123;1 \over
                  ...
                  3&#125; - &#123;1 \over 4&#125;\right)\\ + \,&amp;\,
                  \left(&#123;1 \over 4&#125; - &#123;1 \over 5&#125;\right)\\ +
                  \,&amp;\, \left(&#123;1 \over 5&#125; - &#123;1 \over
                  6&#125;\right)\\ + \,&amp;\, \left(&#123;1 \over 6&#125; -
                  &#123;1 \over 7&#125;\right)\\ + \,&amp;\,
                ...
                <OuterP>
                  ...
                  which is how we came to be reminded of this infinite sum in
                  the first place.) Well...
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align&#125; &#123;1 \over n&#125; - &#123;1
                  \over n+1&#125; &amp;= &#123;1 \over n&#125;\cdot&#123;n+1
                  \over n+1&#125;\, - \, &#123;1 \over n+1&#125;\cdot&#123;n
                  \over n&#125;\up&#123;1.5&#125;\\ &amp;= &#123;n+1 \over
                  n(n+1)&#125; - &#123;n \over n(n+1)&#125;\up&#123;1.5&#125;\\
                  &amp;= &#123;1 \over n(n+1)&#125;\up&#123;1.5&#125;
                  \end&#123;align&#125; $$
                  <ImageRight
                ...
                <Pause />
                <OuterP>...it's that much. (For example,</OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;1 \over 1&#125; - &#123;1 \over 2&#125; = &#123;1
                  \over 1 \cdot 2&#125; = &#123;1 \over 2&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>and</OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;1 \over 2&#125; - &#123;1 \over 3&#125; = &#123;1
                  \over 2 \cdot 3&#125; = &#123;1 \over 6&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>and so on.) So the infinite sum</OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align&#125; &amp;\, \left(1 - &#123;1 \over
                  2&#125;\right)\\ + \,&amp;\, \left(&#123;1 \over 2&#125; -
                  ...
                  &#123;1 \over 7&#125;\right)\\ + \,&amp;\,
                  \,\,\,\,\,\,\,\,\dots\up&#123;1.3&#125;\dn&#123;1&#125;\\
                  \hline = \,&amp;\, 1\up&#123;1.5&#125; \end&#123;align&#125;
                  $$
                </MathBlock>
                <Pause />
                <OuterP>can also be written</OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;1 \over 1 \cdot 2&#125; + &#123;1 \over 2 \cdot
                  3&#125; + &#123;1 \over 3 \cdot 4&#125; + &#123;1 \over 4
                  \cdot 5&#125; + &#123;1 \over 5 \cdot 6&#125; + \dots \,=\, 1
                  $$
                </MathBlock>
                <Pause />
                <OuterP>(or</OuterP>
                ...
                <MathBlock>
                  $$ &#123;1 \over 2&#125; + &#123;1 \over 6&#125; + &#123;1
                  \over 12&#125; + &#123;1 \over 20&#125; + &#123;1 \over
                  30&#125; + \dots \,=\, 1 $$
                </MathBlock>
                <Pause />
                <OuterP>
                  equivalently) which is not obvious at first glance, and kind
                  of interesting!
                </OuterP>
                <Pause />
                <OuterP>
                ...
                <OuterP>
                  ...
                  is roughly <Math>$&#123;1 \over n^2&#125;$</Math> for large{" "}
                  <NoBreak>
                    <Math>$n$</Math>,
                  </NoBreak>{" "}
            ...
            <Exercise number={2}>
              <ExerciseStatement id="_23_h.a.i_">
                ...
                <Pause />
                <OuterP>
                  is <i>roughly</i> <Math>$1/n^2$</Math> for large{" "}
                  <NoBreak>
                    <Math>$n$</Math>.
                  </NoBreak>{" "}
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>(as previously computed) is smaller than</OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;1 \over n^2&#125; $$
                  <ImageRight
                ...
                <Pause />
                <OuterP>we will compute the difference</OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;1 \over n^2&#125; - &#123;1 \over n(n+1)&#125; $$
                </MathBlock>
                <Pause />
                <OuterP>as opposed to the “other” difference</OuterP>
                <Pause />
                <MathBlock>
                ...
                <OuterP>
                  ...
                  difference and having a minus sign does not constitute a
                  mistake, however.) Having said this, the difference is:
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \begin&#123;align&#125; &#123;1 \over n^2&#125; - &#123;1
                  \over n(n+1)&#125; &amp;= &#123;1 \over n^2&#125; \cdot
                  &#123;n+1 \over n+1&#125; - &#123;1 \over n(n+1)&#125; \cdot
                  &#123;n \over n&#125;\\ &amp;= &#123;n+1 \over n^2(n+1)&#125;
                  - &#123;n \over n^2(n+1)&#125;\up&#123;1.5&#125;\\ &amp;=
                ...
                <Pause />
                <OuterP>
                  since <Math>$n^2(n+1) \approx n^3$</Math> for large{" "}
                  <NoBreak>
                    <Math>$n$</Math>.
                  </NoBreak>
                </OuterP>
                ...
                <OuterP>
                  ...
                  but <Math>$1/100$</Math> is bigger than the actual value of{" "}
                  <Math>
