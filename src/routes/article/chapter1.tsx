      ...
      {showMore() && (
        <>
          ...
          <Section>
            ...
            <Pause />
            <VerticalChunk>
              so <Math>$x = &#123;1\over 4&#125;$</Math> is not a solution of
              the equation, being apparently too small. Increasing{" "}
              <Math>$x$</Math> to{" "}
              <NoBreak>
            ...
            <VerticalChunk>
              ...
              and so on—so if we multiply <i>twice</i> by <Math>$0.7071$</Math>{" "}
              we obtain{" "}
              <NoBreak>
                “<Math>$70.71\%$</Math>
              </NoBreak>{" "}
          ...
          <Exercises>
            ...
            <Exercise exercise_number={2}>
              <VerticalChunk>
                <b>Exercise 2.</b> In the solution to Exercise 1, we observed
                how the difference
              </VerticalChunk>
              <Pause />
              <MathBlock>
