  ...
  return (
    <>
      <Chapter number={1} title="A Few Refreshers">
        <a class="next_page" href="/article/chapter2" />
        ...
        <Section>
          <VerticalChunk>
            ...
            plus” and that “plus times plus is plus”. (Why? The enemy of my
            enemy is my friend.) So any nonzero number multiplied by itself is
          ...
          <VerticalChunk>
            ...
            Hence—at possible <i>contrario</i> to murky half-baked thoughts of
            yesteryear—
          </VerticalChunk>
          <Pause />
          <MathBlock>
          ...
          <VerticalChunk indent={true}>We will next ponder</VerticalChunk>
          <Pause />
          ...
          <Pause />
          <VerticalChunk>
            As beginners, there's nothing wrong with trying to solve this
            equation by trial and error. With{" "}
            <NoBreak>
          ...
          <VerticalChunk>
            ...
            but still too small. Increasing <Math>$x$</Math> by{" "}
            <Math>$1/4$</Math> again, say, to{" "}
            <NoBreak>
          ...
          <VerticalChunk>
            ...
            <Math>$\sqrt&#123;0.5&#125;$</Math> must be a little <i>less</i>{" "}
            than{" "}
            <NoBreak>
          ...
          <VerticalChunk indent={true}>
            ...
            is like taking <Math>$70.71\%$</Math> of that value—for example,
            say,
          </VerticalChunk>
          <Pause />
        ...
        <>
          ...
          <Section>
            ...
            <MathBlock>
              ...
              + 30 + 1 \over 40&#125; \,=\, &#123;40 \over 40&#125; + &#123;30
              \over 40&#125; + &#123;1 \over 40&#125;\\ \,&=\, 1 + &#123;3 \over
              4&#125; + &#123;1 \over 4&#125;\!\cdot \!&#123;1 \over
          ...
          <Section>
            ...
            <Example>
              ...
              <MathBlock>
                ...
                \,+\, 10\!\cdot\!4 \,+\, 2\!\cdot\!10 \,+\, 2\!\cdot\!4\\ \,&=\,
                100 \,+\, 40 \,+\, 20 \,+\, 8\\ \,&=\, 168 \end&#123;align&#125;
                $$
              </MathBlock>
              <Pause />
              <VerticalChunk>
            ...
            <Example>
              ...
              <MathBlock>
                ...
                \,+\, 10\!\cdot\!3 \,+\, 3\!\cdot\!10 \,+\, 3\!\cdot\!3\\ \,&=\,
                100 \,+\, 30 \,+\, 30 \,+\, 9\\ \,&=\, 169 \end&#123;align&#125;
                $$
              </MathBlock>
              <Pause />
              <VerticalChunk>
          ...
          <Exercises>
            <Exercise exercise_number={1}>
              ...
              <Solution solution_number={1}>
                ...
                <MathBlock>
                  $$ \begin&#123;array&#125;&#123;c|c&#125; \,\,\,\,n\,\,\,\, &
                  2^n\dn&#123;0.3&#125; \\ \hline 0 & 1 \up&#123;1.1&#125;\\ 1 &
                  2 \\ 2 & 4 \\ 3 & 8 \\ 4 & 16 \\ 5 & 32 \\ 6 & 64 \\ 7 & 128
                  \\ 8 & 256 \\ 9 & 512 \\ 10 & 1024 \end&#123;array&#125; $$
                </MathBlock>
                <Pause />
                ...
                <MathBlock>
                  ...
                  1.05\\ \iff & 1 &gt; 1.05 \cdot 0.95\up&#123;1.4&#125;\\ \iff
                  & 1 &gt; (1 + 0.05)(1 - 0.05)\up&#123;1.4&#125;\\ \iff & 1
                  &gt; 1 - 0.05^2\up&#123;1.4&#125; \end&#123;align&#125; $$
                </MathBlock>
                <Pause />
                <VerticalChunk>
                  (using the fact that{" "}
                ...
                <MathBlock>
                  ...
                  &#123;1 \over 4&#125;\right)\\ \hline = \,&\, \left(1 -
                  &#123;1 \over 4&#125;\right) \end&#123;align&#125; $$
                </MathBlock>
                <Pause />
                ...
                <MathBlock>
                  ...
                  2&#125;\right)\\ + \,&\, \left(&#123;1 \over 2&#125; - &#123;1
                  \over 3&#125;\right)\\ + \,&\, \left(&#123;1 \over 3&#125; -
                  &#123;1 \over 4&#125;\right)\\ + \,&\, \left(&#123;1 \over
                  4&#125; - &#123;1 \over 5&#125;\right)\\ \hline = \,&\,
                  \left(1 - &#123;1 \over 5&#125;\right) \end&#123;align&#125;
                  $$
                </MathBlock>
                <Pause />
                <VerticalChunk>
                ...
                <MathBlock>
                  ...
                  \over 3&#125;\right)\\ + \,&\, \left(&#123;1 \over 3&#125; -
                  &#123;1 \over 4&#125;\right)\\ + \,&\, \left(&#123;1 \over
                  4&#125; - &#123;1 \over 5&#125;\right)\\ + \,&\, \left(&#123;1
                  \over 5&#125; - &#123;1 \over 6&#125;\right)\\ + \,&\,
                ...
                <MathBlock>
                  ...
                  \over n+1&#125; &= &#123;1 \over n&#125;\cdot&#123;n+1 \over
                  n+1&#125;\, - \, &#123;1 \over n+1&#125;\cdot&#123;n \over
                  n&#125;\up&#123;1.5&#125;\\ &= &#123;n+1 \over n(n+1)&#125; -
                  &#123;n \over n(n+1)&#125;\up&#123;1.5&#125;\\ &= &#123;1
                  \over n(n+1)&#125;\up&#123;1.5&#125; \end&#123;align&#125; $$
                  <ImageRight
                    offset_y="-0.5em"
            ...
            <Exercise exercise_number={2}>
              <ExerciseStatement>
                <VerticalChunk>
                  <b>Exercise 2.</b> In the solution to Exercise{" "}
              ...
              <Solution solution_number={2}>
                ...
                <MathBlock>
                  ...
                  \over n(n+1)&#125; &= &#123;1 \over n^2&#125; \cdot &#123;n+1
                  \over n+1&#125; - &#123;1 \over n(n+1)&#125; \cdot &#123;n
                  \over n&#125;\\ &= &#123;n+1 \over n^2(n+1)&#125; - &#123;n
                  \over n^2(n+1)&#125;\up&#123;1.5&#125;\\ &= &#123;1 \over
