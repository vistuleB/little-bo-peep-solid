      ...
      <Section id="section-11">
        ...
        <OuterP>
          ...
          <span style="color:red;background-color:yellow;">
            undefined handle at chapter4.wly:781:5: {" "}
            <i>
              factory
            </i>
            roof
          ...
          {" "} of Chapter {" "}
          <span style="color:red;background-color:yellow;">
            undefined handle at chapter4.wly:781:5: functions
          </span>
          , with
          the little circle {" "}
          <NoBreak>
        ...
        <OuterP>
          ...
          <span style="color:red;background-color:yellow;">
            undefined handle at chapter4.wly:795:5: {" "}
            <i>
              function
            </i>
            operations
          ...
          of Chapter {" "}
          <span style="color:red;background-color:yellow;">
            undefined handle at chapter4.wly:796:5: functions
          </span>
        ...
        <Exercise number={14}>
          <ExerciseStatement id="_15_hgi_">
            <OuterP>
              ...
              {" "}
              <InChapterLink
                href="/article/chapter1#_13_hgi_"
                class="handle-in-chapter-link"
              >
                Exercise 13
              </InChapterLink>
        ...
        <Exercise number={16}>
          ...
          <Solution>
            <OuterP>
              ...
              <NoBreak>
                <InChapterLink
                  href="/article/chapter1#_17_hgi_"
                  class="handle-in-chapter-link"
                >
                  Note 1
                </InChapterLink>
        ...
        <Exercise number={20}>
          <ExerciseStatement id="_23_hgi_">
            <OuterP>
              ...
              in Chapter {" "}
              <span style="color:red;background-color:yellow;">
                undefined handle at chapter4^exercises/
                <i>
                  eta
                </i>
                approximation
            ...
            <SolutionNote>
              ...
              <OuterP>
                ...
                <span style="color:red;background-color:yellow;">
                  ...
                  multiplication_.wly:130:13: functions
                </span>
                .
              </OuterP>
            </SolutionNote>
