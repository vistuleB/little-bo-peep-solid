    ...
    {showMore() && <>
      ...
      <Section id="section-2">
        ...
        <VerticalChunk>
          ...
          Moreover, (
          <InChapterLink
            href="/article/bootcamp2?id=_1_3070"
        ...
        <VerticalChunk>
          ...
          in (
          <InChapterLink
            href="/article/bootcamp2?id=_2_9222"
            class="handle-in-chapter-link">
            AA
          </InChapterLink>
        ...
        <Exercise number={15}>
          ...
          <Solution>
            <VerticalChunk>
              ...
              {" "}(as in{" "}
              <InChapterLink
                href="/article/bootcamp2?id=_3_1697"
                class="handle-in-chapter-link">
                Exercise 14
              </InChapterLink>
              ):
