    ...
    { showMore() && <>
      ...
      <Section id="section-2">
        ...
        <VerticalChunk>
          ...
          Moreover, (
          <InChapterLink
            href="/article/bootcamp2?id=_1210729450"
        ...
        <VerticalChunk>
          ...
          in (
          <InChapterLink
            href="/article/bootcamp2?id=_5166904692"
            class="handle-in-chapter-link">
            AA
          </InChapterLink>
      ...
      <Exercises>
        ...
        <Exercise exercise_number={14}>
          <ExerciseStatement id="_608711471776">
            <VerticalChunk>
              <b>
                Exercise 14.
              </b>
        ...
        <Exercise exercise_number={15}>
          ...
          <Solution solution_number={15}>
            <VerticalChunk>
              ...
              {" "}(as in{" "}
              <InChapterLink
                href="/article/bootcamp2?id=_608711471776"
                class="handle-in-chapter-link">
                Exercise 14
              </InChapterLink>
              ):
