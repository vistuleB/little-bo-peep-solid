    ...
    { showMore() && <>
      ...
      <Section id="section-2">
        ...
        <VerticalChunk>
          ...
          Moreover, (
          <InChapterLink
            href="/article/bootcamp2?id=_6009723231"
        ...
        <VerticalChunk>
          ...
          in (
          <InChapterLink
            href="/article/bootcamp2?id=_8013902053"
            class="handle-in-chapter-link">
            AA
          </InChapterLink>
      ...
      <Exercises>
        ...
        <Exercise exercise_number={14}>
          <ExerciseStatement id="_300511478907">
            <VerticalChunk>
              <b>
                Exercise 14.
              </b>
        ...
        <Exercise exercise_number={15}>
          ...
          <Solution solution_number={15}>
            <VerticalChunk>
              ...
              {" "}(as in{" "}
              <InChapterLink
                href="/article/bootcamp2?id=_300511478907"
                class="handle-in-chapter-link">
                Exercise 14
              </InChapterLink>
              ):
