  ...
  return <>
    {showMore() && <>
      ...
      <Section id="section-5">
        ...
        <Image
          width="377.288px"
          src="/images/svg_ch3_ch_vx1178A_@0_with_cors.svg" />
        <Pause />
        <OuterP>
          <NoBreak>
            ...
        ...
        <Image
          width="377.288px"
          src="/images/svg_ch3_ch_vx1178A_@1_with_cors.svg" />
        <Pause />
        <OuterP>
          <NoBreak>
            ...
        ...
        <Example>
          ...
          <Image
            width="520.0px"
            src="/images/svg_ch3_ch_x_squared_1.svg" />
          <Pause />
          <OuterP>
          ...
          <Image
            width="520.0px"
            src="/images/svg_ch3_ch_x_squared_2.svg" />
          <Pause />
          <OuterP>
      ...
      <Section id="section-8">
        ...
        <Image
          width="365.0px"
          src="/images/svg_ch3_ch_wiggle_graph.svg" />
        <Pause />
        <OuterP>
        ...
        <Image
          width="330.0px"
          src="/images/svg_ch3_ch_circle.svg">
          <ImageRight
            width="400.0px"
        ...
        <Example>
          ...
          <Image
            width="410.0px"
            src="/images/svg_ch3_ch_upper_semicircle.svg" />
          <Pause />
          <OuterP>
        ...
        <Example>
          ...
          <Image
            width="540.0px"
            src="/images/svg_ch3_ch_factory_function.svg" />
          <Pause />
          <OuterP>
      ...
      <Exercises>
        ...
        <Exercise number={4}>
          <ExerciseStatement id="_7_1903">
            ...
            <Image
              width="580.0px"
              src="/images/svg_ch3_ex_factory_roof_graph.svg" />
          </ExerciseStatement>
          <Solution>
            <OuterP>
              As {" "}
            ...
            <Image
              width="580.0px"
              src="/images/svg_ch3_ex_factory_roof_floor_graph.svg" />
            <Pause />
            <OuterP>
              (For example, {" "}
              <Math>
            ...
            <Image
              width="450.0px"
              src="/images/svg_ch3_ex_factory_roof_with_displacement_arrows.svg" />
            <Pause />
            <OuterP>
        ...
        <Exercise number={5}>
          <ExerciseStatement id="_8_5146">
            ...
            <Image
              width="680.0px"
              src="/images/svg_ch3_ex_factory_roof_stretched.svg" />
          </ExerciseStatement>
          <Solution>
            <OuterP>
              ...
              <InChapterLink
                href="/article/chapter3?id=_7_1903"
            ...
            <Image
              width="680.0px"
              src="/images/svg_ch3_ex_factory_roof_stretched_solution.svg" />
            <Pause />
            <OuterP>
            ...
            <Image
              width="470.0px"
              src="/images/svg_ch3_ex_f_box_g_box.svg" />
            <Pause />
            <OuterP>
              In other words, {" "}
              <NoBreak>
            ...
            <Image
              width="640.0px"
              src="/images/svg_ch3_ex_f_circle_g_equals.svg" />
            <Pause />
            <OuterP>
              <Math>
                $f \circ g$
        ...
        <Exercise number={6}>
          <ExerciseStatement>
            ...
            <Image
              width="620.0px"
              src="/images/svg_ch3_ex_three_factories.svg" />
          </ExerciseStatement>
          <Solution>
            <OuterP>
              For the first graph,
            ...
            <OuterP>
              ...
              {" "}
              <InChapterLink
                href="/article/chapter3?id=_8_5146"
                class="handle-in-chapter-link">
                Exercise 5
              </InChapterLink>
              's formula by {" "}
            ...
            <Image
              width="620.0px"
              src="/images/svg_ch3_ex_three_factories_sol1.svg" />
            <Pause />
            <OuterP>
              And that formula is...
            </OuterP>
            ...
            <Image
              width="620.0px"
              src="/images/svg_ch3_ex_three_factories_sol2.svg" />
            <Pause />
            <OuterP>
              ...iiiiiiiS...
            </OuterP>
        ...
        <Exercise number={7}>
          ...
          <Solution>
            ...
            <Image
              width="1043.52px"
              src="/images/svg_ch3_ex_cosine_1000x.svg" />
            <Pause />
            <OuterP>
              By the first step, a
            </OuterP>
        ...
        <Exercise number={9}>
          <ExerciseStatement>
            <OuterP>
              ...
              Same question as {" "}
              <InChapterLink
                href="/article/chapter3?id=_9_4085"
                class="handle-in-chapter-link">
                Exercise 8
              </InChapterLink>
              , but for
          ...
          <Solution>
            ...
            <SolutionNote>
              ...
              <CentralDisplayItalic>
                ...
                <ImageRight
                  width="550.0px"
                  src="/images/svg_ch3_ex_associativity_cloud.svg" />
              </CentralDisplayItalic>
              <Pause />
              <OuterP>
        ...
        <Exercise number={11}>
          <ExerciseStatement>
            <OuterP>
              ...
              Solve {" "}
              <InChapterLink
                href="/article/chapter3?id=_10_2749"
                class="handle-in-chapter-link">
                Exercise 10
              </InChapterLink>
              {" "} using
        ...
        <Exercise number={16}>
          ...
          <Solution>
            ...
            <OuterP class="indent-10">
              ...
              <InChapterLink
                href="/article/chapter3?id=_11_3533"
                class="handle-in-chapter-link">
                Exercise 14
              </InChapterLink>
              ):
            ...
            <OuterP>
              ...
              By {" "}
              <InChapterLink
                href="/article/chapter3?id=_12_1474"
                class="handle-in-chapter-link">
                Exercise 15
              </InChapterLink>
              , the roots of {" "}
          ...
          <Solution>
            ...
            <SolutionNote>
              ...
              <OuterP>
                ...
                <a
                  href="/article/chapter1?id=_5_4532"
