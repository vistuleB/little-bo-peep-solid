      ...
      {showMore() && (
        <>
          ...
          <Section id="section-2">
            ...
            <OuterP class="indent-10">More precisely, if</OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              are the horizontal <i>&amp;</i> the vertical change, respectively,
              from <Math>$A$</Math> to{" "}
              <NoBreak>
                <Math>$B$</Math>,
              </NoBreak>{" "}
          ...
          <Section id="section-5">
            <OuterP>
              ...
              <span class="nobreak">
                <InlineImage src="/images/rise-run.svg" width="28px" />
                ”),
              </span>{" "}
          ...
          <Section id="section-6">
            ...
            <Pause />
            <OuterP>or “run equals rise over slope”. Thus:</OuterP>
            <Pause />
            <Image src="/images/48.svg" />
            <Pause />
            <OuterP>...as can sometimes be useful to know.</OuterP>
          </Section>
          <Pause />
          ...
          <Pause />
          <Section divider={false} id="section-9">
            <OuterP>
          ...
          <Exercises>
            <Exercise number={1}>
              ...
              <Solution>
                ...
                <Pause />
                <Image src="/images/55.svg" class="relative w-fit">
                  <ImageRight
                    src="/images/56.svg"
                    offset_y="5rem"
                    offset_x="-1.3rem"
                ...
                <SolutionNote>
                  ...
                  <Pause />
                  <Image src="/images/58.svg" class="relative w-fit">
                    <ImageRight
                      src="/images/59.svg"
                      offset_y="27%"
                      offset_x="-10%"
