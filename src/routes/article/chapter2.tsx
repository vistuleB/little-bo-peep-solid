  ...
  return (
    <>
      <Chapter number={2} title="Slopes">
        <a class="next_page" href="/article/chapter3" />
        <Rest />
      </Chapter>
    </>
  );
...
const Rest = () => {
  ...
  return (
    <>
      {showMore() && (
        <>
          <a class="prev_page" href="/article/chapter1" />
          <Section>
            <VerticalChunk>
              <b>Slopes.</b> The <i>slope</i> of a line is a mathematical
            ...
            <VerticalChunk>
              ...
              increase going right, as is usually the case. One can also
              describe slope as...
            </VerticalChunk>
            <Pause />
            <CentralDisplayItalic>
            ...
            <VerticalChunk>
              ...
              because it goes up by <i>minus</i> <Math>$0.5$</Math> units with
              each unit to the right:
            </VerticalChunk>
            <Pause />
          ...
          <Section>
            ...
            <Pause />
            <Table style="margin-top:0.5em;margin-bottom:0.5em;" class="lines">
              <colgroup>
                <col width={120} />
                <col width={120} />
                <col width={120} />
          ...
          <Section>
            <VerticalChunk>
              ...
              <span class="nobreak">
                <InlineImage width="28px" src="/images/rise-run.svg" />
                ”),
              </span>{" "}
          ...
          <Exercises>
            <Exercise exercise_number={1}>
              <VerticalChunk>
                ...
                <Math>$-&#123;1 \over 2&#125;$</Math> are perpendicular to lines
                of slope{" "}
                <NoBreak>
                  <Math>$2$</Math>.
                </NoBreak>
            ...
            <Exercise exercise_number={2}>
              <VerticalChunk>
                ...
                <Math>$p$</Math> passing through a point{" "}
                <NoBreak>
                  <Math>$(x_0, y_0)$</Math>.
                </NoBreak>{" "}
            ...
            <Exercise exercise_number={3}>
              <VerticalChunk>
                ...
                <del>an object</del> a mosquito whose height over time is given
                by this graph (use the same time interval as the graph):
              </VerticalChunk>
              <Pause />
              ...
              <Solution solution_number={3}>
                ...
                <Pause />
                <VerticalChunk>
                  <i>Note 1.</i> As explained in Chapter 3, an empty circle of
                  this type
                </VerticalChunk>
                <Pause />
            ...
            <Exercise exercise_number={4}>
              <VerticalChunk>
                <b>Exercise 4.</b> Digressing on the second-to-last equation in
                the solution to Exercise 2, explain why
              </VerticalChunk>
              <Pause />
