  ...
  return (
    <Article
      ...
      <Section id="section-1">
        <OuterP>
          <b>Definition.</b> The <i>slope</i> of a line is a mathematical
          measure of how “steep” a line is. Here are a few examples (for an
          explanation of the values, see below):
        </OuterP>
        <Pause />
        <Image src="/tmp-images/c2_slope_examples.svg" />
        <Pause />
        <OuterP>To explain, the slope of a line is...</OuterP>
        <Pause />
        ...
        <OuterP>
          ...
          increase going right, as is usually the case. Or...
        </OuterP>
        <Pause />
        <CentralDisplayItalic>
        ...
        <Pause />
        <OuterP>...is a different way of expressing the same idea.</OuterP>
        <OuterP class="indent-10">
          For example, the line below has slope 1, because it goes up by{" "}
          <Math>$1$</Math> unit for each unit to the right:
        </OuterP>
        <Pause />
        ...
        <OuterP>
          ...
          because it goes up by <i>minus</i> <Math>$0.5$</Math> units with each
          unit to the right:
        </OuterP>
        <Pause />
        ...
        <>
          ...
          <Section id="section-2">
            <OuterP>
              ...
              vertical change to horizontal change between any two distinct
              points{" "}
              <NoBreak>
                <Math>$A$</Math>,
              </NoBreak>{" "}
              <Math>$B$</Math> on the line:
            </OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              are the horizontal and the vertical change, respectively, from{" "}
              <Math>$A$</Math> to{" "}
              <NoBreak>
                <Math>$B$</Math>,
              </NoBreak>{" "}
            ...
            <Pause />
            <OuterP>
              more succinctly. We call this equation the <i>slope formula</i>.
            </OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              is the vertical change from <Math>$A$</Math> to{" "}
              <NoBreak>
                <Math>$B$</Math>,
              </NoBreak>{" "}
              while
            ...
            <Pause />
            <OuterP>
              is the horizontal change from <Math>$A$</Math> to{" "}
              <NoBreak>
                <Math>$B$</Math>
                .)
              </NoBreak>
          ...
          <Section id="section-3">
            ...
            <MathBlock>$$ x_2 - x_1 $$</MathBlock>
            <Pause />
            <OuterP>can be positive or negative, while</OuterP>
            <Pause />
            <MathBlock>$$ y_2 - y_1 $$</MathBlock>
            <Pause />
            <OuterP>
              can be positive or negative or zero—more on zero below—the
              following sign combinations arise (lines of slope zero not
              included):
            </OuterP>
            <Pause />
            <Table class="lines" style="margin-top:0.5em;margin-bottom:0.5em;">
              <colgroup>
                <col width={120} />
                <col width={120} />
                <col width={120} />
            ...
            <OuterP>
              ...
              slope formula gives the same answer if <Math>$(x_1, y_1)$</Math>{" "}
              and <Math>$(x_2, y_2)$</Math> swap places, or, namely, to show
              that the fractions
              <ImageRight
            ...
            <Pause />
            <OuterP>are somehow equal. But, indeed,</OuterP>
            <Pause />
            <MathBlock>
              $$ &#123;y_2 - y_1 \over x_2 - x_1&#125; = &#123;-(y_2 - y_1)
              \over -(x_2 - x_1)&#125; = &#123;y_1 - y_2 \over x_1 - x_2&#125;
              $$
              <ImageLeft
            ...
            <Pause />
            <OuterP>which verifies this hypothesis. In particular,</OuterP>
            <Pause />
            <MathBlock>
              $$ &#123;y_2 - y_1 \over x_2 -
              x_1&#125;\qquad\,\,\,\,\,\te&#123;and&#125;\,\,\,\,\,\qquad&#123;y_1
          ...
          <Section id="section-4">
            ...
            <OuterP>
              ...
              undefined. This occurs, e.g., if we attempt to measure the slope
              of a vertical line:
            </OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              Indeed, vertical lines have <i>undefined</i> slope. Moreover the
              bad case
            </OuterP>
            <Pause />
            <MathBlock>$$ x_2 - x_1 = 0 $$</MathBlock>
            ...
            <OuterP>
              ...
              <Math>$(x_1, y_1)$</Math> and <Math>$(x_2, y_2)$</Math> coincide.
            ...
            <OuterP>
              ...
              is undefined.) Indeed, infinitely many different lines pass
          ...
          <Section id="section-5">
            ...
            <OuterP>
              ...
              <Math>$\Delta y$</Math> can be thought of as shorthands for{" "}
              <NoBreak>
                “<Math>$x_2 - x_1$</Math>
                ”,
              </NoBreak>{" "}
          ...
          <Section id="section-6">
            ...
            <Pause />
            <OuterP>on each side by “run” gives</OuterP>
            <Pause />
            <MathBlock>
              $$ \te&#123;slope&#125; \times \te&#123;run&#125; =
              \te&#123;rise&#125; $$
            ...
            <Pause />
            <OuterP>
              or “rise equals slope times run”. After which, dividing each side
              by “slope”, we find
            </OuterP>
            <Pause />
            <MathBlock>
            ...
            <Pause />
            <OuterP>or “run equals rise over slope”. Or:</OuterP>
            <Pause />
          ...
          <Section id="section-7">
            ...
            <Pause />
            <OuterP>
              where <Math>$a$</Math> and <Math>$b$</Math> are constants defines
              a line in the Cartesian plane. E.g.:
            </OuterP>
            <Pause />
            ...
            <OuterP>
              ...
              so <Math>$b$</Math> is the height of the line at{" "}
              <NoBreak>
                <Math>$x = 0$</Math>.
              </NoBreak>{" "}
            ...
            <Pause />
            <OuterP>
              of the line, because <Math>$x = 0$</Math> is where the line
              crosses the <Math>$y$</Math> axis. But the point
            </OuterP>
            <Pause />
            <MathBlock>$$ (0, b) $$</MathBlock>
            <Pause />
            <OuterP>is also sometimes called the</OuterP>
            <Pause />
            <CentralDisplayItalic>
              <NoBreak>
                <Math>$y$</Math>
            ...
            <OuterP>
              ...
              might either refer to the value <Math>$b$</Math> or to the point{" "}
              <NoBreak>
                <Math>$(0,b)$</Math>,
              </NoBreak>{" "}
            ...
            <Pause />
            <OuterP>
              so <Math>$y$</Math> increases by <Math>$a$</Math> between{" "}
              <Math>$x = 0$</Math> and{" "}
              <NoBreak>
                <Math>$x = 1$</Math>.
              </NoBreak>{" "}
              In fact, <Math>$y$</Math> increases by <Math>$a$</Math> each time{" "}
              <Math>$x$</Math> increases by 1, so, by our own definition of
              slope—the increase in <Math>$y$</Math> per unit increase in{" "}
              <NoBreak>
                <Math>$x$</Math>—
              </NoBreak>
              <Math>$a$</Math> is the slope of{" "}
              <NoBreak>
                <Math>$y = ax + b$</Math>!
              </NoBreak>
            </OuterP>
            ...
            <Example>
              ...
              <Pause />
              <OuterP>defines a line of slope 100.</OuterP>
            </Example>
            <Pause />
            <OuterP>On the other hand, an equation of the form</OuterP>
            <Pause />
            <MathBlock>$$ y = ax + b $$</MathBlock>
            <Pause />
            <OuterP>
              cannot describe a vertical line, because <Math>$a$</Math> is the
              slope, while a vertical line has no slope, so what would{" "}
              <Math>$a$</Math> be equal to? Instead, a vertical line is
              described by an equation of the form
            </OuterP>
            <Pause />
            <MathBlock>$$ x = c $$</MathBlock>
            <Pause />
            <OuterP>
              (see Fig. 1) where <Math>$c \in \rr$</Math> is a constant,
            ...
            <Pause />
            <OuterP>
              for a horizontal line, where <Math>$b \in \rr$</Math> is a
              constant.
            </OuterP>
            <OuterP class="indent-10">
              One should also bear in mind that an equation can define a line
            ...
            <OuterP>
              ...
              <Math>$3$</Math> and slope{" "}
              <NoBreak>
                <Math>$-1$</Math>.
              </NoBreak>
              <ImageRight src="/build-img/svgo-svg/h7oS.svg" line={1} />
            </OuterP>
          </Section>
          <Pause />
          <Section id="section-8">
            ...
            <OuterP>
              ...
              <Math>$y$</Math> divided by a change in{" "}
              <NoBreak>
                <Math>$x$</Math>.
              </NoBreak>
            </OuterP>
            <OuterP class="indent-10">
              For example, if the units on the <Math>$y$</Math> axis are meters
              (“m”) and the units on the <Math>$x$</Math> axis are seconds (“s”)
            ...
            <Pause />
            <OuterP>
              also known as <i>meters per second</i>. This is precisely the
              case, for example, in the following graph, that purports to plot
              the height of a balloon, in meters, as a function of time elapsed,
              in seconds:
            </OuterP>
            <Pause />
            ...
            <Pause />
            <OuterP>
              The slope of the graph is <Math>$0.75$</Math>{" "}
            ...
            <Pause />
            <OuterP>In fact, the slope is the balloon's upward</OuterP>
            <Pause />
            <CentralDisplayItalic>velocity</CentralDisplayItalic>
            <Pause />
            <OuterP>since velocity is defined as</OuterP>
            <Pause />
            <CentralDisplayItalic>displacement over time</CentralDisplayItalic>
            <Pause />
            <OuterP>
              and this is precisely the form of the ratio “rise over run” for
              the current graph. (More generally, we have
            </OuterP>
            <Pause />
            <CentralDisplay>“slope = velocity”</CentralDisplay>
            <Pause />
            <OuterP>
              whenever the <Math>$y$</Math> axis has dimensions of length and
              the <Math>$x$</Math> axis has dimensions of time—whether the slope
              turns out to be <Math>$\te&#123;m&#125;/\te&#123;s&#125;$</Math>{" "}
              or <Math>$\te&#123;km&#125;/\te&#123;s&#125;$</Math> or km/hour,
              etc, depends on the exact units involved.)
            </OuterP>
            <OuterP class="indent-10">
            ...
            <Pause />
            <OuterP>can be rephrased as</OuterP>
            <Pause />
            <MathBlock>
            ...
            <OuterP>
              ...
              By extension, taking all three permutations of the slope formula
              into account gives us this alternate triptych of equations,
              expressing the same idea(s) in “applied” language:
            </OuterP>
            <Pause />
            ...
            <Example>
              <OuterP>
                <b>Example 3.</b> The increase in height of the above balloon
              ...
              <Pause />
              <OuterP>following the template</OuterP>
              <Pause />
              <MathBlock>
                $$ \begin&#123;array&#125;&#123;c&#125; \rt&#123;0.08&#125;
                (\te&#123;rate of change&#125;) \times \te&#123;(amount of
                time)&#125;\\ = \te&#123;(amount of
                change)&#125;\rt&#123;0.05&#125; \end&#123;array&#125; $$
              </MathBlock>
              <Pause />
              <OuterP>
            ...
            <Example>
              <OuterP>
                <b>Example 4.</b> The amount of time required for the balloon to
                go up by (say){" "}
                <NoBreak>
                  <Math>$4$</Math>m
                </NoBreak>{" "}
              ...
              <Pause />
              <MathBlock>
                $$ \rt&#123;0.1&#125; \te&#123;amount of time&#125; \,\,=\,\,
                \frac&#123;\!\rt&#123;0.15&#125;\te&#123;amount of
                change&#125;\!\rt&#123;0.1&#125;&#125;&#123;\te&#123;rate of
                change&#125;&#125; \rt&#123;0.1&#125; $$
              </MathBlock>
              <Pause />
              <OuterP>found in the third line of the table.</OuterP>
            </Example>
          </Section>
          <Pause />
          <Section id="section-9">
            ...
            <Pause />
            <OuterP>
              one could easily be tricked into thinking that a “dimension” is
              the same thing as a “unit”. In fact, dimensions are broader
            ...
            <Pause />
            <OuterP>
              each of which covers <i>several different</i> units. For example,
              in the “time” dimension, one finds individual units of the type
            </OuterP>
            <Pause />
            <CentralDisplayItalic>
            ...
            <Pause />
            <OuterP>(etc), while in the “length” dimension one finds</OuterP>
            <Pause />
            <CentralDisplayItalic>
          ...
          <Pause />
          <Exercises at_end_of_page={true} show_curlicue={true} id="_31_h.a.i_">
            <Exercise number={1}>
              <ExerciseStatement id="_27_h.a.i_">
                <OuterP>
                  <b>Exercise 1.</b> True or false: Lines of slope{" "}
                  <Math>$-&#123;1 \over 2&#125;$</Math> are perpendicular to
                  lines of slope{" "}
                  <NoBreak>
                    <Math>$2$</Math>.
                  </NoBreak>
              ...
              <Solution>
                ...
                <OuterP>
                  ...
                  <Math>$90^\circ$</Math> rotation and so, likewise, are the
                  lines defined by their hypotenuses!
                </OuterP>
                <Pause />
                <SolutionNote>
                  <OuterP>
                    <i>Note 1.</i> More generally, a line of slope{" "}
                    <Math>$p$</Math> is perpendicular to a line of slope{" "}
                    <NoBreak>
                      <Math>$-1/p$</Math>,
                    </NoBreak>{" "}
                    for all{" "}
            ...
            <Exercise number={2}>
              <ExerciseStatement id="_28_h.a.i_">
                <OuterP>
                  <b>Exercise 2.</b> Find the general equation of a line of
                  slope <Math>$p$</Math> passing through a point{" "}
                  <NoBreak>
                    <Math>$(x_0, y_0)$</Math>.
                  </NoBreak>{" "}
              ...
              <Solution>
                <OuterP>
                  A point <Math>$(x,y) \ne (x_0,y_0)$</Math> is on the line of
                  slope <Math>$p$</Math> if and only if
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ p = &#123;y - y_0 \over x - x_0&#125; $$
                ...
                <Pause />
                <OuterP>
                  is the slope of the line segment from <Math>$(x_0,y_0)$</Math>{" "}
                  to{" "}
                  <NoBreak>
                    <Math>$(x,y)$</Math>,
                  </NoBreak>{" "}
                  and it is necessary and sufficient for this segment to have
                  slope <Math>$p$</Math> in order for the point{" "}
                  <Math>$(x,y)$</Math> to be on the line!
                </OuterP>
                <OuterP class="indent-10">Unfortunately, the equation</OuterP>
                <Pause />
                <MathBlock>
                  $$ p = &#123;y - y_0 \over x - x_0&#125; $$
                </MathBlock>
                ...
                <OuterP>
                  ...
                  <Math>$(x,y) = (x_0,y_0)$</Math> itself does not satisfy the
                  equation. (We find
                </OuterP>
                <Pause />
                ...
                <OuterP>
                  ...
                  which is not a valid equality because the right-hand side is
                  an undefined quantity.)
                </OuterP>
                <OuterP class="indent-10">Instead, multiplying</OuterP>
                <Pause />
                <MathBlock>
                  $$ p = &#123;y - y_0 \over x - x_0&#125; $$
                </MathBlock>
                ...
                <OuterP>
                  ...
                  <Math>$(x,y) = (x_0,y_0)$</Math> as well as by every other
                  point on the line. This can be a final answer, and,
                  pleasingly, has the form
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ \te&#123;“&#125;\te&#123;slope&#125; \times
                ...
                <Pause />
                <OuterP>which can also make it easy to remember!</OuterP>
                <Pause />
                <OuterP>
                ...
                <Pause />
                <OuterP>with the two sides of the equation swapped, or</OuterP>
                <Pause />
                <MathBlock>$$ y = p(x - x_0) + y_0 $$</MathBlock>
                <Pause />
                <OuterP>
                  with <Math>$y$</Math> isolated on the left-hand side. From
                ...
                <Pause />
                <OuterP>which has the form</OuterP>
                <Pause />
                <MathBlock>$$ y = ax + b $$</MathBlock>
                <Pause />
                <OuterP>
            ...
            <Exercise number={3}>
              <ExerciseStatement id="_29_h.a.i_">
                <OuterP>
                  <b>Exercise 3.</b> Plot the vertical velocity of{" "}
                  <del>an object</del> a mosquito whose height over time is
                  given by this graph (use the same time interval as the graph):
                </OuterP>
                <Pause />
              ...
              <Solution>
                ...
                <Pause />
                <OuterP>
                  On each interval, the velocity is rate of change of the
                  height, i.e., the <i>slope</i> of the height. For example, the
                  rate of change of the height is
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;1\te&#123;m&#125; \over 1\te&#123;s&#125;&#125; =
                ...
                <OuterP>
                  ...
                  vertical velocity is <i>undefined</i> wherever the graph of
                  the height has a sharp corner. (Because the slope of the graph
                  is not well-defined at such corners.)
                </OuterP>
                <Pause />
                <OuterP>
                ...
                <OuterP>
                  ...
                  (Think: <i>how many times</i> does <Math>$0.5$</Math> go into{" "}
                  <NoBreak>
                    <Math>$2$</Math>
                    ?)
                  </NoBreak>
            ...
            <Exercise number={4}>
              <ExerciseStatement id="_30_h.a.i_">
                ...
                <OuterP>
                  ...
                  of the line of slope <Math>$p$</Math> through the point{" "}
                  <Math>$(x_0,y_0)$</Math> by using a drawing and “rise equals
                  slope times run”.
                </OuterP>
              </ExerciseStatement>
              <Solution>
                ...
                <Pause />
                <OuterP>
                  <i>Note 1.</i> Our drawing makes some implicit assumptions,
                  such as <Math>$p &gt; 0$</Math> and{" "}
                  <NoBreak>
                    <Math>$x_0 &gt; 0$</Math>.
                  </NoBreak>{" "}
                  But
                ...
                <OuterP>
                  ...
                  to <Math>$(x_0, y_0)$</Math> regardless of the sign of{" "}
                  <Math>$p$</Math> or <Math>$x_0$</Math> (because{" "}
                  <Math>$x_0$</Math> is the run in all cases), making
                </OuterP>
                <Pause />
                <MathBlock>$$ y_0 - px_0 $$</MathBlock>
                <Pause />
