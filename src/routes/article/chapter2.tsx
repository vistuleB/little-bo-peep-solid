    ...
    {showMore() && <>
      ...
      <Section id="section-11">
        ...
        <OuterP>
          ...
          <NoBreak>
            <a
              href="/article/chapter1#_23_hgi_"
        ...
        <OuterP>
          ...
          <NoBreak>
            <a
              href="/article/chapter1#_18_hgi_"
              class="handle-out-chapter-link"
            >
              Exercise 17 of Chapter 1
            </a>
            ,
          </NoBreak>
      ...
      <Exercises id="_51_hgi_">
        ...
        <Exercise number={13}>
          <ExerciseStatement id="_37_hgi_">
            <OuterP>
              ...
              {" "}
              <InChapterLink
                href="/article/chapter2#_36_hgi_"
                class="handle-in-chapter-link"
              >
                Exercise 12
              </InChapterLink>
          ...
          <Solution>
            <OuterP>
              ...
              curves of {" "}
              <InChapterLink
                href="/article/chapter2#_40_hgi_"
                class="handle-in-chapter-link"
              >
                Exercise 15
              </InChapterLink>
        ...
        <Exercise number={17}>
          ...
          <Solution>
            ...
            <OuterP>
              ...
              <NoBreak>
                <InChapterLink
                  href="/article/chapter2#_39_hgi_"
                  class="handle-in-chapter-link"
                >
                  Note 1
                </InChapterLink>
        ...
        <Exercise number={20}>
          ...
          <Solution>
            ...
            <OuterP>
              ...
              <NoBreak>
                <a
                  href="/article/chapter1#_9_hgi_"
                  class="handle-out-chapter-link"
                >
                  Note 6, Exercise 9, Chapter 1
                </a>
                .)
              </NoBreak>
              {" "}{" "}
            ...
            <SolutionNote>
              ...
              <OuterP>
                ...
                <NoBreak>
                  <a
                    href="/article/chapter1#_10_hgi_"
                    class="handle-out-chapter-link"
                  >
        ...
        <Exercise number={21}>
          ...
          <Solution>
            <OuterP>
              ...
              <NoBreak>
                <InChapterLink
                  href="/article/chapter2#_46_hgi_"
                  class="handle-in-chapter-link"
                >
                  Note 1
                </InChapterLink>
          ...
          <Solution>
            ...
            <SolutionNote>
              <OuterP>
                ...
                <NoBreak>
                  <InChapterLink
                    href="/article/chapter2#_47_hgi_"
                    class="handle-in-chapter-link"
                  >
                    Exercise 21
                  </InChapterLink>
        ...
        <Exercise number={24}>
          ...
          <Solution>
            ...
            <Pause />
            <Image src="/build-img/svg/KEtq.svg" />
            <Pause />
            <OuterP>
