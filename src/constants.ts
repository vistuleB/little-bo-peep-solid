...
export const HORIZONTAL_PAGE_ARRIVAL_OFFSET = 72;
...
export const HORIZONTAL_SCROLL_SNAP_BACK_SCREEN_WIDTH_RATIO = 0.3;
...
export const HORIZONTAL_PAGE_ARRIVAL_DURATION_MS = 220;
...
export const HORIZONTAL_SWIPE_IMMEDIATE_SNAP_MIN_RELEASE_PAUSE_MS = 50;
...
export const HORIZONTAL_SWIPE_IMMEDIATE_SNAP_MAX_TERMINAL_VELOCITY = 0.04;
