...
export const HORIZONTAL_SWIPE_MIN_DISTANCE = 80;
export const HORIZONTAL_SWIPE_EDGE_EXCLUSION = 24;
export const HORIZONTAL_SWIPE_MAX_REVERSAL = 30;
export const HORIZONTAL_SWIPE_CENTER_TOLERANCE = 2;
...
export const HORIZONTAL_SWIPE_MAX_DURATION_MS = 350;
...
export const HORIZONTAL_SWIPE_MIN_VELOCITY = 0.3;
