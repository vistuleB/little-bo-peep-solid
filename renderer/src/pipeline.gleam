...
pub fn our_pipeline(only: Bool, remove_unused: Bool, author_mode: Bool) -> Pipeline {
  [
    ...
    [
      ...
      dl.append_attribute(#("Book", "counter", "AppendixCounter", infra.GoBack)),
      ...
      dl.prepend_counter_incrementing_attribute_if_fancy(#("Exercise", "ExerciseCounter", fn(_, ancestors, _, _, _) { infra.v_is_first_ancestor(ancestors, "Exercises") }, infra.GoBack)),
      ...
      dl.prepend_text_node_if_fancy(#("Exercise", "*Exercise ::øøExerciseCounter.*", fn(_, _, prev_siblings, _, next_siblings) { !list.is_empty(prev_siblings) || !list.is_empty(next_siblings) })), // counter not needed if there's only 1 exercise
      dl.prepend_text_node_if_fancy(#("Exercise", "*Exercise*", fn(_, _, prev_siblings, _, next_siblings) { list.is_empty(prev_siblings) && list.is_empty(next_siblings) })),
    ...
    [
      ...
      dl.rename_if_child_of(#("p", "OuterP", "Appendix")),
