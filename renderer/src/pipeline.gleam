...
pub fn our_pipeline(only: Bool, remove_unused: Bool, author_mode: Bool) -> Pipeline {
  [
    ...
    [
      ...
      dl.append_attribute_if_fancy(#("Exercises", fn(_, _, _, _, following_siblings) { list.is_empty(following_siblings) }, "at_end_of_page", "true")),
      dl.append_attribute_if_fancy(#("Exercise", fn(_, ancestors, _, _, _) { infra.v_is_first_ancestor(ancestors, "Exercises") }, "number", "::øøExerciseCounter")),
      ...
      dl.prepend_counter_incrementing_attribute_if_fancy(#("Exercise", "ExerciseCounter", fn(_, ancestors, _, _, _) { infra.v_is_first_ancestor(ancestors, "Exercises") })),
      ...
      dl.prepend_text_node_if_fancy(#("Exercise", "*Exercise ::øøExerciseCounter.*", fn(_, ancestors, _, _, _) { infra.v_is_first_ancestor(ancestors, "Exercises") })),
      dl.prepend_text_node_if_fancy(#("Exercise", "*Exercise*", fn(_, ancestors, _, _, _) { !infra.v_is_first_ancestor(ancestors, "Exercises") })),
