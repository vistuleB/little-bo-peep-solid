...
pub fn our_pipeline(only: Bool, remove_unused: Bool, author_mode: Bool) -> Pipeline {
  [
    ...
    [
      ...
      dl.append_attribute_if(#("Exercises", fn(exercise, ancestors) { infra.v_is_last_child(exercise, ancestors) |> option.is_some }, "at_end_of_page", "true", infra.GoBack)),
      dl.append_attribute_if(#("Section", fn(section, _) { !infra.v_has_attr_with_key(section, "id") }, "id", "section-::++SectionCounter", infra.Continue)),
