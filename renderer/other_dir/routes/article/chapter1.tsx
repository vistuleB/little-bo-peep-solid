    ...
    >
      <SectionsBreadcrumbs>
        <BreadcrumbItem id="breadcrumb-0">
          <InChapterLink href="?id=section-1">square roots</InChapterLink>
        </BreadcrumbItem>
        ...
        <BreadcrumbItem id="breadcrumb-2">
          <InChapterLink href="?id=section-3">distributivity</InChapterLink>
        </BreadcrumbItem>
        <BreadcrumbItem id="breadcrumb-3">
          <InChapterLink href="?id=section-4">epilogue</InChapterLink>
        </BreadcrumbItem>
        <BreadcrumbItem id="breadcrumb-4">
          <InChapterLink href="?id=section-5">vocabulary</InChapterLink>
        </BreadcrumbItem>
      ...
      <Section id="section-1">
        ...
        <Pause />
        <OuterP>
          are both positive. But <Math>$\sqrt&#123;4&#125;$</Math> is, by
        ...
        <OuterP class="indent-10">Next, we will ponder</OuterP>
        <Pause />
      ...
      {showMore() && (
        <>
          ...
          <Section id="section-2">
            ...
            <Pause />
            <OuterP>
              But <Math>$50/2$</Math> is a ratio of integers, which makes things
              particularly nice! For a ratio of decimals, such as, say,
            </OuterP>
            <Pause />
            ...
            <OuterP>
              ...
              Thankfully, however, we can still characterize this fraction as
              the answer to the question “how many times does{" "}
              <Math>$0.01$</Math> go into{" "}
              <NoBreak>
                <Math>$1$</Math>
                ?”
              </NoBreak>{" "}
            ...
            <OuterP>
              ...
              smaller numbers produces larger and larger results (and, by
              extension, why dividing by <Math>$0$</Math> is undefined).
            </OuterP>
            <Pause />
            <OuterP>
          ...
          <Section id="section-3">
            ...
            <Example>
              ...
              <Pause />
              <OuterP>which agrees with Example 2.</OuterP>
            </Example>
            <Pause />
            <OuterP>
            ...
            <Pause />
            <OuterP>or, less pedantically,</OuterP>
            <Pause />
          ...
          <Pause />
          <Section divider={false} id="section-4">
            <OuterP>
            ...
            <MathBlock>
              ...
              10\,\cdot\,12 &amp;= 11^2 - 1\\ 9\,\cdot\,11 &amp;= 10^2 - 1
              \end&#123;align&#125; $$
            </MathBlock>
            <Pause />
            <OuterP>
            ...
            <Exercise number={2}>
              <ExerciseStatement>
                <OuterP>
                  ...
                  we observed how the difference
                </OuterP>
                <Pause />
                <MathBlock>
                  $$ &#123;1 \over n&#125; - &#123;1 \over n+1&#125; $$
